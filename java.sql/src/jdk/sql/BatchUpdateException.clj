...
(defn ->batch-update-exception
  ...
  (^BatchUpdateException [^java.lang.String reason ^java.lang.String sql-state ^Integer vendor-code update-counts ^java.lang.Throwable cause]
    (new BatchUpdateException reason sql-state vendor-code update-counts cause))
  (^BatchUpdateException [^java.lang.String reason ^java.lang.String sql-state ^Integer vendor-code update-counts]
    (new BatchUpdateException reason sql-state vendor-code update-counts))
  (^BatchUpdateException [^java.lang.String reason ^java.lang.String sql-state update-counts]
    (new BatchUpdateException reason sql-state update-counts))
  (^BatchUpdateException [^java.lang.String reason update-counts]
    (new BatchUpdateException reason update-counts))
  (^BatchUpdateException [update-counts]
