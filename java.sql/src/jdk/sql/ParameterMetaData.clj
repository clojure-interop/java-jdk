...
(defn get-precision
  ...
  (^Integer [^ParameterMetaData this ^Integer param]
...
(defn get-parameter-count
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^Integer [^ParameterMetaData this]
...
(defn get-parameter-type-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^java.lang.String [^ParameterMetaData this ^Integer param]
...
(defn signed?
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^Boolean [^ParameterMetaData this ^Integer param]
    (-> this (.isSigned param))))
