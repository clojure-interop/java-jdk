...
(defn get-precision
  ...
  (^Integer [^java.sql.ParameterMetaData this ^Integer param]
...
(defn get-parameter-count
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^Integer [^java.sql.ParameterMetaData this]
...
(defn get-parameter-type-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^java.lang.String [^java.sql.ParameterMetaData this ^Integer param]
...
(defn signed?
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  (^Boolean [^java.sql.ParameterMetaData this ^Integer param]
    (-> this (.isSigned param))))
