...
(defn ->sql-transient-exception
  ...
  (^SQLTransientException [^java.lang.String reason ^java.lang.String sql-state ^Integer vendor-code ^java.lang.Throwable cause]
    (new SQLTransientException reason sql-state vendor-code cause))
  (^SQLTransientException [^java.lang.String reason ^java.lang.String sql-state ^Integer vendor-code]
    (new SQLTransientException reason sql-state vendor-code))
  (^SQLTransientException [^java.lang.String reason ^java.lang.String sql-state]
    (new SQLTransientException reason sql-state))
  (^SQLTransientException [^java.lang.String reason]
