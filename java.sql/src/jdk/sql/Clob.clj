...
(defn set-string
  ...
  ([^java.sql.Clob this ^Long pos ^java.lang.String str ^Integer offset ^Integer len]
    (-> this (.setString pos str offset len)))
  ([^java.sql.Clob this ^Long pos ^java.lang.String str]
...
(defn position
  ...
  throws: java.sql.SQLException - if there is an error accessing the CLOB value or if pos is less than 1"
  ([^java.sql.Clob this ^java.lang.String searchstr ^Long start]
...
(defn get-character-stream
  ...
  ([^java.sql.Clob this ^Long pos ^Long length]
...
(defn get-sub-string
  ...
  ([^java.sql.Clob this ^Long pos ^Integer length]
