...
(defn get-functions
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern function-name-pattern]
...
(defn get-columns
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern table-name-pattern column-name-pattern]
...
(defn get-tables
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern table-name-pattern types]
...
(defn get-column-privileges
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema table column-name-pattern]
...
(defn get-best-row-identifier
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema table scope nullable]
...
(defn get-super-tables
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern table-name-pattern]
...
(defn get-procedures
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern procedure-name-pattern]
...
(defn get-index-info
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema table unique approximate]
...
(defn get-ud-ts
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern type-name-pattern types]
...
(defn get-procedure-columns
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern procedure-name-pattern column-name-pattern]
...
(defn get-cross-reference
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this parent-catalog parent-schema parent-table foreign-catalog foreign-schema foreign-table]
...
(defn get-attributes
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern type-name-pattern attribute-name-pattern]
...
(defn get-function-columns
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern function-name-pattern column-name-pattern]
...
(defn get-super-types
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([this catalog schema-pattern type-name-pattern]
