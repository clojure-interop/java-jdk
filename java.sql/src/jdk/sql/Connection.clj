...
(defn set-type-map
  ...
  ([^java.sql.Connection this ^java.util.Map> map]
    (-> this (.setTypeMap map))))
...
(defn set-read-only
  ...
  ([^java.sql.Connection this ^Boolean read-only]
...
(defn set-client-info
  ...
  ([^java.sql.Connection this ^java.lang.String name ^java.lang.String value]
    (-> this (.setClientInfo name value)))
  ([^java.sql.Connection this ^java.util.Properties properties]
...
(defn release-savepoint
  ...
  ([^java.sql.Connection this ^java.sql.Savepoint savepoint]
...
(defn set-transaction-isolation
  ...
  ([^java.sql.Connection this ^Integer level]
...
(defn set-schema
  ...
  throws: java.sql.SQLException - if a database access error occurs or this method is called on a closed connection"
  ([^java.sql.Connection this ^java.lang.String schema]
...
(defn set-catalog
  ...
  throws: java.sql.SQLException - if a database access error occurs or this method is called on a closed connection"
  ([^java.sql.Connection this ^java.lang.String catalog]
...
(defn set-holdability
  ...
  ([^java.sql.Connection this ^Integer holdability]
...
(defn abort
  ...
  ([^java.sql.Connection this ^java.util.concurrent.Executor executor]
    (-> this (.abort executor))))
...
(defn set-auto-commit
  ...
  ([^java.sql.Connection this ^Boolean auto-commit]
...
(defn set-network-timeout
  ...
  ([^java.sql.Connection this ^java.util.concurrent.Executor executor ^Integer milliseconds]
