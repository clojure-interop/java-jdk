...
(defn get-doc-flavor
  ...
  (^javax.print.DocFlavor [^Doc this]
    (-> this (.getDocFlavor))))
...
(defn get-attributes
  ...
  (^javax.print.attribute.DocAttributeSet [^Doc this]
    (-> this (.getAttributes))))
