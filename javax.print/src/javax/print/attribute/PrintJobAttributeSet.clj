...
(defn add
  ...
  (^Boolean [^PrintJobAttributeSet this ^javax.print.attribute.Attribute attribute]
    (-> this (.add attribute))))
...
(defn add-all
  ...
  (^Boolean [^PrintJobAttributeSet this ^javax.print.attribute.AttributeSet attributes]
