(ns javax.print.attribute.PrintRequestAttributeSet
...
(defn add
  ...
  (^Boolean [^PrintRequestAttributeSet this ^javax.print.attribute.Attribute attribute]
    (-> this (.add attribute))))
...
(defn add-all
  ...
  (^Boolean [^PrintRequestAttributeSet this ^javax.print.attribute.AttributeSet attributes]
