...
(defn get-size
  ...
  ([^Size2DSyntax this ^Integer units]
    (-> this (.getSize units))))
...
(defn get-x
  ...
  throws: java.lang.IllegalArgumentException - (unchecked exception) Thrown if units < 1."
  (^Float [^Size2DSyntax this ^Integer units]
    (-> this (.getX units))))
...
(defn to-string
  ...
  throws: java.lang.IllegalArgumentException - (unchecked exception) Thrown if units < 1."
  (^java.lang.String [^Size2DSyntax this ^Integer units ^java.lang.String units-name]
    (-> this (.toString units units-name)))
  (^java.lang.String [^Size2DSyntax this]
    (-> this (.toString))))
...
(defn equals
  ...
  (^Boolean [^Size2DSyntax this ^java.lang.Object object]
    (-> this (.equals object))))
