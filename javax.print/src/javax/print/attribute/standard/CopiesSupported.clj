...
(defn ->copies-supported
  ...
  (^CopiesSupported [^Integer lower-bound ^Integer upper-bound]
    (new CopiesSupported lower-bound upper-bound))
  (^CopiesSupported [^Integer member]
...
(defn equals
  ...
  (^Boolean [^CopiesSupported this ^java.lang.Object object]
    (-> this (.equals object))))
