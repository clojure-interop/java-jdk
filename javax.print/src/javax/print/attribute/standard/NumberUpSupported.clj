...
(defn equals
  ...
  (^Boolean [^javax.print.attribute.standard.NumberUpSupported this ^java.lang.Object object]
    (-> this (.equals object))))
...
(defn get-name
  ...
  (^java.lang.String [^javax.print.attribute.standard.NumberUpSupported this]
    (-> this (.getName))))
