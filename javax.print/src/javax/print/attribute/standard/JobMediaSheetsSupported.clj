...
(defn ->job-media-sheets-supported
  ...
  (^JobMediaSheetsSupported [^Integer lower-bound ^Integer upper-bound]
...
(defn equals
  ...
  (^Boolean [^JobMediaSheetsSupported this ^java.lang.Object object]
    (-> this (.equals object))))
