...
(defn ->output-device-assigned
  ...
  (^OutputDeviceAssigned [^java.lang.String device-name ^java.util.Locale locale]
...
(defn equals
  ...
  (^Boolean [^OutputDeviceAssigned this ^java.lang.Object object]
    (-> this (.equals object))))
