...
(defn add
  ...
  (^Boolean [^PrintServiceAttributeSet this ^javax.print.attribute.Attribute attribute]
    (-> this (.add attribute))))
...
(defn add-all
  ...
  (^Boolean [^PrintServiceAttributeSet this ^javax.print.attribute.AttributeSet attributes]
