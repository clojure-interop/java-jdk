...
(defn add
  ...
  (^Boolean [^javax.print.attribute.DocAttributeSet this ^javax.print.attribute.Attribute attribute]
    (-> this (.add attribute))))
...
(defn add-all
  ...
  (^Boolean [^javax.print.attribute.DocAttributeSet this ^javax.print.attribute.AttributeSet attributes]
