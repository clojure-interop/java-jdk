...
(defn get-print-service
  ...
  (^javax.print.PrintService [^DocPrintJob this]
...
(defn get-attributes
  ...
  (^javax.print.attribute.PrintJobAttributeSet [^DocPrintJob this]
    (-> this (.getAttributes))))
...
(defn add-print-job-listener
  ...
  ([^DocPrintJob this ^javax.print.event.PrintJobListener listener]
...
(defn add-print-job-attribute-listener
  ...
  ([^DocPrintJob this ^javax.print.event.PrintJobAttributeListener listener ^javax.print.attribute.PrintJobAttributeSet attributes]
...
(defn remove-print-job-attribute-listener
  ...
  listener - The object implementing the listener interface - `javax.print.event.PrintJobAttributeListener`"
  ([^DocPrintJob this ^javax.print.event.PrintJobAttributeListener listener]
...
(defn print
  ...
  ([^DocPrintJob this ^javax.print.Doc doc ^javax.print.attribute.PrintRequestAttributeSet attributes]
