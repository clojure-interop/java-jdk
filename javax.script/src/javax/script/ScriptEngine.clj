...
(defn create-bindings
  ...
  (^javax.script.Bindings [^ScriptEngine this]
    (-> this (.createBindings))))
...
(defn put
  ...
  ([^ScriptEngine this ^java.lang.String key ^java.lang.Object value]
    (-> this (.put key value))))
...
(defn set-context
  ...
  ([^ScriptEngine this ^javax.script.ScriptContext context]
...
(defn eval
  ...
  (^java.lang.Object [^ScriptEngine this ^java.lang.String script ^javax.script.ScriptContext context]
    (-> this (.eval script context)))
  (^java.lang.Object [^ScriptEngine this ^java.lang.String script]
    (-> this (.eval script))))
...
(defn get-factory
  ...
  (^javax.script.ScriptEngineFactory [^ScriptEngine this]
    (-> this (.getFactory))))
...
(defn get-context
  ...
  (^javax.script.ScriptContext [^ScriptEngine this]
    (-> this (.getContext))))
...
(defn get-bindings
  ...
  (^javax.script.Bindings [^ScriptEngine this ^Integer scope]
...
(defn get
  ...
  throws: java.lang.NullPointerException - if key is null."
  (^java.lang.Object [^ScriptEngine this ^java.lang.String key]
    (-> this (.get key))))
...
(defn set-bindings
  ...
  ([^ScriptEngine this ^javax.script.Bindings bindings ^Integer scope]
