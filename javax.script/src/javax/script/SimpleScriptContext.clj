...
(defn get-scopes
  ...
  ([^javax.script.SimpleScriptContext this]
    (-> this (.getScopes))))
...
(defn get-attribute
  ...
  ([^javax.script.SimpleScriptContext this ^java.lang.String name ^Integer scope]
    (-> this (.getAttribute name scope)))
  ([^javax.script.SimpleScriptContext this ^java.lang.String name]
...
(defn get-bindings
  ...
  ([^javax.script.SimpleScriptContext this ^Integer scope]
