...
(defn get-engine-version
  ...
  ([^javax.script.ScriptEngineFactory this]
...
(defn get-program
  ...
  ([^javax.script.ScriptEngineFactory this ^java.lang.String statements]
...
(defn get-output-statement
  ...
  ([^javax.script.ScriptEngineFactory this ^java.lang.String to-display]
...
(defn get-parameter
  ...
  ([^javax.script.ScriptEngineFactory this ^java.lang.String key]
...
(defn get-method-call-syntax
  ...
  ([^javax.script.ScriptEngineFactory this ^java.lang.String obj ^java.lang.String m ^java.lang.String args]
