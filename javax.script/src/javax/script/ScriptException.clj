...
(defn ->script-exception
  ...
  (^ScriptException [^java.lang.String message ^java.lang.String file-name ^Integer line-number ^Integer column-number]
    (new ScriptException message file-name line-number column-number))
  (^ScriptException [^java.lang.String message ^java.lang.String file-name ^Integer line-number]
...
(defn get-message
  ...
  (^java.lang.String [^ScriptException this]
    (-> this (.getMessage))))
