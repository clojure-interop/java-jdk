...
(defn *for-digit
  ...
  (^Character [^Integer digit ^Integer radix]
...
(defn *value-of
  ...
  (^java.lang.Character [^Character c]
    (Character/valueOf c)))
...
(defn *to-code-point
  ...
  (^Integer [^Character high ^Character low]
...
(defn *get-name
  ...
  (^java.lang.String [^Integer code-point]
...
(defn *to-chars
  ...
  throws: java.lang.IllegalArgumentException - if the specified codePoint is not a valid Unicode code point."
  (^Integer [^Integer code-point dst ^Integer dst-index]
...
(defn *offset-by-code-points
  ...
  (^Integer [a ^Integer start ^Integer count ^Integer index ^Integer code-point-offset]
    (Character/offsetByCodePoints a start count index code-point-offset))
  (^Integer [^java.lang.CharSequence seq ^Integer index ^Integer code-point-offset]
...
(defn *surrogate-pair?
  ...
  returns: true if the specified high and
   ...
   false otherwise. - `boolean`"
  (^Boolean [^Character high ^Character low]
...
(defn *code-point-count
  ...
  (^Integer [^java.lang.CharSequence seq ^Integer begin-index ^Integer end-index]
...
(defn *code-point-before
  ...
  throws: java.lang.NullPointerException - if a is null."
  (^Integer [a ^Integer index ^Integer start]
    (Character/codePointBefore a index start))
  (^Integer [^java.lang.CharSequence seq ^Integer index]
...
(defn *digit
  ...
  returns: the numeric value represented by the character in the
            specified radix. - `int`"
  (^Integer [^Character ch ^Integer radix]
...
(defn *code-point-at
  ...
  throws: java.lang.NullPointerException - if a is null."
  (^Integer [a ^Integer index ^Integer limit]
