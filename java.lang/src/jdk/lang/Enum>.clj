...
(defn name
  ...
  (^java.lang.String [^java.lang.Enum> this]
    (-> this (.name))))
...
(defn equals
  ...
  (^Boolean [^java.lang.Enum> this ^java.lang.Object other]
    (-> this (.equals other))))
...
(defn compare-to
  ...
  (^Integer [^java.lang.Enum> this ^Enum.E o]
    (-> this (.compareTo o))))
...
(defn get-declaring-class
  ...
  (^java.lang.Class [^java.lang.Enum> this]
