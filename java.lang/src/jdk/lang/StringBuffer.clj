...
(defn get-chars
  ...
  ([^StringBuffer this ^Integer src-begin ^Integer src-end dst ^Integer dst-begin]
...
(defn append-code-point
  ...
  (^java.lang.StringBuffer [^StringBuffer this ^Integer code-point]
...
(defn delete
  ...
  (^java.lang.StringBuffer [^StringBuffer this ^Integer start ^Integer end]
...
(defn reverse
  ...
  returns: a reference to this object. - `java.lang.StringBuffer`"
  (^java.lang.StringBuffer [^StringBuffer this]
    (-> this (.reverse))))
...
(defn to-string
  ...
  (^java.lang.String [^StringBuffer this]
    (-> this (.toString))))
...
(defn set-length
  ...
  ([^StringBuffer this ^Integer new-length]
...
(defn sub-sequence
  ...
  (^java.lang.CharSequence [^StringBuffer this ^Integer start ^Integer end]
...
(defn substring
  ...
  (^java.lang.String [^StringBuffer this ^Integer start ^Integer end]
    (-> this (.substring start end)))
  (^java.lang.String [^StringBuffer this ^Integer start]
...
(defn replace
  ...
  throws: java.lang.StringIndexOutOfBoundsException - if start is negative, greater than length(), or greater than end."
  (^java.lang.StringBuffer [^StringBuffer this ^Integer start ^Integer end ^java.lang.String str]
...
(defn delete-char-at
  ...
  (^java.lang.StringBuffer [^StringBuffer this ^Integer index]
...
(defn last-index-of
  ...
  (^Integer [^StringBuffer this ^java.lang.String str ^Integer from-index]
    (-> this (.lastIndexOf str from-index)))
  (^Integer [^StringBuffer this ^java.lang.String str]
...
(defn char-at
  ...
  (^Character [^StringBuffer this ^Integer index]
    (-> this (.charAt index))))
...
(defn offset-by-code-points
  ...
  (^Integer [^StringBuffer this ^Integer index ^Integer code-point-offset]
...
(defn ensure-capacity
  ...
  ([^StringBuffer this ^Integer minimum-capacity]
...
(defn append
  ...
  (^java.lang.StringBuffer [^StringBuffer this ^java.lang.CharSequence s ^Integer start ^Integer end]
    (-> this (.append s start end)))
  (^java.lang.StringBuffer [^StringBuffer this ^java.lang.Object obj]
    (-> this (.append obj))))
...
(defn set-char-at
  ...
  throws: java.lang.IndexOutOfBoundsException - if index is negative or greater than or equal to length()."
  ([^StringBuffer this ^Integer index ^Character ch]
...
(defn insert
  ...
  (^java.lang.StringBuffer [^StringBuffer this ^Integer index str ^Integer offset ^Integer len]
    (-> this (.insert index str offset len)))
  (^java.lang.StringBuffer [^StringBuffer this ^Integer offset ^java.lang.Object obj]
...
(defn code-point-count
  ...
  returns: the number of Unicode code points in the specified text
   range - `int`"
  (^Integer [^StringBuffer this ^Integer begin-index ^Integer end-index]
...
(defn code-point-before
  ...
  (^Integer [^StringBuffer this ^Integer index]
