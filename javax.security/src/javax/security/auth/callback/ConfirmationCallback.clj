...
(defn ->confirmation-callback
  ...
  (^ConfirmationCallback [^java.lang.String prompt ^Integer message-type ^Integer option-type ^Integer default-option]
    (new ConfirmationCallback prompt message-type option-type default-option))
  (^ConfirmationCallback [^Integer message-type ^Integer option-type ^Integer default-option]
...
(defn get-prompt
  ...
  (^java.lang.String [^ConfirmationCallback this]
    (-> this (.getPrompt))))
...
(defn get-message-type
  ...
  (^Integer [^ConfirmationCallback this]
    (-> this (.getMessageType))))
...
(defn set-selected-index
  ...
  ([^ConfirmationCallback this ^Integer selection]
