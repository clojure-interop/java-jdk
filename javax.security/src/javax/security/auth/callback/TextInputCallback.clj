...
(defn ->text-input-callback
  ...
  (^TextInputCallback [^java.lang.String prompt ^java.lang.String default-text]
...
(defn get-prompt
  ...
  (^java.lang.String [^TextInputCallback this]
    (-> this (.getPrompt))))
...
(defn set-text
  ...
  ([^TextInputCallback this ^java.lang.String text]
    (-> this (.setText text))))
