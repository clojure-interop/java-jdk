...
(defn unload-all-instruments
  ...
  ([^Synthesizer this ^javax.sound.midi.Soundbank soundbank]
...
(defn get-default-soundbank
  ...
  (^javax.sound.midi.Soundbank [^Synthesizer this]
...
(defn load-all-instruments
  ...
  (^Boolean [^Synthesizer this ^javax.sound.midi.Soundbank soundbank]
...
(defn load-instruments
  ...
  throws: java.lang.IllegalArgumentException - thrown if the soundbank is not supported."
  (^Boolean [^Synthesizer this ^javax.sound.midi.Soundbank soundbank patch-list]
...
(defn unload-instrument
  ...
  ([^Synthesizer this ^javax.sound.midi.Instrument instrument]
...
(defn load-instrument
  ...
  throws: java.lang.IllegalArgumentException - if this Synthesizer doesn't support the specified instrument's soundbank"
  (^Boolean [^Synthesizer this ^javax.sound.midi.Instrument instrument]
...
(defn remap-instrument
  ...
  (^Boolean [^Synthesizer this ^javax.sound.midi.Instrument from ^javax.sound.midi.Instrument to]
...
(defn unload-instruments
  ...
  throws: java.lang.IllegalArgumentException - thrown if the soundbank is not supported."
  ([^Synthesizer this ^javax.sound.midi.Soundbank soundbank patch-list]
