...
(defn get-soundbank
  ...
  (^javax.sound.midi.Soundbank [^javax.sound.midi.SoundbankResource this]
    (-> this (.getSoundbank))))
...
(defn get-name
  ...
  (^java.lang.String [^javax.sound.midi.SoundbankResource this]
    (-> this (.getName))))
...
(defn get-data-class
  ...
  (^java.lang.Class [^javax.sound.midi.SoundbankResource this]
    (-> this (.getDataClass))))
...
(defn get-data
  ...
  (^java.lang.Object [^javax.sound.midi.SoundbankResource this]
    (-> this (.getData))))
