...
(defn ->sysex-message
  ...
  (^SysexMessage [^Integer status data ^Integer length]
    (new SysexMessage status data length))
  (^SysexMessage [data ^Integer length]
...
(defn set-message
  ...
  ([^SysexMessage this ^Integer status data ^Integer length]
    (-> this (.setMessage status data length)))
  ([^SysexMessage this data ^Integer length]
...
(defn clone
  ...
  (^java.lang.Object [^SysexMessage this]
    (-> this (.clone))))
