...
(defn device-supported?
  ...
  returns: true if the specified device is supported, otherwise
           false - `boolean`"
  (^Boolean [^javax.sound.midi.spi.MidiDeviceProvider this ^javax.sound.midi.MidiDevice.Info info]
...
(defn get-device
  ...
  (^javax.sound.midi.MidiDevice [^javax.sound.midi.spi.MidiDeviceProvider this ^javax.sound.midi.MidiDevice.Info info]
    (-> this (.getDevice info))))
