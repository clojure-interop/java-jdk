...
(defn get-track-solo?
  ...
  (^Boolean [^Sequencer this ^Integer track]
...
(defn set-track-mute
  ...
  ([^Sequencer this ^Integer track ^Boolean mute]
...
(defn set-master-sync-mode
  ...
  ([^Sequencer this ^javax.sound.midi.Sequencer$SyncMode sync]
...
(defn record-enable
  ...
  ([^Sequencer this ^javax.sound.midi.Track track ^Integer channel]
...
(defn add-controller-event-listener
  ...
  ([^Sequencer this ^javax.sound.midi.ControllerEventListener listener controllers]
...
(defn get-sequence
  ...
  (^javax.sound.midi.Sequence [^Sequencer this]
    (-> this (.getSequence))))
...
(defn get-master-sync-mode
  ...
  (^javax.sound.midi.Sequencer$SyncMode [^Sequencer this]
...
(defn set-microsecond-position
  ...
  ([^Sequencer this ^Long microseconds]
...
(defn record-disable
  ...
  ([^Sequencer this ^javax.sound.midi.Track track]
...
(defn set-sequence
  ...
  ([^Sequencer this ^javax.sound.midi.Sequence sequence]
...
(defn remove-meta-event-listener
  ...
  ([^Sequencer this ^javax.sound.midi.MetaEventListener listener]
...
(defn set-track-solo
  ...
  ([^Sequencer this ^Integer track ^Boolean solo]
...
(defn add-meta-event-listener
  ...
  (^Boolean [^Sequencer this ^javax.sound.midi.MetaEventListener listener]
