...
(defn open
  ...
  ([^javax.sound.sampled.TargetDataLine this ^javax.sound.sampled.AudioFormat format ^Integer buffer-size]
    (-> this (.open format buffer-size)))
  ([^javax.sound.sampled.TargetDataLine this ^javax.sound.sampled.AudioFormat format]
    (-> this (.open format))))
