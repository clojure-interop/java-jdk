...
(defn get-late-reflection-delay
  ...
  (^Integer [^javax.sound.sampled.ReverbType this]
...
(defn to-string
  ...
  (^java.lang.String [^javax.sound.sampled.ReverbType this]
    (-> this (.toString))))
...
(defn get-early-reflection-intensity
  ...
  (^Float [^javax.sound.sampled.ReverbType this]
...
(defn equals
  ...
  (^Boolean [^javax.sound.sampled.ReverbType this ^java.lang.Object obj]
    (-> this (.equals obj))))
