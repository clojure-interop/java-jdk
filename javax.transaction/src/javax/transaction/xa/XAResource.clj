...
(defn forget
  ...
  ([^XAResource this ^javax.transaction.xa.Xid xid]
    (-> this (.forget xid))))
...
(defn set-transaction-timeout
  ...
  (^Boolean [^XAResource this ^Integer seconds]
...
(defn commit
  ...
  ([^XAResource this ^javax.transaction.xa.Xid xid ^Boolean one-phase]
...
(defn start
  ...
  ([^XAResource this ^javax.transaction.xa.Xid xid ^Integer flags]
...
(defn same-rm?
  ...
  throws: javax.transaction.xa.XAException - An error has occurred. Possible exception values are XAER_RMERR and XAER_RMFAIL."
  (^Boolean [^XAResource this ^javax.transaction.xa.XAResource xares]
    (-> this (.isSameRM xares))))
...
(defn prepare
  ...
  (^Integer [^XAResource this ^javax.transaction.xa.Xid xid]
    (-> this (.prepare xid))))
