...
(defn recover
  ...
  ([^javax.transaction.xa.XAResource this ^Integer flag]
    (-> this (.recover flag))))
...
(defn commit
  ...
  ([^javax.transaction.xa.XAResource this ^javax.transaction.xa.Xid xid ^Boolean one-phase]
...
(defn start
  ...
  ([^javax.transaction.xa.XAResource this ^javax.transaction.xa.Xid xid ^Integer flags]
