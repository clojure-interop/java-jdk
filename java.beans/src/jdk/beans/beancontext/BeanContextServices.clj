...
(defn get-service
  ...
  (^java.lang.Object [^BeanContextServices this ^java.beans.beancontext.BeanContextChild child ^java.lang.Object requestor ^java.lang.Class service-class ^java.lang.Object service-selector ^java.beans.beancontext.BeanContextServiceRevokedListener bcsrl]
...
(defn release-service
  ...
  ([^BeanContextServices this ^java.beans.beancontext.BeanContextChild child ^java.lang.Object requestor ^java.lang.Object service]
...
(defn has-service?
  ...
  (^Boolean [^BeanContextServices this ^java.lang.Class service-class]
...
(defn revoke-service
  ...
  ([^BeanContextServices this ^java.lang.Class service-class ^java.beans.beancontext.BeanContextServiceProvider service-provider ^Boolean revoke-current-services-now]
...
(defn add-service
  ...
  (^Boolean [^BeanContextServices this ^java.lang.Class service-class ^java.beans.beancontext.BeanContextServiceProvider service-provider]
...
(defn get-current-service-selectors
  ...
  (^java.util.Iterator [^BeanContextServices this ^java.lang.Class service-class]
...
(defn add-bean-context-services-listener
  ...
  ([^BeanContextServices this ^java.beans.beancontext.BeanContextServicesListener bcsl]
...
(defn get-current-service-classes
  ...
  (^java.util.Iterator [^BeanContextServices this]
