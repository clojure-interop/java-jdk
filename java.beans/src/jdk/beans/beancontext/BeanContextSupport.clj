...
(defn ->bean-context-support
  ...
  (^BeanContextSupport [^java.beans.beancontext.BeanContext peer ^java.util.Locale lcle ^Boolean d-time ^Boolean visible]
    (new BeanContextSupport peer lcle d-time visible))
  (^BeanContextSupport [^java.beans.beancontext.BeanContext peer ^java.util.Locale lcle ^Boolean dtime]
    (new BeanContextSupport peer lcle dtime))
  (^BeanContextSupport [^java.beans.beancontext.BeanContext peer ^java.util.Locale lcle]
    (new BeanContextSupport peer lcle))
  (^BeanContextSupport [^java.beans.beancontext.BeanContext peer]
...
(defn add-all
  ...
  (^Boolean [^BeanContextSupport this ^java.util.Collection c]
    (-> this (.addAll c))))
...
(defn get-bean-context-peer
  ...
  (^java.beans.beancontext.BeanContext [^BeanContextSupport this]
...
(defn needs-gui
  ...
  (^Boolean [^BeanContextSupport this]
    (-> this (.needsGui))))
...
(defn write-children
  ...
  ([^BeanContextSupport this ^java.io.ObjectOutputStream oos]
...
(defn get-resource
  ...
  (^java.net.URL [^BeanContextSupport this ^java.lang.String name ^java.beans.beancontext.BeanContextChild bcc]
...
(defn get-resource-as-stream
  ...
  (^java.io.InputStream [^BeanContextSupport this ^java.lang.String name ^java.beans.beancontext.BeanContextChild bcc]
...
(defn add-bean-context-membership-listener
  ...
  throws: java.lang.NullPointerException - if the argument is null"
  ([^BeanContextSupport this ^java.beans.beancontext.BeanContextMembershipListener bcml]
...
(defn contains
  ...
  (^Boolean [^BeanContextSupport this ^java.lang.Object o]
    (-> this (.contains o))))
...
(defn set-design-time
  ...
  ([^BeanContextSupport this ^Boolean d-time]
...
(defn get-locale
  ...
  (^java.util.Locale [^BeanContextSupport this]
    (-> this (.getLocale))))
...
(defn instantiate-child
  ...
  (^java.lang.Object [^BeanContextSupport this ^java.lang.String bean-name]
...
(defn iterator
  ...
  (^java.util.Iterator [^BeanContextSupport this]
    (-> this (.iterator))))
...
(defn property-change
  ...
  ([^BeanContextSupport this ^java.beans.PropertyChangeEvent pce]
...
(defn remove
  ...
  (^Boolean [^BeanContextSupport this ^java.lang.Object target-child]
...
(defn set-locale
  ...
  ([^BeanContextSupport this ^java.util.Locale new-locale]
...
(defn size
  ...
  (^Integer [^BeanContextSupport this]
    (-> this (.size))))
...
(defn read-children
  ...
  ([^BeanContextSupport this ^java.io.ObjectInputStream ois]
