...
(defn ->bean-context-child-support
  ...
  (^BeanContextChildSupport [^java.beans.beancontext.BeanContextChild bcc]
...
(defn fire-property-change
  ...
  ([^BeanContextChildSupport this ^java.lang.String name ^java.lang.Object old-value ^java.lang.Object new-value]
...
(defn validate-pending-set-bean-context
  ...
  (^Boolean [^BeanContextChildSupport this ^java.beans.beancontext.BeanContext new-value]
...
(defn remove-property-change-listener
  ...
  ([^BeanContextChildSupport this ^java.lang.String name ^java.beans.PropertyChangeListener pcl]
...
(defn delegated?
  ...
  (^Boolean [^BeanContextChildSupport this]
    (-> this (.isDelegated))))
...
(defn set-bean-context
  ...
  ([^BeanContextChildSupport this ^java.beans.beancontext.BeanContext bc]
...
(defn get-bean-context
  ...
  (^java.beans.beancontext.BeanContext [^BeanContextChildSupport this]
    (-> this (.getBeanContext))))
...
(defn remove-vetoable-change-listener
  ...
  ([^BeanContextChildSupport this ^java.lang.String name ^java.beans.VetoableChangeListener vcl]
...
(defn service-available
  ...
  ([^BeanContextChildSupport this ^java.beans.beancontext.BeanContextServiceAvailableEvent bcsae]
...
(defn service-revoked
  ...
  ([^BeanContextChildSupport this ^java.beans.beancontext.BeanContextServiceRevokedEvent bcsre]
