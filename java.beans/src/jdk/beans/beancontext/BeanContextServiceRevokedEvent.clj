...
(defn ->bean-context-service-revoked-event
  ...
  (^BeanContextServiceRevokedEvent [^java.beans.beancontext.BeanContextServices bcs ^java.lang.Class sc ^Boolean invalidate]
...
(defn get-source-as-bean-context-services
  ...
  (^java.beans.beancontext.BeanContextServices [^BeanContextServiceRevokedEvent this]
...
(defn get-service-class
  ...
  (^java.lang.Class [^BeanContextServiceRevokedEvent this]
...
(defn service-class?
  ...
  (^Boolean [^BeanContextServiceRevokedEvent this ^java.lang.Class service]
...
(defn current-service-invalid-now?
  ...
  (^Boolean [^BeanContextServiceRevokedEvent this]
