...
(defn ->vetoable-change-listener-proxy
  ...
  ([^java.lang.String property-name ^java.beans.VetoableChangeListener listener]
...
(defn vetoable-change
  ...
  ([^java.beans.VetoableChangeListenerProxy this ^java.beans.PropertyChangeEvent event]
