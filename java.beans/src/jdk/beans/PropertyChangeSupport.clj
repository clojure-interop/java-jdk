...
(defn ->property-change-support
  ...
  (^PropertyChangeSupport [^java.lang.Object source-bean]
...
(defn add-property-change-listener
  ...
  ([^PropertyChangeSupport this ^java.lang.String property-name ^java.beans.PropertyChangeListener listener]
    (-> this (.addPropertyChangeListener property-name listener)))
  ([^PropertyChangeSupport this ^java.beans.PropertyChangeListener listener]
...
(defn get-property-change-listeners
  ...
  ([^PropertyChangeSupport this ^java.lang.String property-name]
...
(defn fire-property-change
  ...
  ([^PropertyChangeSupport this ^java.lang.String property-name ^java.lang.Object old-value ^java.lang.Object new-value]
    (-> this (.firePropertyChange property-name old-value new-value)))
  ([^PropertyChangeSupport this ^java.beans.PropertyChangeEvent event]
...
(defn fire-indexed-property-change
  ...
  old-value - the old value of the property - `java.lang.Object`
  new-value - the new value of the property - `java.lang.Object`"
  ([^PropertyChangeSupport this ^java.lang.String property-name ^Integer index ^java.lang.Object old-value ^java.lang.Object new-value]
...
(defn has-listeners?
  ...
  (^Boolean [^PropertyChangeSupport this ^java.lang.String property-name]
