...
(defn paint-value
  ...
  ([^PropertyEditor this ^java.awt.Graphics gfx ^java.awt.Rectangle box]
...
(defn set-as-text
  ...
  ([^PropertyEditor this ^java.lang.String text]
    (-> this (.setAsText text))))
...
(defn get-as-text
  ...
  (^java.lang.String [^PropertyEditor this]
    (-> this (.getAsText))))
...
(defn get-custom-editor
  ...
  (^java.awt.Component [^PropertyEditor this]
...
(defn remove-property-change-listener
  ...
  ([^PropertyEditor this ^java.beans.PropertyChangeListener listener]
