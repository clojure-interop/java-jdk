...
(defn ->volatile-call-site
  ...
  (^VolatileCallSite [^java.lang.invoke.MethodType type]
...
(defn get-target
  ...
  (^java.lang.invoke.MethodHandle [^VolatileCallSite this]
    (-> this (.getTarget))))
...
(defn set-target
  ...
  ([^VolatileCallSite this ^java.lang.invoke.MethodHandle new-target]
