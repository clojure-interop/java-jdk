...
(defn get-type
  ...
  (^java.lang.management.MemoryType [^MemoryPoolMXBean this]
    (-> this (.getType))))
...
(defn get-peak-usage
  ...
  (^java.lang.management.MemoryUsage [^MemoryPoolMXBean this]
    (-> this (.getPeakUsage))))
...
(defn get-name
  ...
  (^java.lang.String [^MemoryPoolMXBean this]
    (-> this (.getName))))
...
(defn set-usage-threshold
  ...
  ([^MemoryPoolMXBean this ^Long threshold]
