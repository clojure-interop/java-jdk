...
(defn ->bidi
  ...
  (^Bidi [text ^Integer text-start embeddings ^Integer emb-start ^Integer paragraph-length ^Integer flags]
    (new Bidi text text-start embeddings emb-start paragraph-length flags))
  (^Bidi [^java.lang.String paragraph ^Integer flags]
    (new Bidi paragraph flags))
  (^Bidi [^java.text.AttributedCharacterIterator paragraph]
    (new Bidi paragraph)))
...
(defn get-level-at
  ...
  (^Integer [^Bidi this ^Integer offset]
...
(defn create-line-bidi
  ...
  (^java.text.Bidi [^Bidi this ^Integer line-start ^Integer line-limit]
