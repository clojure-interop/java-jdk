...
(defn get-rules
  ...
  (^java.lang.String [^RuleBasedCollator this]
    (-> this (.getRules))))
...
(defn get-collation-element-iterator
  ...
  (^java.text.CollationElementIterator [^RuleBasedCollator this ^java.lang.String source]
...
(defn compare
  ...
  (^Integer [^RuleBasedCollator this ^java.lang.String source ^java.lang.String target]
...
(defn get-collation-key
  ...
  (^java.text.CollationKey [^RuleBasedCollator this ^java.lang.String source]
...
(defn clone
  ...
  (^java.lang.Object [^RuleBasedCollator this]
    (-> this (.clone))))
...
(defn equals
  ...
  (^Boolean [^RuleBasedCollator this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn hash-code
  ...
  (^Integer [^RuleBasedCollator this]
    (-> this (.hashCode))))
