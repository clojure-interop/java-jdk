...
(defn set-index
  ...
  ([^ParsePosition this ^Integer index]
    (-> this (.setIndex index))))
...
(defn equals
  ...
  (^Boolean [^ParsePosition this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn to-string
  ...
  (^java.lang.String [^ParsePosition this]
    (-> this (.toString))))
