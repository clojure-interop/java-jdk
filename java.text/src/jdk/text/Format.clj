...
(defn format
  ...
  ([^java.text.Format this ^java.lang.Object obj ^java.lang.StringBuffer to-append-to ^java.text.FieldPosition pos]
    (-> this (.format obj to-append-to pos)))
  ([^java.text.Format this ^java.lang.Object obj]
    (-> this (.format obj))))
...
(defn parse-object
  ...
  ([^java.text.Format this ^java.lang.String source ^java.text.ParsePosition pos]
    (-> this (.parseObject source pos)))
  ([^java.text.Format this ^java.lang.String source]
