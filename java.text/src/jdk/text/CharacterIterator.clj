...
(defn next
  ...
  (^Character [^java.text.CharacterIterator this]
    (-> this (.next))))
...
(defn get-index
  ...
  (^Integer [^java.text.CharacterIterator this]
    (-> this (.getIndex))))
...
(defn set-index
  ...
  (^Character [^java.text.CharacterIterator this ^Integer position]
...
(defn clone
  ...
  (^java.lang.Object [^java.text.CharacterIterator this]
    (-> this (.clone))))
