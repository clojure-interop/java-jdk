...
(defn change-selection
  ...
  ([this row-index column-index toggle extend]
...
(defn set-auto-create-columns-from-model
  ...
  ([this auto-create-columns-from-model]
...
(defn set-surrenders-focus-on-keystroke
  ...
  ([this surrenders-focus-on-keystroke]
...
(defn print
  ...
  ([this print-mode header-format footer-format show-print-dialog attr interactive service]
    (-> this (.print print-mode header-format footer-format show-print-dialog attr interactive service)))
  ([this print-mode header-format footer-format show-print-dialog attr interactive]
    (-> this (.print print-mode header-format footer-format show-print-dialog attr interactive)))
  ([this print-mode header-format footer-format]
...
(defn get-cell-rect
  ...
  ([this row column include-spacing]
