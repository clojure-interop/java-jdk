...
(defn paint-border
  ...
  ([^MetalBorders$MenuBarBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^MetalBorders$MenuBarBorder this ^java.awt.Component c ^java.awt.Insets new-insets]
