...
(defn paint-border
  ...
  ([^MetalBorders$MenuItemBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^MetalBorders$MenuItemBorder this ^java.awt.Component c ^java.awt.Insets new-insets]
