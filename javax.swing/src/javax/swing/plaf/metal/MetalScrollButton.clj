...
(defn ->metal-scroll-button
  ...
  (^MetalScrollButton [^Integer direction ^Integer width ^Boolean free-standing]
    (new MetalScrollButton direction width free-standing)))

(defn set-free-standing
  "free-standing - `boolean`"
  ([^MetalScrollButton this ^Boolean free-standing]
...
(defn paint
  ...
  ([^MetalScrollButton this ^java.awt.Graphics g]
    (-> this (.paint g))))
...
(defn get-preferred-size
  ...
  (^java.awt.Dimension [^MetalScrollButton this]
...
(defn get-button-width
  "returns: `int`"
  (^Integer [^MetalScrollButton this]
    (-> this (.getButtonWidth))))
