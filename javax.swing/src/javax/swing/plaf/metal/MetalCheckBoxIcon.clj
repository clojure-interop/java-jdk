...
(defn paint-icon
  ...
  x - `int`
  y - `int`"
  ([^javax.swing.plaf.metal.MetalCheckBoxIcon this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y]
...
(defn get-icon-width
  ...
  (^Integer [^javax.swing.plaf.metal.MetalCheckBoxIcon this]
    (-> this (.getIconWidth))))
