...
(defn paint-border
  ...
  ([^MetalBorders$TableHeaderBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^MetalBorders$TableHeaderBorder this ^java.awt.Component c ^java.awt.Insets insets]
