...
(defn install-ui
  ...
  ([^MultiToolTipUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiToolTipUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiToolTipUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  (^Boolean [^MultiToolTipUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiToolTipUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^MultiToolTipUI this ^javax.swing.JComponent a]
