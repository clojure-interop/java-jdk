...
(defn install-ui
  ...
  ([^MultiMenuBarUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiMenuBarUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiMenuBarUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  (^Boolean [^MultiMenuBarUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiMenuBarUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^MultiMenuBarUI this ^javax.swing.JComponent a]
