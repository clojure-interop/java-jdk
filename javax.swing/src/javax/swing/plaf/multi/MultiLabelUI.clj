(ns javax.swing.plaf.multi.MultiLabelUI
...
(defn install-ui
  ...
  ([^javax.swing.plaf.multi.MultiLabelUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^javax.swing.plaf.multi.MultiLabelUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^javax.swing.plaf.multi.MultiLabelUI this ^javax.swing.JComponent a ^Integer b]
...
(defn get-u-is
  ...
  returns: `javax.swing.plaf.ComponentUI[]`"
  ([^javax.swing.plaf.multi.MultiLabelUI this]
    (-> this (.getUIs))))
...
(defn contains
  ...
  (^Boolean [^javax.swing.plaf.multi.MultiLabelUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^javax.swing.plaf.multi.MultiLabelUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^javax.swing.plaf.multi.MultiLabelUI this ^javax.swing.JComponent a]
