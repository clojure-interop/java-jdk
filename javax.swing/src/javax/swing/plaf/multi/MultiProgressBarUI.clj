...
(defn install-ui
  ...
  ([^MultiProgressBarUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiProgressBarUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiProgressBarUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  (^Boolean [^MultiProgressBarUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiProgressBarUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^MultiProgressBarUI this ^javax.swing.JComponent a]
