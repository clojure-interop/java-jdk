...
(defn install-ui
  ...
  ([^MultiTableHeaderUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiTableHeaderUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiTableHeaderUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  (^Boolean [^MultiTableHeaderUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiTableHeaderUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^MultiTableHeaderUI this ^javax.swing.JComponent a]
