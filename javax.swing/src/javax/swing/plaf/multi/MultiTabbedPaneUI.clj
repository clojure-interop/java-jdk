...
(defn install-ui
  ...
  ([^MultiTabbedPaneUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiTabbedPaneUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiTabbedPaneUI this ^javax.swing.JComponent a ^Integer b]
...
(defn get-tab-run-count
  ...
  (^Integer [^MultiTabbedPaneUI this ^javax.swing.JTabbedPane a]
...
(defn contains
  ...
  (^Boolean [^MultiTabbedPaneUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiTabbedPaneUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn tab-for-coordinate
  ...
  returns: the value obtained from the first UI, which is
   the UI obtained from the default LookAndFeel - `int`"
  (^Integer [^MultiTabbedPaneUI this ^javax.swing.JTabbedPane a ^Integer b ^Integer c]
...
(defn get-accessible-children-count
  ...
  returns: the value obtained from the first UI, which is
   the UI obtained from the default LookAndFeel - `int`"
  (^Integer [^MultiTabbedPaneUI this ^javax.swing.JComponent a]
...
(defn get-tab-bounds
  ...
  (^java.awt.Rectangle [^MultiTabbedPaneUI this ^javax.swing.JTabbedPane a ^Integer b]
