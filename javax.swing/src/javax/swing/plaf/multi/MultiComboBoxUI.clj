...
(defn get-accessible-child
  ...
  ([^javax.swing.plaf.multi.MultiComboBoxUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  ([^javax.swing.plaf.multi.MultiComboBoxUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn focus-traversable?
  ...
  returns: the value obtained from the first UI, which is
   the UI obtained from the default LookAndFeel - `boolean`"
  ([^javax.swing.plaf.multi.MultiComboBoxUI this ^javax.swing.JComboBox a]
