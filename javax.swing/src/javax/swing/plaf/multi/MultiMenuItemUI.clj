...
(defn install-ui
  ...
  ([^MultiMenuItemUI this ^javax.swing.JComponent a]
    (-> this (.installUI a))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^MultiMenuItemUI this ^javax.swing.JComponent a]
...
(defn get-accessible-child
  ...
  (^javax.accessibility.Accessible [^MultiMenuItemUI this ^javax.swing.JComponent a ^Integer b]
...
(defn contains
  ...
  (^Boolean [^MultiMenuItemUI this ^javax.swing.JComponent a ^Integer b ^Integer c]
    (-> this (.contains a b c))))
...
(defn update
  ...
  ([^MultiMenuItemUI this ^java.awt.Graphics a ^javax.swing.JComponent b]
    (-> this (.update a b))))
...
(defn get-accessible-children-count
  ...
  (^Integer [^MultiMenuItemUI this ^javax.swing.JComponent a]
