...
(defn install-ui
  ...
  ([^LayerUI this ^javax.swing.JComponent c]
    (-> this (.installUI c))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^LayerUI this ^javax.swing.JComponent c]
...
(defn get-baseline-resize-behavior
  ...
  (^java.awt.Component$BaselineResizeBehavior [^LayerUI this ^javax.swing.JComponent c]
...
(defn remove-property-change-listener
  ...
  ([^LayerUI this ^java.lang.String property-name ^java.beans.PropertyChangeListener listener]
    (-> this (.removePropertyChangeListener property-name listener)))
  ([^LayerUI this ^java.beans.PropertyChangeListener listener]
...
(defn apply-property-change
  ...
  ([^LayerUI this ^java.beans.PropertyChangeEvent evt ^javax.swing.JLayer l]
...
(defn paint-immediately
  ...
  ([^LayerUI this ^Integer x ^Integer y ^Integer width ^Integer height ^javax.swing.JLayer l]
...
(defn paint
  ...
  ([^LayerUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.paint g c))))
...
(defn get-property-change-listeners
  ...
  ([^LayerUI this ^java.lang.String property-name]
...
(defn do-layout
  ...
  ([^LayerUI this ^javax.swing.JLayer l]
    (-> this (.doLayout l))))
...
(defn event-dispatched
  ...
  ([^LayerUI this ^java.awt.AWTEvent e ^javax.swing.JLayer l]
...
(defn get-baseline
  ...
  returns: baseline or a value < 0 indicating there is no reasonable
                    baseline - `int`"
  (^Integer [^LayerUI this ^javax.swing.JComponent c ^Integer width ^Integer height]
