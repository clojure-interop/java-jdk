...
(defn ->toggle-button-border
  ...
  (^BasicBorders$ToggleButtonBorder [^java.awt.Color shadow ^java.awt.Color dark-shadow ^java.awt.Color highlight ^java.awt.Color light-highlight]
...
(defn paint-border
  ...
  ([^BasicBorders$ToggleButtonBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer width ^Integer height]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^BasicBorders$ToggleButtonBorder this ^java.awt.Component c ^java.awt.Insets insets]
