...
(defn install-ui
  ...
  ([^BasicSeparatorUI this ^javax.swing.JComponent c]
    (-> this (.installUI c))))
...
(defn paint
  ...
  ([^BasicSeparatorUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.paint g c))))
...
(defn get-preferred-size
  ...
  (^java.awt.Dimension [^BasicSeparatorUI this ^javax.swing.JComponent c]
