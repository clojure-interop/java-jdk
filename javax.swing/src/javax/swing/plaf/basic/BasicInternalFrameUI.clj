...
(defn install-ui
  ...
  ([^BasicInternalFrameUI this ^javax.swing.JComponent c]
    (-> this (.installUI c))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^BasicInternalFrameUI this ^javax.swing.JComponent x]
...
(defn get-west-pane
  ...
  (^javax.swing.JComponent [^BasicInternalFrameUI this]
    (-> this (.getWestPane))))
...
(defn key-binding-active?
  "returns: `boolean`"
  (^Boolean [^BasicInternalFrameUI this]
