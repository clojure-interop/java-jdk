...
(defn paint-border
  ...
  ([^javax.swing.plaf.basic.BasicBorders$RadioButtonBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer width ^Integer height]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^javax.swing.plaf.basic.BasicBorders$RadioButtonBorder this ^java.awt.Component c ^java.awt.Insets insets]
