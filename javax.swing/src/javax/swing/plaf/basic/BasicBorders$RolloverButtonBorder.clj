...
(defn ->rollover-button-border
  ...
  (^BasicBorders$RolloverButtonBorder [^java.awt.Color shadow ^java.awt.Color dark-shadow ^java.awt.Color highlight ^java.awt.Color light-highlight]
...
(defn paint-border
  ...
  ([^BasicBorders$RolloverButtonBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
