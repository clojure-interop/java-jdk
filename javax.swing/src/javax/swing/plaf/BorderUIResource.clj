...
(defn ->border-ui-resource
  ...
  (^BorderUIResource [^javax.swing.border.Border delegate]
...
(defn paint-border
  ...
  ([^BorderUIResource this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer width ^Integer height]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^BorderUIResource this ^java.awt.Component c]
