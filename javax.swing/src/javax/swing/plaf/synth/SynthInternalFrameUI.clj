(ns javax.swing.plaf.synth.SynthInternalFrameUI
...
(defn *create-ui
  ...
  (^javax.swing.plaf.ComponentUI [^javax.swing.JComponent b]
    (SynthInternalFrameUI/createUI b)))

(defn install-defaults
  ""
  ([^javax.swing.plaf.synth.SynthInternalFrameUI this]
...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^javax.swing.plaf.synth.SynthInternalFrameUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^javax.swing.plaf.synth.SynthInternalFrameUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^javax.swing.plaf.synth.SynthInternalFrameUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^javax.swing.plaf.synth.SynthInternalFrameUI this ^java.beans.PropertyChangeEvent evt]
