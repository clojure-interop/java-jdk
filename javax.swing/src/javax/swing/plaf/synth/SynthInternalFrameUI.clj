...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthInternalFrameUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^SynthInternalFrameUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^SynthInternalFrameUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^SynthInternalFrameUI this ^java.beans.PropertyChangeEvent evt]
