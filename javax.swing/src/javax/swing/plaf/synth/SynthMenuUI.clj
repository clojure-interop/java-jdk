...
(defn uninstall-ui
  ...
  ([^SynthMenuUI this ^javax.swing.JComponent c]
    (-> this (.uninstallUI c))))
...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthMenuUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^SynthMenuUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^SynthMenuUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^SynthMenuUI this ^java.beans.PropertyChangeEvent e]
