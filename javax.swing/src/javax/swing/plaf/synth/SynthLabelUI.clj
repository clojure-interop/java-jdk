...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^javax.swing.plaf.synth.SynthLabelUI this ^javax.swing.JComponent c]
...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^javax.swing.plaf.synth.SynthLabelUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn get-baseline
  ...
  returns: baseline or a value < 0 indicating there is no reasonable
                    baseline - `int`"
  (^Integer [^javax.swing.plaf.synth.SynthLabelUI this ^javax.swing.JComponent c ^Integer width ^Integer height]
