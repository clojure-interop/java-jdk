...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthScrollBarUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^SynthScrollBarUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^SynthScrollBarUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn get-preferred-size
  ...
  (^java.awt.Dimension [^SynthScrollBarUI this ^javax.swing.JComponent c]
...
(defn property-change
  ...
  ([^SynthScrollBarUI this ^java.beans.PropertyChangeEvent e]
