...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthMenuBarUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^SynthMenuBarUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^SynthMenuBarUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^SynthMenuBarUI this ^java.beans.PropertyChangeEvent e]
