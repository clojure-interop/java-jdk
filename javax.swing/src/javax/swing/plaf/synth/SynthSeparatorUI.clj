...
(defn install-ui
  ...
  ([^SynthSeparatorUI this ^javax.swing.JComponent c]
    (-> this (.installUI c))))
...
(defn get-minimum-size
  ...
  (^java.awt.Dimension [^SynthSeparatorUI this ^javax.swing.JComponent c]
...
(defn uninstall-listeners
  ...
  ([^SynthSeparatorUI this ^javax.swing.JSeparator c]
...
(defn paint-border
  ...
  ([^SynthSeparatorUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn update
  ...
  ([^SynthSeparatorUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn property-change
  ...
  ([^SynthSeparatorUI this ^java.beans.PropertyChangeEvent evt]
...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthSeparatorUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
