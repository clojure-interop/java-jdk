...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^SynthToolBarUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^SynthToolBarUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^SynthToolBarUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^SynthToolBarUI this ^java.beans.PropertyChangeEvent e]
