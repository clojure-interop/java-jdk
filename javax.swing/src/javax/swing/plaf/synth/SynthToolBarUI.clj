(ns javax.swing.plaf.synth.SynthToolBarUI
  "Provides the Synth L&F UI delegate for
  JToolBar."
  (:refer-clojure :only [require comment defn ->])
  (:import [javax.swing.plaf.synth SynthToolBarUI]))

(defn ->synth-tool-bar-ui
  "Constructor."
  ([]
    (new SynthToolBarUI )))
...
(defn get-context
  ...
  (^javax.swing.plaf.synth.SynthContext [^javax.swing.plaf.synth.SynthToolBarUI this ^javax.swing.JComponent c]
    (-> this (.getContext c))))
...
(defn update
  ...
  ([^javax.swing.plaf.synth.SynthToolBarUI this ^java.awt.Graphics g ^javax.swing.JComponent c]
    (-> this (.update g c))))
...
(defn paint-border
  ...
  ([^javax.swing.plaf.synth.SynthToolBarUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
...
(defn property-change
  ...
  ([^javax.swing.plaf.synth.SynthToolBarUI this ^java.beans.PropertyChangeEvent e]
