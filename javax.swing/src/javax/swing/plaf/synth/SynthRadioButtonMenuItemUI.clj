...
(defn paint-border
  ...
  ([^javax.swing.plaf.synth.SynthRadioButtonMenuItemUI this ^javax.swing.plaf.synth.SynthContext context ^java.awt.Graphics g ^Integer x ^Integer y ^Integer w ^Integer h]
