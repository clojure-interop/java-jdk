...
(defn invalidate-layout
  ...
  ([^OverlayLayout this ^java.awt.Container target]
...
(defn get-layout-alignment-y
  ...
  (^Float [^OverlayLayout this ^java.awt.Container target]
...
(defn preferred-layout-size
  ...
  (^java.awt.Dimension [^OverlayLayout this ^java.awt.Container target]
...
(defn get-target
  ...
  (^java.awt.Container [^OverlayLayout this]
    (-> this (.getTarget))))
...
(defn add-layout-component
  ...
  ([^OverlayLayout this ^java.lang.String name ^java.awt.Component comp]
...
(defn remove-layout-component
  ...
  ([^OverlayLayout this ^java.awt.Component comp]
