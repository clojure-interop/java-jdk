...
(defn ->progress-monitor-input-stream
  ...
  (^ProgressMonitorInputStream [^java.awt.Component parent-component ^java.lang.Object message ^java.io.InputStream in]
...
(defn get-progress-monitor
  ...
  (^javax.swing.ProgressMonitor [^ProgressMonitorInputStream this]
...
(defn read
  ...
  (^Integer [^ProgressMonitorInputStream this b ^Integer off ^Integer len]
    (-> this (.read b off len)))
  (^Integer [^ProgressMonitorInputStream this b]
    (-> this (.read b)))
  (^Integer [^ProgressMonitorInputStream this]
    (-> this (.read))))
...
(defn skip
  ...
  (^Long [^ProgressMonitorInputStream this ^Long n]
    (-> this (.skip n))))
