...
(defn ->line-border
  ...
  (^LineBorder [^java.awt.Color color ^Integer thickness ^Boolean rounded-corners]
    (new LineBorder color thickness rounded-corners))
  (^LineBorder [^java.awt.Color color ^Integer thickness]
...
(defn paint-border
  ...
  ([^LineBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer width ^Integer height]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^LineBorder this ^java.awt.Component c ^java.awt.Insets insets]
...
(defn get-line-color
  ...
  (^java.awt.Color [^LineBorder this]
    (-> this (.getLineColor))))
