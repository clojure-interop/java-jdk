...
(defn ->compound-border
  ...
  (^CompoundBorder [^javax.swing.border.Border outside-border ^javax.swing.border.Border inside-border]
...
(defn paint-border
  ...
  ([^CompoundBorder this ^java.awt.Component c ^java.awt.Graphics g ^Integer x ^Integer y ^Integer width ^Integer height]
...
(defn get-border-insets
  ...
  (^java.awt.Insets [^CompoundBorder this ^java.awt.Component c ^java.awt.Insets insets]
...
(defn get-outside-border
  ...
  (^javax.swing.border.Border [^CompoundBorder this]
