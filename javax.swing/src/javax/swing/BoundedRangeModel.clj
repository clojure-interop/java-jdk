...
(defn add-change-listener
  ...
  ([^javax.swing.BoundedRangeModel this ^javax.swing.event.ChangeListener x]
...
(defn get-value-is-adjusting?
  ...
  (^Boolean [^javax.swing.BoundedRangeModel this]
...
(defn get-minimum
  ...
  (^Integer [^javax.swing.BoundedRangeModel this]
    (-> this (.getMinimum))))
...
(defn set-extent
  ...
  ([^javax.swing.BoundedRangeModel this ^Integer new-extent]
...
(defn set-maximum
  ...
  ([^javax.swing.BoundedRangeModel this ^Integer new-maximum]
...
(defn set-range-properties
  ...
  ([^javax.swing.BoundedRangeModel this ^Integer value ^Integer extent ^Integer min ^Integer max ^Boolean adjusting]
...
(defn set-value-is-adjusting
  ...
  ([^javax.swing.BoundedRangeModel this ^Boolean b]
...
(defn set-value
  ...
  ([^javax.swing.BoundedRangeModel this ^Integer new-value]
...
(defn set-minimum
  ...
  ([^javax.swing.BoundedRangeModel this ^Integer new-minimum]
