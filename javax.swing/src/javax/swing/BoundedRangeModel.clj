...
(defn add-change-listener
  ...
  ([^BoundedRangeModel this ^javax.swing.event.ChangeListener x]
...
(defn get-value-is-adjusting?
  ...
  (^Boolean [^BoundedRangeModel this]
...
(defn get-minimum
  ...
  (^Integer [^BoundedRangeModel this]
    (-> this (.getMinimum))))
...
(defn set-extent
  ...
  ([^BoundedRangeModel this ^Integer new-extent]
...
(defn set-maximum
  ...
  ([^BoundedRangeModel this ^Integer new-maximum]
...
(defn set-range-properties
  ...
  ([^BoundedRangeModel this ^Integer value ^Integer extent ^Integer min ^Integer max ^Boolean adjusting]
...
(defn set-value-is-adjusting
  ...
  ([^BoundedRangeModel this ^Boolean b]
...
(defn set-value
  ...
  ([^BoundedRangeModel this ^Integer new-value]
...
(defn set-minimum
  ...
  ([^BoundedRangeModel this ^Integer new-minimum]
