...
(defn ->ancestor-event
  ...
  (^AncestorEvent [^javax.swing.JComponent source ^Integer id ^java.awt.Container ancestor ^java.awt.Container ancestor-parent]
...
(defn get-ancestor
  ...
  (^java.awt.Container [^AncestorEvent this]
    (-> this (.getAncestor))))
...
(defn get-component
  ...
  (^javax.swing.JComponent [^AncestorEvent this]
    (-> this (.getComponent))))
