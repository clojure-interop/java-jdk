...
(defn get-document
  ...
  (^javax.swing.text.Document [^DocumentEvent this]
    (-> this (.getDocument))))
...
(defn get-type
  ...
  (^javax.swing.event.DocumentEvent$EventType [^DocumentEvent this]
    (-> this (.getType))))
...
(defn get-change
  ...
  (^javax.swing.event.DocumentEvent$ElementChange [^DocumentEvent this ^javax.swing.text.Element elem]
    (-> this (.getChange elem))))
