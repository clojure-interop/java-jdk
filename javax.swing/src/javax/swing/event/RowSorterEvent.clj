...
(defn ->row-sorter-event
  ...
  (^RowSorterEvent [^javax.swing.RowSorter source ^javax.swing.event.RowSorterEvent$Type type previous-row-index-to-model]
    (new RowSorterEvent source type previous-row-index-to-model))
  (^RowSorterEvent [^javax.swing.RowSorter source]
...
(defn get-source
  ...
  (^javax.swing.RowSorter [^RowSorterEvent this]
    (-> this (.getSource))))
...
(defn get-type
  ...
  (^javax.swing.event.RowSorterEvent$Type [^RowSorterEvent this]
    (-> this (.getType))))
...
(defn convert-previous-row-index-to-model
  ...
  (^Integer [^RowSorterEvent this ^Integer index]
