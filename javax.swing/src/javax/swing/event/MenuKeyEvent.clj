...
(defn ->menu-key-event
  ...
  (^MenuKeyEvent [^java.awt.Component source ^Integer id ^Long when ^Integer modifiers ^Integer key-code ^Character key-char p ^javax.swing.MenuSelectionManager m]
...
(defn get-menu-selection-manager
  ...
  (^javax.swing.MenuSelectionManager [^MenuKeyEvent this]
