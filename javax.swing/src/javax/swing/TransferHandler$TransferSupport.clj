...
(defn ->transfer-support
  ...
  (^TransferHandler$TransferSupport [^java.awt.Component component ^java.awt.datatransfer.Transferable transferable]
...
(defn get-component
  ...
  (^java.awt.Component [^TransferHandler$TransferSupport this]
    (-> this (.getComponent))))
...
(defn drop?
  ...
  (^Boolean [^TransferHandler$TransferSupport this]
    (-> this (.isDrop))))
...
(defn get-source-drop-actions
  ...
  (^Integer [^TransferHandler$TransferSupport this]
...
(defn get-drop-location
  ...
  throws: java.lang.IllegalStateException - if this is not a drop"
  (^javax.swing.TransferHandler$DropLocation [^TransferHandler$TransferSupport this]
...
(defn get-transferable
  ...
  (^java.awt.datatransfer.Transferable [^TransferHandler$TransferSupport this]
...
(defn set-show-drop-location
  ...
  throws: java.lang.IllegalStateException - if this is not a drop"
  ([^TransferHandler$TransferSupport this ^Boolean show-drop-location]
...
(defn set-drop-action
  ...
  throws: java.lang.IllegalStateException - if this is not a drop"
  ([^TransferHandler$TransferSupport this ^Integer drop-action]
...
(defn get-data-flavors
  ...
  ([^TransferHandler$TransferSupport this]
    (-> this (.getDataFlavors))))
...
(defn data-flavor-supported?
  ...
  (^Boolean [^TransferHandler$TransferSupport this ^java.awt.datatransfer.DataFlavor df]
