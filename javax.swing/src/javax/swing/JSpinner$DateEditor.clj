...
(defn ->date-editor
  ...
  (^JSpinner$DateEditor [^javax.swing.JSpinner spinner ^java.lang.String date-format-pattern]
    (new JSpinner$DateEditor spinner date-format-pattern))
  (^JSpinner$DateEditor [^javax.swing.JSpinner spinner]
...
(defn get-format
  ...
  (^java.text.SimpleDateFormat [^JSpinner$DateEditor this]
    (-> this (.getFormat))))
...
(defn get-model
  ...
  (^javax.swing.SpinnerDateModel [^JSpinner$DateEditor this]
    (-> this (.getModel))))
