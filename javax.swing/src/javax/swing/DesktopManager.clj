...
(defn drag-frame
  ...
  new-x - `int`
  new-y - `int`"
  ([^DesktopManager this ^javax.swing.JComponent f ^Integer new-x ^Integer new-y]
...
(defn begin-dragging-frame
  ...
  f - `javax.swing.JComponent`"
  ([^DesktopManager this ^javax.swing.JComponent f]
...
(defn resize-frame
  ...
  new-width - `int`
  new-height - `int`"
  ([^DesktopManager this ^javax.swing.JComponent f ^Integer new-x ^Integer new-y ^Integer new-width ^Integer new-height]
...
(defn activate-frame
  ...
  ([^DesktopManager this ^javax.swing.JInternalFrame f]
...
(defn begin-resizing-frame
  ...
  f - `javax.swing.JComponent`
  direction - `int`"
  ([^DesktopManager this ^javax.swing.JComponent f ^Integer direction]
