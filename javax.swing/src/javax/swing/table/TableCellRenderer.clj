...
(defn get-table-cell-renderer-component
  ...
  ([^javax.swing.table.TableCellRenderer this ^javax.swing.JTable table ^java.lang.Object value ^Boolean is-selected ^Boolean has-focus ^Integer row ^Integer column]
