...
(defn ->transfer-handler
  ...
  (^TransferHandler [^java.lang.String property]
...
(defn can-import?
  ...
  (^Boolean [^TransferHandler this ^javax.swing.JComponent comp transfer-flavors]
    (-> this (.canImport comp transfer-flavors)))
  (^Boolean [^TransferHandler this ^javax.swing.TransferHandler$TransferSupport support]
...
(defn set-drag-image-offset
  ...
  ([^TransferHandler this ^java.awt.Point p]
...
(defn export-as-drag
  ...
  ([^TransferHandler this ^javax.swing.JComponent comp ^java.awt.event.InputEvent e ^Integer action]
...
(defn import-data
  ...
  (^Boolean [^TransferHandler this ^javax.swing.JComponent comp ^java.awt.datatransfer.Transferable t]
...
(defn get-source-actions
  ...
  (^Integer [^TransferHandler this ^javax.swing.JComponent c]
...
(defn get-visual-representation
  ...
  (^javax.swing.Icon [^TransferHandler this ^java.awt.datatransfer.Transferable t]
...
(defn get-drag-image
  ...
  (^java.awt.Image [^TransferHandler this]
    (-> this (.getDragImage))))
...
(defn export-to-clipboard
  ...
  ([^TransferHandler this ^javax.swing.JComponent comp ^java.awt.datatransfer.Clipboard clip ^Integer action]
...
(defn set-drag-image
  ...
  ([^TransferHandler this ^java.awt.Image img]
...
(defn get-drag-image-offset
  ...
  (^java.awt.Point [^TransferHandler this]
