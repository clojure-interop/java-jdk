...
(defn ->segment
  ...
  (^Segment [array ^Integer offset ^Integer count]
...
(defn sub-sequence
  ...
  (^java.lang.CharSequence [^Segment this ^Integer start ^Integer end]
...
(defn char-at
  ...
  (^Character [^Segment this ^Integer index]
    (-> this (.charAt index))))
...
(defn set-index
  ...
  (^Character [^Segment this ^Integer position]
