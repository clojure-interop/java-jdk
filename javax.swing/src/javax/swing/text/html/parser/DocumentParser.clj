...
(defn ->document-parser
  ...
  (^DocumentParser [^javax.swing.text.html.parser.DTD dtd]
...
(defn parse
  ...
  ([^DocumentParser this ^java.io.Reader in ^javax.swing.text.html.HTMLEditorKit$ParserCallback callback ^Boolean ignore-char-set]
