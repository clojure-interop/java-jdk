...
(defn ->default-styled-document
  ...
  (^DefaultStyledDocument [^javax.swing.text.AbstractDocument$Content c ^javax.swing.text.StyleContext styles]
    (new DefaultStyledDocument c styles))
  (^DefaultStyledDocument [^javax.swing.text.StyleContext styles]
...
(defn get-foreground
  ...
  (^java.awt.Color [^DefaultStyledDocument this ^javax.swing.text.AttributeSet attr]
...
(defn set-paragraph-attributes
  ...
  ([^DefaultStyledDocument this ^Integer offset ^Integer length ^javax.swing.text.AttributeSet s ^Boolean replace]
...
(defn remove-document-listener
  ...
  ([^DefaultStyledDocument this ^javax.swing.event.DocumentListener listener]
...
(defn get-logical-style
  ...
  (^javax.swing.text.Style [^DefaultStyledDocument this ^Integer p]
...
(defn set-logical-style
  ...
  ([^DefaultStyledDocument this ^Integer pos ^javax.swing.text.Style s]
...
(defn add-style
  ...
  (^javax.swing.text.Style [^DefaultStyledDocument this ^java.lang.String nm ^javax.swing.text.Style parent]
...
(defn remove-element
  ...
  ([^DefaultStyledDocument this ^javax.swing.text.Element elem]
...
(defn get-style-names
  ...
  (^java.util.Enumeration [^DefaultStyledDocument this]
    (-> this (.getStyleNames))))
...
(defn get-character-element
  ...
  (^javax.swing.text.Element [^DefaultStyledDocument this ^Integer pos]
...
(defn get-font
  ...
  (^java.awt.Font [^DefaultStyledDocument this ^javax.swing.text.AttributeSet attr]
    (-> this (.getFont attr))))
...
(defn get-default-root-element
  ...
  (^javax.swing.text.Element [^DefaultStyledDocument this]
...
(defn remove-style
  ...
  ([^DefaultStyledDocument this ^java.lang.String nm]
    (-> this (.removeStyle nm))))
...
(defn get-style
  ...
  returns: the style - `javax.swing.text.Style`"
  (^javax.swing.text.Style [^DefaultStyledDocument this ^java.lang.String nm]
    (-> this (.getStyle nm))))
