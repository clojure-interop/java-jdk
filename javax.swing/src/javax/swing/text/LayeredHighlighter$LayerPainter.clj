...
(defn paint-layer
  ...
  ([^javax.swing.text.LayeredHighlighter$LayerPainter this ^java.awt.Graphics g ^Integer p-0 ^Integer p-1 ^java.awt.Shape view-bounds ^javax.swing.text.JTextComponent editor ^javax.swing.text.View view]
