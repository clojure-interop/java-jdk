...
(defn ->wrapped-plain-view
  ...
  (^WrappedPlainView [^javax.swing.text.Element elem ^Boolean word-wrap]
    (new WrappedPlainView elem word-wrap))
  (^WrappedPlainView [^javax.swing.text.Element elem]
...
(defn changed-update
  ...
  ([^WrappedPlainView this ^javax.swing.event.DocumentEvent e ^java.awt.Shape a ^javax.swing.text.ViewFactory f]
...
(defn get-preferred-span
  ...
  (^Float [^WrappedPlainView this ^Integer axis]
...
(defn paint
  ...
  ([^WrappedPlainView this ^java.awt.Graphics g ^java.awt.Shape a]
    (-> this (.paint g a))))
...
(defn next-tab-stop
  ...
  (^Float [^WrappedPlainView this ^Float x ^Integer tab-offset]
...
(defn set-size
  ...
  ([^WrappedPlainView this ^Float width ^Float height]
