...
(defn ->glyph-view
  ...
  (^GlyphView [^javax.swing.text.Element elem]
    (new GlyphView elem)))
...
(defn get-break-weight
  ...
  (^Integer [^GlyphView this ^Integer axis ^Float pos ^Float len]
...
(defn changed-update
  ...
  ([^GlyphView this ^javax.swing.event.DocumentEvent e ^java.awt.Shape a ^javax.swing.text.ViewFactory f]
...
(defn get-preferred-span
  ...
  (^Float [^GlyphView this ^Integer axis]
...
(defn create-fragment
  ...
  (^javax.swing.text.View [^GlyphView this ^Integer p-0 ^Integer p-1]
...
(defn get-text
  ...
  (^javax.swing.text.Segment [^GlyphView this ^Integer p-0 ^Integer p-1]
...
(defn get-tabbed-span
  ...
  (^Float [^GlyphView this ^Float x ^javax.swing.text.TabExpander e]
...
(defn get-tab-expander
  ...
  (^javax.swing.text.TabExpander [^GlyphView this]
    (-> this (.getTabExpander))))
...
(defn paint
  ...
  ([^GlyphView this ^java.awt.Graphics g ^java.awt.Shape a]
    (-> this (.paint g a))))
...
(defn get-partial-span
  ...
  (^Float [^GlyphView this ^Integer p-0 ^Integer p-1]
...
(defn set-glyph-painter
  ...
  ([^GlyphView this ^javax.swing.text.GlyphView$GlyphPainter p]
...
(defn view-to-model
  ...
  (^Integer [^GlyphView this ^Float x ^Float y ^java.awt.Shape a bias-return]
...
(defn break-view
  ...
  (^javax.swing.text.View [^GlyphView this ^Integer axis ^Integer p-0 ^Float pos ^Float len]
...
(defn get-glyph-painter
  ...
  (^javax.swing.text.GlyphView$GlyphPainter [^GlyphView this]
...
(defn model-to-view
  ...
  (^java.awt.Shape [^GlyphView this ^Integer pos ^java.awt.Shape a ^javax.swing.text.Position$Bias b]
...
(defn get-next-visual-position-from
  ...
  (^Integer [^GlyphView this ^Integer pos ^javax.swing.text.Position$Bias b ^java.awt.Shape a ^Integer direction bias-ret]
