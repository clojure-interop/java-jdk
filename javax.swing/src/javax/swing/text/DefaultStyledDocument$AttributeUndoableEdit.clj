...
(defn ->attribute-undoable-edit
  ...
  (^DefaultStyledDocument$AttributeUndoableEdit [^javax.swing.text.Element element ^javax.swing.text.AttributeSet new-attributes ^Boolean is-replacing]
...
(defn redo
  ...
  ([^DefaultStyledDocument$AttributeUndoableEdit this]
    (-> this (.redo))))
