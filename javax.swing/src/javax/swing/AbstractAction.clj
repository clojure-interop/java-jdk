...
(defn get-value
  ...
  (^java.lang.Object [^AbstractAction this ^java.lang.String key]
    (-> this (.getValue key))))
...
(defn put-value
  ...
  ([^AbstractAction this ^java.lang.String key ^java.lang.Object new-value]
...
(defn set-enabled
  ...
  ([^AbstractAction this ^Boolean new-value]
...
(defn add-property-change-listener
  ...
  ([^AbstractAction this ^java.beans.PropertyChangeListener listener]
