...
(defn set-window-decoration-style
  ...
  ([^JRootPane this ^Integer window-decoration-style]
...
(defn set-layered-pane
  ...
  ([^JRootPane this ^javax.swing.JLayeredPane layered]
...
(defn get-content-pane
  ...
  (^java.awt.Container [^JRootPane this]
    (-> this (.getContentPane))))
...
(defn get-j-menu-bar
  ...
  (^javax.swing.JMenuBar [^JRootPane this]
    (-> this (.getJMenuBar))))
...
(defn set-menu-bar
  ...
  ([^JRootPane this ^javax.swing.JMenuBar menu]
...
(defn set-ui
  ...
  ([^JRootPane this ^javax.swing.plaf.RootPaneUI ui]
    (-> this (.setUI ui))))
...
(defn get-ui
  ...
  (^javax.swing.plaf.RootPaneUI [^JRootPane this]
    (-> this (.getUI))))
...
(defn get-glass-pane
  ...
  (^java.awt.Component [^JRootPane this]
    (-> this (.getGlassPane))))
...
(defn get-accessible-context
  ...
  (^javax.accessibility.AccessibleContext [^JRootPane this]
...
(defn set-glass-pane
  ...
  ([^JRootPane this ^java.awt.Component glass]
...
(defn get-default-button
  ...
  (^javax.swing.JButton [^JRootPane this]
...
(defn set-content-pane
  ...
  ([^JRootPane this ^java.awt.Container content]
...
(defn get-layered-pane
  ...
  (^javax.swing.JLayeredPane [^JRootPane this]
    (-> this (.getLayeredPane))))
...
(defn set-default-button
  ...
  ([^JRootPane this ^javax.swing.JButton default-button]
