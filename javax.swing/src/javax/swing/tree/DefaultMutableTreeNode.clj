...
(defn ->default-mutable-tree-node
  ...
  (^DefaultMutableTreeNode [^java.lang.Object user-object ^Boolean allows-children]
    (new DefaultMutableTreeNode user-object allows-children))
  (^DefaultMutableTreeNode [^java.lang.Object user-object]
...
(defn get-allows-children?
  ...
  (^Boolean [^DefaultMutableTreeNode this]
...
(defn set-user-object
  ...
  ([^DefaultMutableTreeNode this ^java.lang.Object user-object]
...
(defn depth-first-enumeration
  ...
  (^java.util.Enumeration [^DefaultMutableTreeNode this]
...
(defn set-parent
  ...
  ([^DefaultMutableTreeNode this ^javax.swing.tree.MutableTreeNode new-parent]
...
(defn get-child-count
  ...
  (^Integer [^DefaultMutableTreeNode this]
    (-> this (.getChildCount))))
...
(defn node-ancestor?
  ...
  (^Boolean [^DefaultMutableTreeNode this ^javax.swing.tree.TreeNode another-node]
...
(defn get-previous-node
  ...
  (^javax.swing.tree.DefaultMutableTreeNode [^DefaultMutableTreeNode this]
...
(defn get-index
  ...
  (^Integer [^DefaultMutableTreeNode this ^javax.swing.tree.TreeNode a-child]
...
(defn to-string
  ...
  (^java.lang.String [^DefaultMutableTreeNode this]
    (-> this (.toString))))
...
(defn node-descendant?
  ...
  (^Boolean [^DefaultMutableTreeNode this ^javax.swing.tree.DefaultMutableTreeNode another-node]
...
(defn get-child-after
  ...
  (^javax.swing.tree.TreeNode [^DefaultMutableTreeNode this ^javax.swing.tree.TreeNode a-child]
...
(defn get-last-child
  ...
  (^javax.swing.tree.TreeNode [^DefaultMutableTreeNode this]
    (-> this (.getLastChild))))
...
(defn node-child?
  ...
  (^Boolean [^DefaultMutableTreeNode this ^javax.swing.tree.TreeNode a-node]
...
(defn set-allows-children
  ...
  ([^DefaultMutableTreeNode this ^Boolean allows]
...
(defn remove
  ...
  ([^DefaultMutableTreeNode this ^Integer child-index]
...
(defn get-child-at
  ...
  (^javax.swing.tree.TreeNode [^DefaultMutableTreeNode this ^Integer index]
...
(defn insert
  ...
  throws: java.lang.ArrayIndexOutOfBoundsException - if childIndex is out of bounds"
  ([^DefaultMutableTreeNode this ^javax.swing.tree.MutableTreeNode new-child ^Integer child-index]
...
(defn clone
  ...
  (^java.lang.Object [^DefaultMutableTreeNode this]
    (-> this (.clone))))
...
(defn add
  ...
  ([^DefaultMutableTreeNode this ^javax.swing.tree.MutableTreeNode new-child]
    (-> this (.add new-child))))
...
(defn path-from-ancestor-enumeration
  ...
  (^java.util.Enumeration [^DefaultMutableTreeNode this ^javax.swing.tree.TreeNode ancestor]
...
(defn get-shared-ancestor
  ...
  (^javax.swing.tree.TreeNode [^DefaultMutableTreeNode this ^javax.swing.tree.DefaultMutableTreeNode a-node]
...
(defn node-related?
  ...
  (^Boolean [^DefaultMutableTreeNode this ^javax.swing.tree.DefaultMutableTreeNode a-node]
