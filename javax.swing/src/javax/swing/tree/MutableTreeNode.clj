...
(defn insert
  ...
  index - `int`"
  ([^MutableTreeNode this ^javax.swing.tree.MutableTreeNode child ^Integer index]
...
(defn remove
  ...
  index - `int`"
  ([^MutableTreeNode this ^Integer index]
    (-> this (.remove index))))
...
(defn set-user-object
  ...
  ([^MutableTreeNode this ^java.lang.Object object]
    (-> this (.setUserObject object))))

(defn remove-from-parent
  "Removes the receiver from its parent."
  ([^MutableTreeNode this]
...
(defn set-parent
  ...
  ([^MutableTreeNode this ^javax.swing.tree.MutableTreeNode new-parent]
