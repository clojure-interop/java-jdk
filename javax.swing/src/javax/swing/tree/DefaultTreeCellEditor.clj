...
(defn ->default-tree-cell-editor
  ...
  (^DefaultTreeCellEditor [^javax.swing.JTree tree ^javax.swing.tree.DefaultTreeCellRenderer renderer ^javax.swing.tree.TreeCellEditor editor]
    (new DefaultTreeCellEditor tree renderer editor))
  (^DefaultTreeCellEditor [^javax.swing.JTree tree ^javax.swing.tree.DefaultTreeCellRenderer renderer]
...
(defn stop-cell-editing
  ...
  (^Boolean [^DefaultTreeCellEditor this]
...
(defn get-cell-editor-value
  ...
  (^java.lang.Object [^DefaultTreeCellEditor this]
...
(defn get-tree-cell-editor-component
  ...
  (^java.awt.Component [^DefaultTreeCellEditor this ^javax.swing.JTree tree ^java.lang.Object value ^Boolean is-selected ^Boolean expanded ^Boolean leaf ^Integer row]
...
(defn cell-editable?
  ...
  (^Boolean [^DefaultTreeCellEditor this ^java.util.EventObject event]
...
(defn set-border-selection-color
  ...
  ([^DefaultTreeCellEditor this ^java.awt.Color new-color]
...
(defn value-changed
  ...
  ([^DefaultTreeCellEditor this ^javax.swing.event.TreeSelectionEvent e]
    (-> this (.valueChanged e))))
...
(defn set-font
  ...
  ([^DefaultTreeCellEditor this ^java.awt.Font font]
    (-> this (.setFont font))))
...
(defn action-performed
  ...
  ([^DefaultTreeCellEditor this ^java.awt.event.ActionEvent e]
...
(defn add-cell-editor-listener
  ...
  ([^DefaultTreeCellEditor this ^javax.swing.event.CellEditorListener l]
...
(defn get-font
  ...
  (^java.awt.Font [^DefaultTreeCellEditor this]
    (-> this (.getFont))))
...
(defn get-border-selection-color
  ...
  (^java.awt.Color [^DefaultTreeCellEditor this]
