...
(defn fire-property-change
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.lang.String property-name ^Byte old-value ^Byte new-value]
...
(defn set-text-selection-color
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.awt.Color new-color]
...
(defn set-leaf-icon
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^javax.swing.Icon new-icon]
...
(defn set-background
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.awt.Color color]
...
(defn repaint
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^Long tm ^Integer x ^Integer y ^Integer width ^Integer height]
    (-> this (.repaint tm x y width height)))
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.awt.Rectangle r]
    (-> this (.repaint r)))
  ([^javax.swing.tree.DefaultTreeCellRenderer this]
    (-> this (.repaint))))
...
(defn set-font
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.awt.Font font]
    (-> this (.setFont font))))
...
(defn paint
  ...
  ([^javax.swing.tree.DefaultTreeCellRenderer this ^java.awt.Graphics g]
    (-> this (.paint g))))
