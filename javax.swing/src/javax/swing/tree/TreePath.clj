...
(defn get-parent-path
  ...
  (^javax.swing.tree.TreePath [^TreePath this]
    (-> this (.getParentPath))))
...
(defn path-by-adding-child
  ...
  (^javax.swing.tree.TreePath [^TreePath this ^java.lang.Object child]
...
(defn to-string
  ...
  (^java.lang.String [^TreePath this]
    (-> this (.toString))))
...
(defn get-path-component
  ...
  (^java.lang.Object [^TreePath this ^Integer index]
...
(defn descendant?
  ...
  (^Boolean [^TreePath this ^javax.swing.tree.TreePath a-tree-path]
...
(defn get-last-path-component
  ...
  (^java.lang.Object [^TreePath this]
...
(defn equals
  ...
  (^Boolean [^TreePath this ^java.lang.Object o]
    (-> this (.equals o))))
