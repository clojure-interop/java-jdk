...
(defn get-editor-component
  ...
  (^java.awt.Component [^ComboBoxEditor this]
...
(defn set-item
  ...
  ([^ComboBoxEditor this ^java.lang.Object an-object]
...
(defn get-item
  ...
  (^java.lang.Object [^ComboBoxEditor this]
    (-> this (.getItem))))
...
(defn add-action-listener
  ...
  ([^ComboBoxEditor this ^java.awt.event.ActionListener l]
