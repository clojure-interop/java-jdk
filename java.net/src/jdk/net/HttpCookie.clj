...
(defn set-http-only
  ...
  ([^HttpCookie this ^Boolean http-only]
...
(defn set-comment
  ...
  ([^HttpCookie this ^java.lang.String purpose]
...
(defn set-portlist
  ...
  ([^HttpCookie this ^java.lang.String ports]
...
(defn set-path
  ...
  ([^HttpCookie this ^java.lang.String uri]
    (-> this (.setPath uri))))
...
(defn set-value
  ...
  ([^HttpCookie this ^java.lang.String new-value]
...
(defn clone
  ...
  (^java.lang.Object [^HttpCookie this]
    (-> this (.clone))))
...
(defn set-discard
  ...
  ([^HttpCookie this ^Boolean discard]
...
(defn set-domain
  ...
  ([^HttpCookie this ^java.lang.String pattern]
...
(defn equals
  ...
  returns: true if two HTTP cookies equal to each other;
            otherwise, false - `boolean`"
  (^Boolean [^HttpCookie this ^java.lang.Object obj]
    (-> this (.equals obj))))
