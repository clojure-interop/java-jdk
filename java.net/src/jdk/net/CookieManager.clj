...
(defn ->cookie-manager
  ...
  (^CookieManager [^java.net.CookieStore store ^java.net.CookiePolicy cookie-policy]
...
(defn set-cookie-policy
  ...
  ([^CookieManager this ^java.net.CookiePolicy cookie-policy]
...
(defn get-cookie-store
  ...
  (^java.net.CookieStore [^CookieManager this]
    (-> this (.getCookieStore))))
...
(defn get
  ...
  (^java.util.Map [^CookieManager this ^java.net.URI uri ^java.util.Map request-headers]
...
(defn put
  ...
  throws: java.io.IOException - if an I/O error occurs"
  ([^CookieManager this ^java.net.URI uri ^java.util.Map response-headers]
