...
(defn ->uri
  ...
  (^URI [^java.lang.String scheme ^java.lang.String user-info ^java.lang.String host ^Integer port ^java.lang.String path ^java.lang.String query ^java.lang.String fragment]
...
(defn resolve
  ...
  (^java.net.URI [^URI this ^java.net.URI uri]
    (-> this (.resolve uri))))
...
(defn compare-to
  ...
  (^Integer [^URI this ^java.net.URI that]
    (-> this (.compareTo that))))
...
(defn equals
  ...
  (^Boolean [^URI this ^java.lang.Object ob]
    (-> this (.equals ob))))
