...
(defn ->http-retry-exception
  ...
  (^HttpRetryException [^java.lang.String detail ^Integer code ^java.lang.String location]
    (new HttpRetryException detail code location))
  (^HttpRetryException [^java.lang.String detail ^Integer code]
...
(defn response-code
  ...
  (^Integer [^HttpRetryException this]
    (-> this (.responseCode))))
...
(defn get-reason
  ...
  (^java.lang.String [^HttpRetryException this]
    (-> this (.getReason))))
