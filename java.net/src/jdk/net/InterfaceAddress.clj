...
(defn get-address
  ...
  (^java.net.InetAddress [^java.net.InterfaceAddress this]
    (-> this (.getAddress))))
...
(defn get-network-prefix-length
  ...
  (^Short [^java.net.InterfaceAddress this]
...
(defn equals
  ...
  (^Boolean [^java.net.InterfaceAddress this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn hash-code
  ...
  (^Integer [^java.net.InterfaceAddress this]
    (-> this (.hashCode))))
...
(defn to-string
  ...
  (^java.lang.String [^java.net.InterfaceAddress this]
    (-> this (.toString))))
