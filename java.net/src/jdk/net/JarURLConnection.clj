...
(defn get-jar-file-url
  ...
  (^java.net.URL [^JarURLConnection this]
    (-> this (.getJarFileURL))))
...
(defn get-entry-name
  ...
  (^java.lang.String [^JarURLConnection this]
    (-> this (.getEntryName))))
...
(defn get-jar-file
  ...
  (^java.util.jar.JarFile [^JarURLConnection this]
    (-> this (.getJarFile))))
...
(defn get-manifest
  ...
  (^java.util.jar.Manifest [^JarURLConnection this]
    (-> this (.getManifest))))
...
(defn get-jar-entry
  ...
  throws: java.io.IOException - if getting the JAR file for this connection causes an IOException to be thrown."
  (^java.util.jar.JarEntry [^JarURLConnection this]
    (-> this (.getJarEntry))))
...
(defn get-attributes
  ...
  (^java.util.jar.Attributes [^JarURLConnection this]
    (-> this (.getAttributes))))
