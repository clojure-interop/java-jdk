...
(defn get-command-path
  ...
  (^java.lang.String [^ActivationGroupDesc$CommandEnvironment this]
    (-> this (.getCommandPath))))
...
(defn get-command-options
  ...
  ([^ActivationGroupDesc$CommandEnvironment this]
...
(defn equals
  ...
  (^Boolean [^ActivationGroupDesc$CommandEnvironment this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn hash-code
  ...
  (^Integer [^ActivationGroupDesc$CommandEnvironment this]
    (-> this (.hashCode))))
