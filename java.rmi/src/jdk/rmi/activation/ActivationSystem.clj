...
(defn register-object
  ...
  (^java.rmi.activation.ActivationID [^ActivationSystem this ^java.rmi.activation.ActivationDesc desc]
...
(defn unregister-object
  ...
  ([^ActivationSystem this ^java.rmi.activation.ActivationID id]
...
(defn unregister-group
  ...
  throws: java.rmi.activation.ActivationException - if unregister fails (e.g., database update failure, etc)."
  ([^ActivationSystem this ^java.rmi.activation.ActivationGroupID id]
...
(defn get-activation-desc
  ...
  (^java.rmi.activation.ActivationDesc [^ActivationSystem this ^java.rmi.activation.ActivationID id]
...
(defn set-activation-group-desc
  ...
  (^java.rmi.activation.ActivationGroupDesc [^ActivationSystem this ^java.rmi.activation.ActivationGroupID id ^java.rmi.activation.ActivationGroupDesc desc]
...
(defn set-activation-desc
  ...
  (^java.rmi.activation.ActivationDesc [^ActivationSystem this ^java.rmi.activation.ActivationID id ^java.rmi.activation.ActivationDesc desc]
...
(defn register-group
  ...
  (^java.rmi.activation.ActivationGroupID [^ActivationSystem this ^java.rmi.activation.ActivationGroupDesc desc]
...
(defn get-activation-group-desc
  ...
  (^java.rmi.activation.ActivationGroupDesc [^ActivationSystem this ^java.rmi.activation.ActivationGroupID id]
...
(defn active-group
  ...
  (^java.rmi.activation.ActivationMonitor [^ActivationSystem this ^java.rmi.activation.ActivationGroupID id ^java.rmi.activation.ActivationInstantiator group ^Long incarnation]
