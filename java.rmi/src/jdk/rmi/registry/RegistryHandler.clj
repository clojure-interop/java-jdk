...
(defn registry-stub
  ...
  (^java.lang..rmi.registry.Registry [^java.rmi.registry.RegistryHandler this ^java.lang.String host ^Integer port]
...
(defn registry-impl
  ...
  throws: java.rmi.RemoteException - if a remote error occurs"
  (^java.lang..rmi.registry.Registry [^java.rmi.registry.RegistryHandler this ^Integer port]
