...
(defn create-socket
  ...
  (^java.net.Socket [^SSLSocketFactory this ^java.net.Socket s ^java.lang.String host ^Integer port ^Boolean auto-close]
    (-> this (.createSocket s host port auto-close)))
  (^java.net.Socket [^SSLSocketFactory this ^java.net.Socket s ^java.io.InputStream consumed ^Boolean auto-close]
