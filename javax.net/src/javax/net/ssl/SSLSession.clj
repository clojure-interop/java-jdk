...
(defn get-cipher-suite
  ...
  (^java.lang.String [^SSLSession this]
    (-> this (.getCipherSuite))))
...
(defn get-local-principal
  ...
  (^java.security.Principal [^SSLSession this]
...
(defn put-value
  ...
  ([^SSLSession this ^java.lang.String name ^java.lang.Object value]
...
(defn remove-value
  ...
  ([^SSLSession this ^java.lang.String name]
...
(defn get-value
  ...
  throws: java.lang.IllegalArgumentException - if the argument is null."
  (^java.lang.Object [^SSLSession this ^java.lang.String name]
    (-> this (.getValue name))))
...
(defn get-session-context
  ...
  (^javax.net.ssl.SSLSessionContext [^SSLSession this]
