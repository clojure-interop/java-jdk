...
(defn get-client-aliases
  ...
  ([^. this ^java.lang.String key-type ^java.security.Principal[] issuers]
...
(defn choose-client-alias
  ...
  ([^. this ^java.lang.String[] key-type ^java.security.Principal[] issuers ^java.net.Socket socket]
