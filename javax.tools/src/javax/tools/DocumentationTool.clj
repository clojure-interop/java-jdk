...
(defn get-task
  ...
  ([^javax.tools.DocumentationTool this ^java.io.Writer out ^javax.tools.JavaFileManager file-manager ^javax.tools.JavaFileObject> diagnostic-listener ^java.lang.Class doclet-class ^java.lang.Iterable options ^javax.tools.JavaFileObject> compilation-units]
...
(defn get-standard-file-manager
  ...
  ([^javax.tools.DocumentationTool this ^javax.tools.JavaFileObject> diagnostic-listener ^java.util.Locale locale ^java.nio.charset.Charset charset]
