...
(defn run
  ...
  (^Integer [^javax.tools.Tool this ^java.io.InputStream in ^java.io.OutputStream out ^java.io.OutputStream err ^java.lang.String arguments]
...
(defn get-source-versions
  ...
  (^java.util.Set [^javax.tools.Tool this]
