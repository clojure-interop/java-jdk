...
(defn get-java-file-for-input
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^java.lang.String class-name ^javax.tools.JavaFileObject.Kind kind]
...
(defn list
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^java.lang.String package-name ^java.util.Set kinds ^Boolean recurse]
...
(defn handle-option
  ...
  ([^. this ^java.lang.String current ^java.util.Iterator remaining]
...
(defn infer-binary-name
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^javax.tools.JavaFileObject file]
...
(defn get-file-for-input
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^java.lang.String package-name ^java.lang.String relative-name]
...
(defn get-java-file-for-output
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^java.lang.String class-name ^javax.tools.JavaFileObject.Kind kind ^javax.tools.FileObject sibling]
...
(defn get-file-for-output
  ...
  ([^. this ^javax.tools.JavaFileManager.Location location ^java.lang.String package-name ^java.lang.String relative-name ^javax.tools.FileObject sibling]
