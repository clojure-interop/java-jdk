...
(defn try-split
  ...
  (^java.util.Spliterator$OfInt [^Spliterator$OfInt this]
    (-> this (.trySplit))))
...
(defn try-advance
  ...
  (^Boolean [^Spliterator$OfInt this ^java.util.function.IntConsumer action]
...
(defn for-each-remaining
  ...
  ([^Spliterator$OfInt this ^java.util.function.IntConsumer action]
