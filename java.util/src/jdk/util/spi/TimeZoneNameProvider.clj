...
(defn get-display-name
  ...
  (^java.lang.String [^TimeZoneNameProvider this ^java.lang.String id ^Boolean daylight ^Integer style ^java.util.Locale locale]
...
(defn get-generic-display-name
  ...
  throws: java.lang.IllegalArgumentException - if style is invalid, or locale isn't one of the locales returned from getAvailableLocales()."
  (^java.lang.String [^TimeZoneNameProvider this ^java.lang.String id ^Integer style ^java.util.Locale locale]
