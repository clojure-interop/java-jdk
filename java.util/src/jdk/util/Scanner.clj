...
(defn ->scanner
  ...
  (^Scanner [^java.io.InputStream source ^java.lang.String charset-name]
...
(defn skip
  ...
  (^java.util.Scanner [^Scanner this ^java.util.regex.Pattern pattern]
    (-> this (.skip pattern))))
...
(defn next-big-integer
  ...
  (^java.math.BigInteger [^Scanner this ^Integer radix]
    (-> this (.nextBigInteger radix)))
  (^java.math.BigInteger [^Scanner this]
    (-> this (.nextBigInteger))))
...
(defn next
  ...
  (^java.lang.String [^Scanner this ^java.lang.String pattern]
    (-> this (.next pattern)))
  (^java.lang.String [^Scanner this]
    (-> this (.next))))
...
(defn find-within-horizon
  ...
  throws: java.lang.IllegalStateException - if this scanner is closed"
  (^java.lang.String [^Scanner this ^java.lang.String pattern ^Integer horizon]
...
(defn next-int
  ...
  throws: java.util.InputMismatchException - if the next token does not match the Integer regular expression, or is out of range"
  (^Integer [^Scanner this ^Integer radix]
    (-> this (.nextInt radix)))
  (^Integer [^Scanner this]
    (-> this (.nextInt))))
...
(defn has-next-short?
  ...
  throws: java.lang.IllegalStateException - if this scanner is closed"
  (^Boolean [^Scanner this ^Integer radix]
...
(defn reset
  ...
  returns: this scanner - `java.util.Scanner`"
  (^java.util.Scanner [^Scanner this]
    (-> this (.reset))))
...
(defn next-short
  ...
  throws: java.util.InputMismatchException - if the next token does not match the Integer regular expression, or is out of range"
  (^Short [^Scanner this ^Integer radix]
...
(defn next-long
  ...
  throws: java.util.InputMismatchException - if the next token does not match the Integer regular expression, or is out of range"
  (^Long [^Scanner this ^Integer radix]
    (-> this (.nextLong radix)))
  (^Long [^Scanner this]
    (-> this (.nextLong))))
...
(defn io-exception
  ...
  (^java.io.IOException [^Scanner this]
    (-> this (.ioException))))
...
(defn delimiter
  ...
  (^java.util.regex.Pattern [^Scanner this]
    (-> this (.delimiter))))
...
(defn has-next?
  ...
  throws: java.lang.IllegalStateException - if this scanner is closed"
  (^Boolean [^Scanner this ^java.lang.String pattern]
...
(defn next-byte
  ...
  throws: java.util.InputMismatchException - if the next token does not match the Integer regular expression, or is out of range"
  (^Byte [^Scanner this ^Integer radix]
    (-> this (.nextByte radix)))
  (^Byte [^Scanner this]
    (-> this (.nextByte))))
...
(defn next-big-decimal
  ...
  (^java.math.BigDecimal [^Scanner this]
    (-> this (.nextBigDecimal))))
...
(defn use-locale
  ...
  returns: this scanner - `java.util.Scanner`"
  (^java.util.Scanner [^Scanner this ^java.util.Locale locale]
...
(defn match
  ...
  (^java.util.regex.MatchResult [^Scanner this]
    (-> this (.match))))
...
(defn use-radix
  ...
  (^java.util.Scanner [^Scanner this ^Integer radix]
    (-> this (.useRadix radix))))
