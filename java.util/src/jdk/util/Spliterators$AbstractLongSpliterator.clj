...
(defn try-split
  ...
  (^java.util.Spliterator$OfLong [^Spliterators$AbstractLongSpliterator this]
    (-> this (.trySplit))))
...
(defn estimate-size
  ...
  (^Long [^Spliterators$AbstractLongSpliterator this]
    (-> this (.estimateSize))))
...
(defn characteristics
  ...
  (^Integer [^Spliterators$AbstractLongSpliterator this]
