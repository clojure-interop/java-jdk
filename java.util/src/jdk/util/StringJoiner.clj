...
(defn ->string-joiner
  ...
  (^StringJoiner [^java.lang.CharSequence delimiter ^java.lang.CharSequence prefix ^java.lang.CharSequence suffix]
    (new StringJoiner delimiter prefix suffix))
  (^StringJoiner [^java.lang.CharSequence delimiter]
...
(defn set-empty-value
  ...
  (^java.util.StringJoiner [^StringJoiner this ^java.lang.CharSequence empty-value]
...
(defn to-string
  ...
  (^java.lang.String [^StringJoiner this]
    (-> this (.toString))))
...
(defn add
  ...
  (^java.util.StringJoiner [^StringJoiner this ^java.lang.CharSequence new-element]
...
(defn merge
  ...
  (^java.util.StringJoiner [^StringJoiner this ^java.util.StringJoiner other]
    (-> this (.merge other))))
