...
(defn apply-as-int
  ...
  (^Integer [^IntUnaryOperator this ^Integer operand]
...
(defn compose
  ...
  ([^IntUnaryOperator this ^java.util.function.IntUnaryOperator before]
    (-> this (.compose before))))
...
(defn and-then
  ...
  ([^IntUnaryOperator this ^java.util.function.IntUnaryOperator after]
    (-> this (.andThen after))))
