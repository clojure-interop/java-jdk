...
(defn offer
  ...
  (^Boolean [^DelayQueue this e ^Long timeout ^java.util.concurrent.TimeUnit unit]
    (-> this (.offer e timeout unit)))
  (^Boolean [^DelayQueue this e]
    (-> this (.offer e))))
...
(defn iterator
  ...
  (^java.util.Iterator [^DelayQueue this]
    (-> this (.iterator))))
...
(defn remove
  ...
  (^Boolean [^DelayQueue this ^java.lang.Object o]
    (-> this (.remove o))))
...
(defn drain-to
  ...
  (^Integer [^DelayQueue this ^java.util.Collection c ^Integer max-elements]
    (-> this (.drainTo c max-elements)))
  (^Integer [^DelayQueue this ^java.util.Collection c]
    (-> this (.drainTo c))))
...
(defn poll
  ...
  throws: java.lang.InterruptedException - if interrupted while waiting"
  ([^DelayQueue this ^Long timeout ^java.util.concurrent.TimeUnit unit]
