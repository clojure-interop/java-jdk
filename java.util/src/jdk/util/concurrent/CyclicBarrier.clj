...
(defn ->cyclic-barrier
  ...
  (^CyclicBarrier [^Integer parties ^java.lang.Runnable barrier-action]
...
(defn await
  ...
  (^Integer [^CyclicBarrier this ^Long timeout ^java.util.concurrent.TimeUnit unit]
