...
(defn ->scheduled-thread-pool-executor
  ...
  (^ScheduledThreadPoolExecutor [^Integer core-pool-size ^java.util.concurrent.ThreadFactory thread-factory ^java.util.concurrent.RejectedExecutionHandler handler]
    (new ScheduledThreadPoolExecutor core-pool-size thread-factory handler))
  (^ScheduledThreadPoolExecutor [^Integer core-pool-size ^java.util.concurrent.ThreadFactory thread-factory]
    (new ScheduledThreadPoolExecutor core-pool-size thread-factory))
  (^ScheduledThreadPoolExecutor [^Integer core-pool-size]
...
(defn set-remove-on-cancel-policy
  ...
  ([^ScheduledThreadPoolExecutor this ^Boolean value]
...
(defn get-execute-existing-delayed-tasks-after-shutdown-policy?
  ...
  (^Boolean [^ScheduledThreadPoolExecutor this]
...
(defn schedule
  ...
  (^java.util.concurrent.ScheduledFuture [^ScheduledThreadPoolExecutor this ^java.lang.Runnable command ^Long delay ^java.util.concurrent.TimeUnit unit]
...
(defn submit
  ...
  throws: java.util.concurrent.RejectedExecutionException - if the task cannot be scheduled for execution"
  ([^ScheduledThreadPoolExecutor this ^java.lang.Runnable task result]
    (-> this (.submit task result)))
  (^java.util.concurrent.Future [^ScheduledThreadPoolExecutor this ^java.lang.Runnable task]
    (-> this (.submit task))))
...
(defn schedule-with-fixed-delay
  ...
  throws: java.util.concurrent.RejectedExecutionException - if the task cannot be scheduled for execution"
  (^java.util.concurrent.ScheduledFuture [^ScheduledThreadPoolExecutor this ^java.lang.Runnable command ^Long initial-delay ^Long delay ^java.util.concurrent.TimeUnit unit]
...
(defn schedule-at-fixed-rate
  ...
  throws: java.util.concurrent.RejectedExecutionException - if the task cannot be scheduled for execution"
  (^java.util.concurrent.ScheduledFuture [^ScheduledThreadPoolExecutor this ^java.lang.Runnable command ^Long initial-delay ^Long period ^java.util.concurrent.TimeUnit unit]
...
(defn execute
  ...
  ([^ScheduledThreadPoolExecutor this ^java.lang.Runnable command]
...
(defn get-queue
  ...
  (^java.util.concurrent.BlockingQueue [^ScheduledThreadPoolExecutor this]
    (-> this (.getQueue))))
