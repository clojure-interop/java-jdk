...
(defn try-split
  ...
  (^java.util.Spliterator$OfInt [^Spliterators$AbstractIntSpliterator this]
    (-> this (.trySplit))))
...
(defn estimate-size
  ...
  (^Long [^Spliterators$AbstractIntSpliterator this]
    (-> this (.estimateSize))))
...
(defn characteristics
  ...
  (^Integer [^Spliterators$AbstractIntSpliterator this]
