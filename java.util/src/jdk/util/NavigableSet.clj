...
(defn tail-set
  ...
  ([^. this ^NavigableSet.E from-element ^Boolean inclusive]
    (-> this (.tailSet from-element inclusive)))
  ([^. this ^NavigableSet.E from-element]
...
(defn sub-set
  ...
  ([^. this ^NavigableSet.E from-element ^Boolean from-inclusive ^NavigableSet.E to-element ^Boolean to-inclusive]
    (-> this (.subSet from-element from-inclusive to-element to-inclusive)))
  ([^. this ^NavigableSet.E from-element ^NavigableSet.E to-element]
...
(defn head-set
  ...
  ([^. this ^NavigableSet.E to-element ^Boolean inclusive]
    (-> this (.headSet to-element inclusive)))
  ([^. this ^NavigableSet.E to-element]
