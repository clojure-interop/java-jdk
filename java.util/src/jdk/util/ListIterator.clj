...
(defn next
  ...
  returns: the next element in the list - `E`
...
(defn previous
  ...
  returns: the previous element in the list - `E`
...
(defn set
  ...
  e - the element with which to replace the last element returned by next or previous - `E`
