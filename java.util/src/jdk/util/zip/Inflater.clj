...
(defn set-input
  ...
  ([^Inflater this b ^Integer off ^Integer len]
...
(defn inflate
  ...
  (^Integer [^Inflater this b ^Integer off ^Integer len]
    (-> this (.inflate b off len)))
  (^Integer [^Inflater this b]
    (-> this (.inflate b))))
