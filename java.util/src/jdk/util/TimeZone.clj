...
(defn in-daylight-time
  ...
  (^Boolean [^TimeZone this ^java.util.Date date]
...
(defn get-display-name
  ...
  (^java.lang.String [^TimeZone this ^Boolean daylight ^Integer style ^java.util.Locale locale]
    (-> this (.getDisplayName daylight style locale)))
  (^java.lang.String [^TimeZone this ^Boolean daylight ^Integer style]
    (-> this (.getDisplayName daylight style)))
  (^java.lang.String [^TimeZone this ^java.util.Locale locale]
    (-> this (.getDisplayName locale)))
  (^java.lang.String [^TimeZone this]
    (-> this (.getDisplayName))))
...
(defn get-offset
  ...
  (^Integer [^TimeZone this ^Integer era ^Integer year ^Integer month ^Integer day ^Integer day-of-week ^Integer milliseconds]
    (-> this (.getOffset era year month day day-of-week milliseconds)))
  (^Integer [^TimeZone this ^Long date]
    (-> this (.getOffset date))))
...
(defn set-raw-offset
  ...
  ([^TimeZone this ^Integer offset-millis]
...
(defn has-same-rules?
  ...
  (^Boolean [^TimeZone this ^java.util.TimeZone other]
...
(defn clone
  ...
  (^java.lang.Object [^TimeZone this]
    (-> this (.clone))))
...
(defn to-zone-id
  ...
  (^java.time.ZoneId [^TimeZone this]
    (-> this (.toZoneId))))
...
(defn set-id
  ...
  ([^TimeZone this ^java.lang.String id]
    (-> this (.setID id))))
