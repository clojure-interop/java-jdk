...
(defn try-split
  ...
  (^Spliterator.OfPrimitive.T_SPLITR [^java.util.Spliterator$OfPrimitive> this]
    (-> this (.trySplit))))
...
(defn try-advance
  ...
  (^Boolean [^java.util.Spliterator$OfPrimitive> this ^Spliterator.OfPrimitive.T_CONS action]
