...
(defn ->formatter
  ...
  (^Formatter [^java.lang.String file-name ^java.lang.String csn ^java.util.Locale l]
...
(defn locale
  ...
  (^java.util.Locale [^Formatter this]
    (-> this (.locale))))
...
(defn out
  ...
  throws: java.util.FormatterClosedException - If this formatter has been closed by invoking its close() method"
  (^java.lang.Appendable [^Formatter this]
    (-> this (.out))))
...
(defn to-string
  ...
  throws: java.util.FormatterClosedException - If this formatter has been closed by invoking its close() method"
  (^java.lang.String [^Formatter this]
    (-> this (.toString))))
...
(defn io-exception
  ...
  (^java.io.IOException [^Formatter this]
    (-> this (.ioException))))
...
(defn format
  ...
  (^java.util.Formatter [^Formatter this ^java.util.Locale l ^java.lang.String format ^java.lang.Object args]
    (-> this (.format l format args)))
  (^java.util.Formatter [^Formatter this ^java.lang.String format ^java.lang.Object args]
