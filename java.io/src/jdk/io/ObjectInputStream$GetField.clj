...
(defn get-object-stream-class
  ...
  (^java.io.ObjectStreamClass [^ObjectInputStream$GetField this]
...
(defn defaulted
  ...
  (^Boolean [^ObjectInputStream$GetField this ^java.lang.String name]
    (-> this (.defaulted name))))
...
(defn get
  ...
  throws: java.io.IOException - if there are I/O errors while reading from the underlying InputStream"
  (^Boolean [^ObjectInputStream$GetField this ^java.lang.String name ^Boolean val]
    (-> this (.get name val))))
