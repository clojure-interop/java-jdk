...
(defn read-object
  ...
  (^java.lang.Object [^ObjectInput this]
    (-> this (.readObject))))
...
(defn read
  ...
  (^Integer [^ObjectInput this b ^Integer off ^Integer len]
    (-> this (.read b off len)))
  (^Integer [^ObjectInput this b]
    (-> this (.read b)))
  (^Integer [^ObjectInput this]
    (-> this (.read))))
