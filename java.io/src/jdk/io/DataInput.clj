...
(defn read-fully
  ...
  throws: java.io.EOFException - if this stream reaches the end before reading all the bytes."
  ([^DataInput this b ^Integer off ^Integer len]
...
(defn skip-bytes
  ...
  (^Integer [^DataInput this ^Integer n]
    (-> this (.skipBytes n))))
...
(defn read-utf
  ...
  throws: java.io.EOFException - if this stream reaches the end before reading all the bytes."
  (^java.lang.String [^DataInput this]
    (-> this (.readUTF))))
