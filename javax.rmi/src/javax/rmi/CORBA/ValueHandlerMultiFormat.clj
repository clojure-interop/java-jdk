(ns javax.rmi.CORBA.ValueHandlerMultiFormat
  "Java to IDL ptc 02-01-12 1.5.1.5"
  (:refer-clojure :only [require comment defn ->])
  (:import [javax.rmi.CORBA ValueHandlerMultiFormat]))

(defn get-maximum-stream-format-version
...
(defn write-value
  ...
  ([^javax.rmi.CORBA.ValueHandlerMultiFormat this ^org.omg.CORBA.portable.OutputStream out ^java.io.Serializable value ^Byte stream-format-version]
