...
(defn export-object
  ...
  ([^PortableRemoteObjectDelegate this ^java.rmi.Remote obj]
...
(defn to-stub
  ...
  (^java.rmi.Remote [^PortableRemoteObjectDelegate this ^java.rmi.Remote obj]
    (-> this (.toStub obj))))
...
(defn narrow
  ...
  (^java.lang.Object [^PortableRemoteObjectDelegate this ^java.lang.Object narrow-from ^java.lang.Class narrow-to]
...
(defn connect
  ...
  throws: java.rmi.RemoteException"
  ([^PortableRemoteObjectDelegate this ^java.rmi.Remote target ^java.rmi.Remote source]
