...
(defn read-value
  ...
  (^java.io.Serializable [^javax.rmi.CORBA.ValueHandler this ^org.omg.CORBA.portable.InputStream in ^Integer offset ^java.lang.Class clz ^java.lang.String repository-id ^org.omg.SendingContext.RunTime sender]
...
(defn get-rmi-repository-id
  ...
  (^java.lang.String [^javax.rmi.CORBA.ValueHandler this ^java.lang.Class clz]
...
(defn custom-marshaled?
  ...
  (^Boolean [^javax.rmi.CORBA.ValueHandler this ^java.lang.Class clz]
...
(defn get-run-time-code-base
  ...
  (^org.omg.SendingContext.RunTime [^javax.rmi.CORBA.ValueHandler this]
...
(defn write-replace
  ...
  (^java.io.Serializable [^javax.rmi.CORBA.ValueHandler this ^java.io.Serializable value]
