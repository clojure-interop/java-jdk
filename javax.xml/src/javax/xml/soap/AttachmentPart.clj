...
(defn add-mime-header
  ...
  ([^AttachmentPart this ^java.lang.String name ^java.lang.String value]
...
(defn get-data-handler
  ...
  (^javax.activation.DataHandler [^AttachmentPart this]
    (-> this (.getDataHandler))))
...
(defn set-base-64-content
  ...
  ([^AttachmentPart this ^java.io.InputStream content ^java.lang.String content-type]
...
(defn get-raw-content
  ...
  (^java.io.InputStream [^AttachmentPart this]
    (-> this (.getRawContent))))
...
(defn get-non-matching-mime-headers
  ...
  (^java.util.Iterator [^AttachmentPart this names]
...
(defn set-raw-content-bytes
  ...
  ([^AttachmentPart this content ^Integer offset ^Integer len ^java.lang.String content-type]
...
(defn set-data-handler
  ...
  ([^AttachmentPart this ^javax.activation.DataHandler data-handler]
...
(defn remove-mime-header
  ...
  ([^AttachmentPart this ^java.lang.String header]
...
(defn get-mime-header
  ...
  ([^AttachmentPart this ^java.lang.String name]
...
(defn get-all-mime-headers
  ...
  (^java.util.Iterator [^AttachmentPart this]
...
(defn set-content
  ...
  ([^AttachmentPart this ^java.lang.Object object ^java.lang.String content-type]
...
(defn get-content
  ...
  throws: javax.xml.soap.SOAPException - if there is no content set into this AttachmentPart object or if there was a data transformation error"
  (^java.lang.Object [^AttachmentPart this]
    (-> this (.getContent))))
