...
(defn add-fault-reason-text
  ...
  ([^javax.xml.soap.SOAPFault this ^java.lang.String text ^java.util.Locale locale]
...
(defn set-fault-string
  ...
  ([^javax.xml.soap.SOAPFault this ^java.lang.String fault-string ^java.util.Locale locale]
    (-> this (.setFaultString fault-string locale)))
  ([^javax.xml.soap.SOAPFault this ^java.lang.String fault-string]
...
(defn set-fault-actor
  ...
  ([^javax.xml.soap.SOAPFault this ^java.lang.String fault-actor]
...
(defn set-fault-node
  ...
  ([^javax.xml.soap.SOAPFault this ^java.lang.String uri]
...
(defn append-fault-subcode
  ...
  ([^javax.xml.soap.SOAPFault this ^javax.xml.namespace.QName subcode]
...
(defn set-fault-code
  ...
  ([^javax.xml.soap.SOAPFault this ^javax.xml.soap.Name fault-code-q-name]
