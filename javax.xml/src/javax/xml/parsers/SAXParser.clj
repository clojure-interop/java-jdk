...
(defn get-parser
  ...
  (^org.xml.sax.Parser [^SAXParser this]
    (-> this (.getParser))))
...
(defn get-property
  ...
  (^java.lang.Object [^SAXParser this ^java.lang.String name]
...
(defn get-xml-reader
  ...
  throws: org.xml.sax.SAXException - If any SAX errors occur during processing."
  (^org.xml.sax.XMLReader [^SAXParser this]
    (-> this (.getXMLReader))))
...
(defn get-schema
  ...
  (^javax.xml.validation.Schema [^SAXParser this]
    (-> this (.getSchema))))
...
(defn parse
  ...
  ([^SAXParser this ^java.io.InputStream is ^org.xml.sax.HandlerBase hb ^java.lang.String system-id]
    (-> this (.parse is hb system-id)))
  ([^SAXParser this ^java.io.InputStream is ^org.xml.sax.HandlerBase hb]
    (-> this (.parse is hb))))
...
(defn set-property
  ...
  throws: org.xml.sax.SAXNotRecognizedException - When the underlying XMLReader does not recognize the property name."
  ([^SAXParser this ^java.lang.String name ^java.lang.Object value]
