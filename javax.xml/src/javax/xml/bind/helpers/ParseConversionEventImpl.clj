...
(defn ->parse-conversion-event-impl
  ...
  (^ParseConversionEventImpl [^Integer severity ^java.lang.String message ^javax.xml.bind.ValidationEventLocator locator ^java.lang.Throwable linked-exception]
    (new ParseConversionEventImpl severity message locator linked-exception))
  (^ParseConversionEventImpl [^Integer severity ^java.lang.String message ^javax.xml.bind.ValidationEventLocator locator]
