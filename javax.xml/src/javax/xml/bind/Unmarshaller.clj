...
(defn set-listener
  ...
  ([^. this ^javax.xml.bind.Unmarshaller.Listener listener]
...
(defn set-attachment-unmarshaller
  ...
  ([^. this ^javax.xml.bind.attachment.AttachmentUnmarshaller au]
...
(defn unmarshal
  ...
  ([^. this ^org.w3c.dom.Node node ^java.lang.Class declared-type]
