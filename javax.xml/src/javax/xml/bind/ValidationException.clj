...
(defn ->validation-exception
  ...
  (^ValidationException [^java.lang.String message ^java.lang.String error-code ^java.lang.Throwable exception]
    (new ValidationException message error-code exception))
  (^ValidationException [^java.lang.String message ^java.lang.String error-code]
