...
(defn unmarshal
  ...
  ([^javax.xml.bind.annotation.adapters.NormalizedStringAdapter this ^java.lang.String text]
    (-> this (.unmarshal text))))
...
(defn marshal
  ...
  returns: `java.lang.String`"
  ([^javax.xml.bind.annotation.adapters.NormalizedStringAdapter this ^java.lang.String s]
    (-> this (.marshal s))))
