...
(defn parse-base-64-binary
  ...
  ([^DatatypeConverterInterface this ^java.lang.String lexical-xsd-base-64-binary]
...
(defn parse-date-time
  ...
  (^java.util.Calendar [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-date-time]
...
(defn print-unsigned-int
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Long val]
...
(defn print-q-name
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^javax.xml.namespace.QName val ^javax.xml.namespace.NamespaceContext nsc]
...
(defn parse-q-name
  ...
  (^javax.xml.namespace.QName [^DatatypeConverterInterface this ^java.lang.String lexical-xsdq-name ^javax.xml.namespace.NamespaceContext nsc]
...
(defn print-time
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^java.util.Calendar val]
    (-> this (.printTime val))))
...
(defn print-short
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Short val]
    (-> this (.printShort val))))
...
(defn print-any-simple-type
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^java.lang.String val]
...
(defn parse-string
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-string]
...
(defn parse-short
  ...
  (^Short [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-short]
...
(defn parse-time
  ...
  (^java.util.Calendar [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-time]
...
(defn parse-hex-binary
  ...
  ([^DatatypeConverterInterface this ^java.lang.String lexical-xsd-hex-binary]
...
(defn print-unsigned-short
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Integer val]
...
(defn parse-float
  ...
  (^Float [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-float]
...
(defn print-base-64-binary
  ...
  throws: java.lang.IllegalArgumentException - if val is null."
  (^java.lang.String [^DatatypeConverterInterface this val]
...
(defn parse-date
  ...
  (^java.util.Calendar [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-date]
...
(defn parse-integer
  ...
  (^java.math.BigInteger [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-integer]
...
(defn parse-decimal
  ...
  (^java.math.BigDecimal [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-decimal]
...
(defn print-decimal
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^java.math.BigDecimal val]
...
(defn print-float
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Float val]
    (-> this (.printFloat val))))
...
(defn print-byte
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Byte val]
    (-> this (.printByte val))))
...
(defn parse-boolean
  ...
  (^Boolean [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-boolean]
...
(defn print-integer
  ...
  throws: java.lang.IllegalArgumentException - val is null."
  (^java.lang.String [^DatatypeConverterInterface this ^java.math.BigInteger val]
...
(defn parse-double
  ...
  (^Double [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-double]
...
(defn parse-long
  ...
  (^Long [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-long]
...
(defn parse-any-simple-type
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-any-simple-type]
...
(defn print-double
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Double val]
...
(defn parse-unsigned-short
  ...
  (^Integer [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-unsigned-short]
...
(defn parse-byte
  ...
  (^Byte [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-byte]
...
(defn print-boolean
  ...
  (^java.lang.String [^DatatypeConverterInterface this ^Boolean val]
...
(defn parse-unsigned-int
  ...
  (^Long [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-unsigned-int]
...
(defn parse-int
  ...
  (^Integer [^DatatypeConverterInterface this ^java.lang.String lexical-xsd-int]
