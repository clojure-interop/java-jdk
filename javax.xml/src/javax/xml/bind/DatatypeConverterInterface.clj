...
(defn parse-base-64-binary
  ...
  ([^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-base-64-binary]
...
(defn parse-date-time
  ...
  (^java.util.Calendar [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-date-time]
...
(defn print-unsigned-int
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Long val]
...
(defn print-q-name
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^javax.xml.namespace.QName val ^javax.xml.namespace.NamespaceContext nsc]
...
(defn parse-q-name
  ...
  (^javax.xml.namespace.QName [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsdq-name ^javax.xml.namespace.NamespaceContext nsc]
...
(defn print-time
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.util.Calendar val]
    (-> this (.printTime val))))
...
(defn print-short
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Short val]
    (-> this (.printShort val))))
...
(defn print-any-simple-type
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String val]
...
(defn parse-string
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-string]
...
(defn parse-short
  ...
  (^Short [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-short]
...
(defn parse-time
  ...
  (^java.util.Calendar [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-time]
...
(defn parse-hex-binary
  ...
  ([^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-hex-binary]
...
(defn print-unsigned-short
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Integer val]
...
(defn parse-float
  ...
  (^Float [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-float]
...
(defn print-base-64-binary
  ...
  throws: java.lang.IllegalArgumentException - if val is null."
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this val]
...
(defn parse-date
  ...
  (^java.util.Calendar [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-date]
...
(defn parse-integer
  ...
  (^java.math.BigInteger [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-integer]
...
(defn parse-decimal
  ...
  (^java.math.BigDecimal [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-decimal]
...
(defn print-decimal
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.math.BigDecimal val]
...
(defn print-float
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Float val]
    (-> this (.printFloat val))))
...
(defn print-byte
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Byte val]
    (-> this (.printByte val))))
...
(defn parse-boolean
  ...
  (^Boolean [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-boolean]
...
(defn print-integer
  ...
  throws: java.lang.IllegalArgumentException - val is null."
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.math.BigInteger val]
...
(defn parse-double
  ...
  (^Double [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-double]
...
(defn parse-long
  ...
  (^Long [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-long]
...
(defn parse-any-simple-type
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-any-simple-type]
...
(defn print-double
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Double val]
...
(defn parse-unsigned-short
  ...
  (^Integer [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-unsigned-short]
...
(defn parse-byte
  ...
  (^Byte [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-byte]
...
(defn print-boolean
  ...
  (^java.lang.String [^javax.xml.bind.DatatypeConverterInterface this ^Boolean val]
...
(defn parse-unsigned-int
  ...
  (^Long [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-unsigned-int]
...
(defn parse-int
  ...
  (^Integer [^javax.xml.bind.DatatypeConverterInterface this ^java.lang.String lexical-xsd-int]
