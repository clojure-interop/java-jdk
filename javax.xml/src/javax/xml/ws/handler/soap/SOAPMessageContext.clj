...
(defn get-message
  ...
  (^javax.xml.soap.SOAPMessage [^SOAPMessageContext this]
    (-> this (.getMessage))))
...
(defn set-message
  ...
  ([^SOAPMessageContext this ^javax.xml.soap.SOAPMessage message]
...
(defn get-headers
  ...
  ([^SOAPMessageContext this ^javax.xml.namespace.QName header ^javax.xml.bind.JAXBContext context ^Boolean all-roles]
...
(defn get-roles
  ...
  (^java.util.Set [^SOAPMessageContext this]
    (-> this (.getRoles))))
