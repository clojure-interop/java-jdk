...
(defn set-payload
  ...
  ([^javax.xml.ws.LogicalMessage this ^java.lang.Object payload ^javax.xml.bind.JAXBContext context]
    (-> this (.setPayload payload context)))
  ([^javax.xml.ws.LogicalMessage this ^javax.xml.transform.Source payload]
