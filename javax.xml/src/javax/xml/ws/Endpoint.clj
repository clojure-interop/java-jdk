...
(defn *create
  ...
  ([^java.lang.String binding-id ^java.lang.Object implementor ^javax.xml.ws.WebServiceFeature features]
    (Endpoint/create binding-id implementor features))
  ([^java.lang.Object implementor ^javax.xml.ws.WebServiceFeature features]
...
(defn *publish
  ...
  ([^java.lang.String address ^java.lang.Object implementor ^javax.xml.ws.WebServiceFeature features]
    (Endpoint/publish address implementor features))
  ([^java.lang.String address ^java.lang.Object implementor]
...
(defn get-endpoint-reference
  ...
  ([^javax.xml.ws.Endpoint this ^org.w3c.dom.Element reference-parameters]
