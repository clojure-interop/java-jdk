...
(defn create-dispatch
  ...
  ([^ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class type ^javax.xml.ws.Service$Mode mode ^javax.xml.ws.WebServiceFeature features]
    (-> this (.createDispatch port-name type mode features)))
  ([^ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class type ^javax.xml.ws.Service$Mode mode]
...
(defn set-handler-resolver
  ...
  ([^ServiceDelegate this ^javax.xml.ws.handler.HandlerResolver handler-resolver]
...
(defn get-executor
  ...
  (^java.util.concurrent.Executor [^ServiceDelegate this]
    (-> this (.getExecutor))))
...
(defn set-executor
  ...
  ([^ServiceDelegate this ^java.util.concurrent.Executor executor]
...
(defn get-handler-resolver
  ...
  (^javax.xml.ws.handler.HandlerResolver [^ServiceDelegate this]
...
(defn get-service-name
  ...
  (^javax.xml.namespace.QName [^ServiceDelegate this]
    (-> this (.getServiceName))))
...
(defn get-port
  ...
  service-endpoint-interface - Service endpoint interface supported by the dynamic proxy or instance - `java.lang.Class`
  features - A list of WebServiceFeatures to configure on the proxy. Supported features not in the features parameter will have their default values. - `javax.xml.ws.WebServiceFeature`
  ...
  ([^ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class service-endpoint-interface ^javax.xml.ws.WebServiceFeature features]
    (-> this (.getPort port-name service-endpoint-interface features)))
  ([^ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class service-endpoint-interface]
    (-> this (.getPort port-name service-endpoint-interface)))
  ([^ServiceDelegate this ^java.lang.Class service-endpoint-interface]
...
(defn get-wsdl-document-location
  ...
  (^java.net.URL [^ServiceDelegate this]
...
(defn get-ports
  ...
  (^java.util.Iterator [^ServiceDelegate this]
    (-> this (.getPorts))))
...
(defn add-port
  ...
  ([^ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.String binding-id ^java.lang.String endpoint-address]
