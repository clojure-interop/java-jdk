...
(defn create-dispatch
  ...
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class type ^javax.xml.ws.Service.Mode mode ^javax.xml.ws.WebServiceFeature features]
    (-> this (.createDispatch port-name type mode features)))
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class type ^javax.xml.ws.Service.Mode mode]
...
(defn set-handler-resolver
  ...
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.ws.handler.HandlerResolver handler-resolver]
...
(defn set-executor
  ...
  ([^javax.xml.ws.spi.ServiceDelegate this ^java.util.concurrent.Executor executor]
...
(defn get-port
  ...
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class service-endpoint-interface ^javax.xml.ws.WebServiceFeature features]
    (-> this (.getPort port-name service-endpoint-interface features)))
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.Class service-endpoint-interface]
    (-> this (.getPort port-name service-endpoint-interface)))
  ([^javax.xml.ws.spi.ServiceDelegate this ^java.lang.Class service-endpoint-interface]
...
(defn add-port
  ...
  ([^javax.xml.ws.spi.ServiceDelegate this ^javax.xml.namespace.QName port-name ^java.lang.String binding-id ^java.lang.String endpoint-address]
