...
(defn get-request-header
  ...
  (^java.lang.String [^HttpExchange this ^java.lang.String name]
...
(defn get-remote-address
  ...
  (^java.net.InetSocketAddress [^HttpExchange this]
...
(defn add-response-header
  ...
  ([^HttpExchange this ^java.lang.String name ^java.lang.String value]
...
(defn get-attribute
  ...
  (^java.lang.Object [^HttpExchange this ^java.lang.String name]
...
(defn user-in-role?
  ...
  returns: true if the user making this request belongs to a
           given role - `boolean`"
  (^Boolean [^HttpExchange this ^java.lang.String role]
...
(defn get-request-body
  ...
  (^java.io.InputStream [^HttpExchange this]
    (-> this (.getRequestBody))))
...
(defn get-response-headers
  ...
  (^java.util.Map [^HttpExchange this]
...
(defn get-user-principal
  ...
  (^java.security.Principal [^HttpExchange this]
...
(defn get-http-context
  ...
  (^javax.xml.ws.spi.http.HttpContext [^HttpExchange this]
    (-> this (.getHttpContext))))
...
(defn get-response-body
  ...
  (^java.io.OutputStream [^HttpExchange this]
...
(defn get-attribute-names
  ...
  (^java.util.Set [^HttpExchange this]
...
(defn set-status
  ...
  ([^HttpExchange this ^Integer status]
