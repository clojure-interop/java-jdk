...
(defn get-feature?
  ...
  (^Boolean [^Validator this ^java.lang.String name]
...
(defn get-resource-resolver
  ...
  (^org.w3c.dom.ls.LSResourceResolver [^Validator this]
...
(defn set-resource-resolver
  ...
  ([^Validator this ^org.w3c.dom.ls.LSResourceResolver resource-resolver]
...
(defn validate
  ...
  ([^Validator this ^javax.xml.transform.Source source ^javax.xml.transform.Result result]
    (-> this (.validate source result)))
  ([^Validator this ^javax.xml.transform.Source source]
...
(defn get-error-handler
  ...
  (^org.xml.sax.ErrorHandler [^Validator this]
...
(defn set-error-handler
  ...
  ([^Validator this ^org.xml.sax.ErrorHandler error-handler]
...
(defn set-feature
  ...
  throws: org.xml.sax.SAXNotRecognizedException - If the feature value can't be assigned or retrieved."
  ([^Validator this ^java.lang.String name ^Boolean value]
...
(defn set-property
  ...
  throws: org.xml.sax.SAXNotRecognizedException - If the property value can't be assigned or retrieved."
  ([^Validator this ^java.lang.String name ^java.lang.Object object]
