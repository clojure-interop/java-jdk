...
(defn get-element-type-info
  ...
  (^org.w3c.dom.TypeInfo [^javax.xml.validation.TypeInfoProvider this]
...
(defn get-attribute-type-info
  ...
  (^org.w3c.dom.TypeInfo [^javax.xml.validation.TypeInfoProvider this ^Integer index]
...
(defn id-attribute?
  ...
  throws: java.lang.IndexOutOfBoundsException - If the index is invalid."
  (^Boolean [^javax.xml.validation.TypeInfoProvider this ^Integer index]
