...
(defn create-ignorable-space
  ...
  (^javax.xml.stream.events.Characters [^XMLEventFactory this ^java.lang.String content]
...
(defn create-processing-instruction
  ...
  (^javax.xml.stream.events.ProcessingInstruction [^XMLEventFactory this ^java.lang.String target ^java.lang.String data]
...
(defn create-end-document
  ...
  (^javax.xml.stream.events.EndDocument [^XMLEventFactory this]
...
(defn set-location
  ...
  ([^XMLEventFactory this ^javax.xml.stream.Location location]
...
(defn create-comment
  ...
  (^javax.xml.stream.events.Comment [^XMLEventFactory this ^java.lang.String text]
...
(defn create-namespace
  ...
  (^javax.xml.stream.events.Namespace [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri]
    (-> this (.createNamespace prefix namespace-uri)))
  (^javax.xml.stream.events.Namespace [^XMLEventFactory this ^java.lang.String namespace-uri]
...
(defn create-entity-reference
  ...
  (^javax.xml.stream.events.EntityReference [^XMLEventFactory this ^java.lang.String name ^javax.xml.stream.events.EntityDeclaration declaration]
...
(defn create-attribute
  ...
  (^javax.xml.stream.events.Attribute [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name ^java.lang.String value]
    (-> this (.createAttribute prefix namespace-uri local-name value)))
  (^javax.xml.stream.events.Attribute [^XMLEventFactory this ^java.lang.String local-name ^java.lang.String value]
...
(defn create-end-element
  ...
  (^javax.xml.stream.events.EndElement [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name ^java.util.Iterator namespaces]
    (-> this (.createEndElement prefix namespace-uri local-name namespaces)))
  (^javax.xml.stream.events.EndElement [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name]
    (-> this (.createEndElement prefix namespace-uri local-name)))
  (^javax.xml.stream.events.EndElement [^XMLEventFactory this ^javax.xml.namespace.QName name ^java.util.Iterator namespaces]
...
(defn create-start-element
  ...
  (^javax.xml.stream.events.StartElement [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name ^java.util.Iterator attributes ^java.util.Iterator namespaces ^javax.xml.namespace.NamespaceContext context]
    (-> this (.createStartElement prefix namespace-uri local-name attributes namespaces context)))
  (^javax.xml.stream.events.StartElement [^XMLEventFactory this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name ^java.util.Iterator attributes ^java.util.Iterator namespaces]
    (-> this (.createStartElement prefix namespace-uri local-name attributes namespaces)))
  (^javax.xml.stream.events.StartElement [^XMLEventFactory this ^javax.xml.namespace.QName name ^java.util.Iterator attributes ^java.util.Iterator namespaces]
...
(defn create-start-document
  ...
  (^javax.xml.stream.events.StartDocument [^XMLEventFactory this ^java.lang.String encoding ^java.lang.String version]
    (-> this (.createStartDocument encoding version)))
  (^javax.xml.stream.events.StartDocument [^XMLEventFactory this ^java.lang.String encoding]
    (-> this (.createStartDocument encoding)))
  (^javax.xml.stream.events.StartDocument [^XMLEventFactory this]
...
(defn create-dtd
  ...
  (^javax.xml.stream.events.DTD [^XMLEventFactory this ^java.lang.String dtd]
    (-> this (.createDTD dtd))))
