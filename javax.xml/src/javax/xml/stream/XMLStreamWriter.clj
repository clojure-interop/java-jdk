...
(defn write-namespace
  ...
  ([^. this ^java.lang.String prefix ^java.lang.String namespace-uri]
...
(defn write-default-namespace
  ...
  throws: java.lang.IllegalStateException - if the current state does not allow Namespace writing"
  ([^. this ^java.lang.String namespace-uri]
...
(defn write-start-document
  ...
  ([^. this ^java.lang.String encoding ^java.lang.String version]
    (-> this (.writeStartDocument encoding version)))
  ([^. this ^java.lang.String version]
...
(defn write-processing-instruction
  ...
  throws: javax.xml.stream.XMLStreamException"
  ([^. this ^java.lang.String target ^java.lang.String data]
    (-> this (.writeProcessingInstruction target data)))
  ([^. this ^java.lang.String target]
...
(defn write-characters
  ...
  throws: javax.xml.stream.XMLStreamException"
  ([^. this text ^Integer start ^Integer len]
...
(defn write-start-element
  ...
  throws: javax.xml.stream.XMLStreamException"
  ([^. this ^java.lang.String prefix ^java.lang.String local-name ^java.lang.String namespace-uri]
  ...
  ([^. this ^java.lang.String local-name]
...
(defn write-attribute
  ...
  ([^. this ^java.lang.String prefix ^java.lang.String namespace-uri ^java.lang.String local-name ^java.lang.String value]
    (-> this (.writeAttribute prefix namespace-uri local-name value)))
  ([^. this ^java.lang.String namespace-uri ^java.lang.String local-name ^java.lang.String value]
    (-> this (.writeAttribute namespace-uri local-name value)))
  ([^. this ^java.lang.String local-name ^java.lang.String value]
