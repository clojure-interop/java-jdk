...
(defn get-name
  ...
  (^javax.xml.namespace.QName [^StartElement this]
    (-> this (.getName))))
...
(defn get-attributes
  ...
  (^java.util.Iterator [^StartElement this]
    (-> this (.getAttributes))))
...
(defn get-attribute-by-name
  ...
  (^javax.xml.stream.events.Attribute [^StartElement this ^javax.xml.namespace.QName name]
...
(defn get-namespace-context
  ...
  (^javax.xml.namespace.NamespaceContext [^StartElement this]
...
(defn get-namespace-uri
  ...
  (^java.lang.String [^StartElement this ^java.lang.String prefix]
