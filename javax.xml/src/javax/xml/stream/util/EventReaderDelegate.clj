...
(defn peek
  ...
  (^javax.xml.stream.events.XMLEvent [^EventReaderDelegate this]
    (-> this (.peek))))
...
(defn set-parent
  ...
  ([^EventReaderDelegate this ^javax.xml.stream.XMLEventReader reader]
...
(defn next
  ...
  (^java.lang.Object [^EventReaderDelegate this]
    (-> this (.next))))
...
(defn get-element-text
  ...
  (^java.lang.String [^EventReaderDelegate this]
    (-> this (.getElementText))))
...
(defn get-parent
  ...
  (^javax.xml.stream.XMLEventReader [^EventReaderDelegate this]
    (-> this (.getParent))))

(defn remove
  "Description copied from interface: Iterator"
  ([^EventReaderDelegate this]
    (-> this (.remove))))
...
(defn has-next?
  ...
  (^Boolean [^EventReaderDelegate this]
    (-> this (.hasNext))))
...
(defn get-property
  ...
  (^java.lang.Object [^EventReaderDelegate this ^java.lang.String name]
