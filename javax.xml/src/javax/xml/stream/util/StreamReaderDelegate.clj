...
(defn set-parent
  ...
  ([^javax.xml.stream.util.StreamReaderDelegate this ^javax.xml.stream.XMLStreamReader reader]
...
(defn require
  ...
  ([^javax.xml.stream.util.StreamReaderDelegate this ^Integer type ^java.lang.String namespace-uri ^java.lang.String local-name]
