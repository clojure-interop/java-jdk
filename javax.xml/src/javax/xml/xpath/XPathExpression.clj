...
(defn evaluate
  ...
  (^java.lang.Object [^XPathExpression this ^java.lang.Object item ^javax.xml.namespace.QName return-type]
    (-> this (.evaluate item return-type)))
  (^java.lang.String [^XPathExpression this ^java.lang.Object item]
    (-> this (.evaluate item))))
