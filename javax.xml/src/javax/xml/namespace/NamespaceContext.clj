...
(defn get-namespace-uri
  ...
  (^java.lang.String [^NamespaceContext this ^java.lang.String prefix]
...
(defn get-prefix
  ...
  (^java.lang.String [^NamespaceContext this ^java.lang.String namespace-uri]
...
(defn get-prefixes
  ...
  throws: java.lang.IllegalArgumentException - When namespaceURI is null"
  (^java.util.Iterator [^NamespaceContext this ^java.lang.String namespace-uri]
