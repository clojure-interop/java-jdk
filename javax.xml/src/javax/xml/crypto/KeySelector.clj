...
(defn select
  ...
  (^javax.xml.crypto.KeySelectorResult [^KeySelector this ^javax.xml.crypto.dsig.keyinfo.KeyInfo key-info ^javax.xml.crypto.KeySelector$Purpose purpose ^javax.xml.crypto.AlgorithmMethod method ^javax.xml.crypto.XMLCryptoContext context]
