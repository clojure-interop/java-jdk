...
(defn get-parameter-spec
  ...
  (^java.security.spec.AlgorithmParameterSpec [^javax.xml.crypto.dsig.Transform this]
...
(defn transform
  ...
  (^javax.xml.crypto.Data [^javax.xml.crypto.dsig.Transform this ^javax.xml.crypto.Data data ^javax.xml.crypto.XMLCryptoContext context ^java.io.OutputStream os]
    (-> this (.transform data context os)))
  (^javax.xml.crypto.Data [^javax.xml.crypto.dsig.Transform this ^javax.xml.crypto.Data data ^javax.xml.crypto.XMLCryptoContext context]
