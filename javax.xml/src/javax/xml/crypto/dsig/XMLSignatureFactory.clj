...
(defn new-xml-object
  ...
  ([this content id mime-type encoding]
...
(defn new-xml-signature
  ...
  ([this si ki objects id signature-value-id]
...
(defn new-reference
  ...
  ([this uri dm applied-transforms result transforms type id]
    (-> this (.newReference uri dm applied-transforms result transforms type id)))
  ([this uri dm transforms type id digest-value]
    (-> this (.newReference uri dm transforms type id digest-value)))
  ([this uri dm transforms type id]
