...
(defn *get-instance
  ...
  ([^java.lang.String mechanism-type ^java.security.Provider provider]
    (XMLSignatureFactory/getInstance mechanism-type provider))
  ([^java.lang.String mechanism-type]
...
(defn new-signature-properties
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.util.List properties ^java.lang.String id]
...
(defn new-signed-info
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^javax.xml.crypto.dsig.CanonicalizationMethod cm ^javax.xml.crypto.dsig.SignatureMethod sm ^java.util.List references ^java.lang.String id]
    (-> this (.newSignedInfo cm sm references id)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^javax.xml.crypto.dsig.CanonicalizationMethod cm ^javax.xml.crypto.dsig.SignatureMethod sm ^java.util.List references]
...
(defn get-uri-dereferencer
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this]
...
(defn new-signature-property
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.util.List content ^java.lang.String target ^java.lang.String id]
...
(defn new-xml-object
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.util.List content ^java.lang.String id ^java.lang.String mime-type ^java.lang.String encoding]
...
(defn new-xml-signature
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^javax.xml.crypto.dsig.SignedInfo si ^javax.xml.crypto.dsig.keyinfo.KeyInfo ki ^java.util.List objects ^java.lang.String id ^java.lang.String signature-value-id]
    (-> this (.newXMLSignature si ki objects id signature-value-id)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^javax.xml.crypto.dsig.SignedInfo si ^javax.xml.crypto.dsig.keyinfo.KeyInfo ki]
...
(defn new-signature-method
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String algorithm ^javax.xml.crypto.dsig.spec.SignatureMethodParameterSpec params]
...
(defn new-reference
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String uri ^javax.xml.crypto.dsig.DigestMethod dm ^java.util.List applied-transforms ^javax.xml.crypto.Data result ^java.util.List transforms ^java.lang.String type ^java.lang.String id]
    (-> this (.newReference uri dm applied-transforms result transforms type id)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String uri ^javax.xml.crypto.dsig.DigestMethod dm ^java.util.List transforms ^java.lang.String type ^java.lang.String id digest-value]
    (-> this (.newReference uri dm transforms type id digest-value)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String uri ^javax.xml.crypto.dsig.DigestMethod dm ^java.util.List transforms ^java.lang.String type ^java.lang.String id]
    (-> this (.newReference uri dm transforms type id)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String uri ^javax.xml.crypto.dsig.DigestMethod dm]
...
(defn feature-supported?
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String feature]
...
(defn unmarshal-xml-signature
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^javax.xml.crypto.dsig.XMLValidateContext context]
...
(defn new-transform
  ...
  throws: java.security.InvalidAlgorithmParameterException - if the specified parameters are inappropriate for the requested algorithm"
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String algorithm ^javax.xml.crypto.dsig.spec.TransformParameterSpec params]
...
(defn new-canonicalization-method
  ...
  throws: java.security.InvalidAlgorithmParameterException - if the specified parameters are inappropriate for the requested algorithm"
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String algorithm ^javax.xml.crypto.dsig.spec.C14NMethodParameterSpec params]
...
(defn new-manifest
  ...
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.util.List references ^java.lang.String id]
    (-> this (.newManifest references id)))
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.util.List references]
...
(defn new-digest-method
  ...
  throws: java.security.InvalidAlgorithmParameterException - if the specified parameters are inappropriate for the requested algorithm"
  ([^javax.xml.crypto.dsig.XMLSignatureFactory this ^java.lang.String algorithm ^javax.xml.crypto.dsig.spec.DigestMethodParameterSpec params]
