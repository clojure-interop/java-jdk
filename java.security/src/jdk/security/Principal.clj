...
(defn equals
  ...
  (^Boolean [^Principal this ^java.lang.Object another]
    (-> this (.equals another))))
...
(defn to-string
  ...
  (^java.lang.String [^Principal this]
    (-> this (.toString))))
...
(defn implies
  ...
  ([^Principal this ^javax.security.auth.Subject subject]
