...
(defn ->unresolved-permission
  ...
  ([^java.lang.String type ^java.lang.String name ^java.lang.String actions ^java.security.cert.Certificate[] certs]
...
(defn implies
  ...
  ([^java.security.UnresolvedPermission this ^java.security.Permission p]
    (-> this (.implies p))))
...
(defn equals
  ...
  ([^java.security.UnresolvedPermission this ^java.lang.Object obj]
    (-> this (.equals obj))))
