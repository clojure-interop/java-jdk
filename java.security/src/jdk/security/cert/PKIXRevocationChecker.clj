...
(defn set-options
  ...
  ([^PKIXRevocationChecker this ^java.util.Set options]
...
(defn set-ocsp-extensions
  ...
  ([^PKIXRevocationChecker this ^java.util.List extensions]
...
(defn get-ocsp-responder-cert
  ...
  (^java.security.cert.X509Certificate [^PKIXRevocationChecker this]
...
(defn set-ocsp-responses
  ...
  ([^PKIXRevocationChecker this ^java.util.Map responses]
...
(defn get-ocsp-responder
  ...
  (^java.net.URI [^PKIXRevocationChecker this]
...
(defn get-soft-fail-exceptions
  ...
  (^java.util.List [^PKIXRevocationChecker this]
...
(defn set-ocsp-responder
  ...
  ([^PKIXRevocationChecker this ^java.net.URI uri]
...
(defn get-options
  ...
  (^java.util.Set [^PKIXRevocationChecker this]
    (-> this (.getOptions))))
...
(defn clone
  ...
  (^java.security.cert.PKIXRevocationChecker [^PKIXRevocationChecker this]
    (-> this (.clone))))
...
(defn set-ocsp-responder-cert
  ...
  ([^PKIXRevocationChecker this ^java.security.cert.X509Certificate cert]
