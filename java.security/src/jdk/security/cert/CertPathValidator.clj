...
(defn get-provider
  ...
  ([^java.security.cert.CertPathValidator this]
    (-> this (.getProvider))))
...
(defn validate
  ...
  ([^java.security.cert.CertPathValidator this ^java.security.cert.CertPath cert-path ^java.security.cert.CertPathParameters params]
