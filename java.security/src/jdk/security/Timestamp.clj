...
(defn ->timestamp
  ...
  (^Timestamp [^java.util.Date timestamp ^java.security.cert.CertPath signer-cert-path]
...
(defn get-signer-cert-path
  ...
  (^java.security.cert.CertPath [^Timestamp this]
...
(defn equals
  ...
  (^Boolean [^Timestamp this ^java.lang.Object obj]
    (-> this (.equals obj))))
