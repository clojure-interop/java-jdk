...
(defn ->rsa-multi-prime-private-crt-key-spec
  ...
  ([^java.math.BigInteger modulus ^java.math.BigInteger public-exponent ^java.math.BigInteger private-exponent ^java.math.BigInteger prime-p ^java.math.BigInteger prime-q ^java.math.BigInteger prime-exponent-p ^java.math.BigInteger prime-exponent-q ^java.math.BigInteger crt-coefficient other-prime-info]
...
(defn get-public-exponent
  ...
  (^java.math.BigInteger [^java.security.spec.RSAMultiPrimePrivateCrtKeySpec this]
