...
(defn set-name
  ...
  ([^. this ^java.security.Principal caller ^java.lang.String name]
...
(defn add-entry
  ...
  throws: java.security.acl.NotOwnerException - if the caller principal is not an owner of this ACL."
  ([^. this ^java.security.Principal caller ^java.security.acl.AclEntry entry]
...
(defn get-permissions
  ...
  ([^. this ^java.security.Principal user]
...
(defn check-permission
  ...
  returns: true if the principal has the specified permission, false
   otherwise. - `boolean`"
  ([^. this ^java.security.Principal principal ^java.security.acl.Permission permission]
