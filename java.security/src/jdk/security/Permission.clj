...
(defn check-guard
  ...
  ([^Permission this ^java.lang.Object object]
...
(defn implies
  ...
  (^Boolean [^Permission this ^java.security.Permission permission]
...
(defn equals
  ...
  (^Boolean [^Permission this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn new-permission-collection
  ...
  (^java.security.PermissionCollection [^Permission this]
