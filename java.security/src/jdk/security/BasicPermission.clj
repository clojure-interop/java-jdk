...
(defn implies
  ...
  (^Boolean [^BasicPermission this ^java.security.Permission p]
    (-> this (.implies p))))
...
(defn equals
  ...
  (^Boolean [^BasicPermission this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn new-permission-collection
  ...
  (^java.security.PermissionCollection [^BasicPermission this]
