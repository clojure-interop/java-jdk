...
(defn get-supported-source-version
  ...
  (^javax.lang.model.SourceVersion [^Processor this]
...
(defn init
  ...
  ([^Processor this ^javax.annotation.processing.ProcessingEnvironment processing-env]
...
(defn process
  ...
  (^Boolean [^Processor this ^java.util.Set annotations ^javax.annotation.processing.RoundEnvironment round-env]
...
(defn get-completions
  ...
  ([^Processor this ^javax.lang.model.element.Element element ^javax.lang.model.element.AnnotationMirror annotation ^javax.lang.model.element.ExecutableElement member ^java.lang.String user-text]
