...
(defn get-text-range
  ...
  (^java.lang.String [^AccessibleExtendedText this ^Integer start-index ^Integer end-index]
...
(defn get-text-sequence-at
  ...
  (^javax.accessibility.AccessibleTextSequence [^AccessibleExtendedText this ^Integer part ^Integer index]
...
(defn get-text-bounds
  ...
  (^java.awt.Rectangle [^AccessibleExtendedText this ^Integer start-index ^Integer end-index]
