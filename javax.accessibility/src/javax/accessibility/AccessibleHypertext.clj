...
(defn get-link-count
  ...
  (^Integer [^javax.accessibility.AccessibleHypertext this]
    (-> this (.getLinkCount))))
...
(defn get-link
  ...
  (^javax.accessibility.AccessibleHyperlink [^javax.accessibility.AccessibleHypertext this ^Integer link-index]
...
(defn get-link-index
  ...
  (^Integer [^javax.accessibility.AccessibleHypertext this ^Integer char-index]
