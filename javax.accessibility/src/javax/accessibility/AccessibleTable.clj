...
(defn set-accessible-summary
  ...
  ([^. this ^javax.accessibility.Accessible a]
...
(defn set-accessible-row-header
  ...
  ([^. this ^javax.accessibility.AccessibleTable table]
...
(defn set-accessible-column-description
  ...
  ([^. this ^Integer c ^javax.accessibility.Accessible a]
...
(defn set-accessible-row-description
  ...
  ([^. this ^Integer r ^javax.accessibility.Accessible a]
