...
(defn delete
  ...
  ([^. this ^Integer start-index ^Integer end-index]
...
(defn insert-text-at-index
  ...
  ([^. this ^Integer index ^java.lang.String s]
...
(defn replace-text
  ...
  ([^. this ^Integer start-index ^Integer end-index ^java.lang.String s]
...
(defn set-attributes
  ...
  ([^. this ^Integer start-index ^Integer end-index ^javax.swing.text.AttributeSet as]
