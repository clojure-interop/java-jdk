...
(defn write-utf
  ...
  ([^javax.imageio.stream.ImageOutputStream this ^java.lang.String s]
    (-> this (.writeUTF s))))
...
(defn write-double
  ...
  ([^javax.imageio.stream.ImageOutputStream this ^Double v]
    (-> this (.writeDouble v))))
...
(defn write-doubles
  ...
  ([^javax.imageio.stream.ImageOutputStream this d ^Integer off ^Integer len]
...
(defn write-boolean
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^javax.imageio.stream.ImageOutputStream this ^Boolean v]
    (-> this (.writeBoolean v))))
...
(defn flush-before
  ...
  ([^javax.imageio.stream.ImageOutputStream this ^Long pos]
...
(defn write-long
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^javax.imageio.stream.ImageOutputStream this ^Long v]
    (-> this (.writeLong v))))
...
(defn write-short
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^javax.imageio.stream.ImageOutputStream this ^Integer v]
    (-> this (.writeShort v))))
...
(defn write-floats
  ...
  ([^javax.imageio.stream.ImageOutputStream this f ^Integer off ^Integer len]
...
(defn write-shorts
  ...
  ([^javax.imageio.stream.ImageOutputStream this s ^Integer off ^Integer len]
...
(defn write-longs
  ...
  ([^javax.imageio.stream.ImageOutputStream this l ^Integer off ^Integer len]
...
(defn write-bit
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^javax.imageio.stream.ImageOutputStream this ^Integer bit]
    (-> this (.writeBit bit))))
...
(defn write-float
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^javax.imageio.stream.ImageOutputStream this ^Float v]
    (-> this (.writeFloat v))))
...
(defn write-chars
  ...
  ([^javax.imageio.stream.ImageOutputStream this c ^Integer off ^Integer len]
...
(defn write-bits
  ...
  ([^javax.imageio.stream.ImageOutputStream this ^Long bits ^Integer num-bits]
...
(defn write-ints
  ...
  ([^javax.imageio.stream.ImageOutputStream this i ^Integer off ^Integer len]
...
(defn write
  ...
  ([^javax.imageio.stream.ImageOutputStream this b ^Integer off ^Integer len]
    (-> this (.write b off len)))
  ([^javax.imageio.stream.ImageOutputStream this ^Integer b]
    (-> this (.write b))))
