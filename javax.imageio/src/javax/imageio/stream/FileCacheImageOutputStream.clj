...
(defn ->file-cache-image-output-stream
  ...
  (^FileCacheImageOutputStream [^java.io.OutputStream stream ^java.io.File cache-dir]
...
(defn flush-before
  ...
  ([^FileCacheImageOutputStream this ^Long pos]
...
(defn read
  ...
  throws: java.io.IOException - if an I/O error occurs."
  (^Integer [^FileCacheImageOutputStream this b ^Integer off ^Integer len]
    (-> this (.read b off len)))
  (^Integer [^FileCacheImageOutputStream this]
    (-> this (.read))))
...
(defn cached-memory?
  ...
  (^Boolean [^FileCacheImageOutputStream this]
    (-> this (.isCachedMemory))))
...
(defn length
  ...
  (^Long [^FileCacheImageOutputStream this]
    (-> this (.length))))
...
(defn close
  ...
  ([^FileCacheImageOutputStream this]
    (-> this (.close))))
...
(defn write
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^FileCacheImageOutputStream this b ^Integer off ^Integer len]
    (-> this (.write b off len)))
  ([^FileCacheImageOutputStream this ^Integer b]
    (-> this (.write b))))
