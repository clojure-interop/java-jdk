...
(defn read-bytes
  ...
  ([^ImageInputStream this ^javax.imageio.stream.IIOByteBuffer buf ^Integer len]
...
(defn set-byte-order
  ...
  ([^ImageInputStream this ^java.nio.ByteOrder byte-order]
...
(defn read-fully
  ...
  ([^ImageInputStream this b ^Integer off ^Integer len]
    (-> this (.readFully b off len)))
  ([^ImageInputStream this b]
    (-> this (.readFully b))))
...
(defn read-char
  ...
  (^Character [^ImageInputStream this]
    (-> this (.readChar))))
...
(defn set-bit-offset
  ...
  ([^ImageInputStream this ^Integer bit-offset]
...
(defn flush-before
  ...
  ([^ImageInputStream this ^Long pos]
...
(defn read
  ...
  (^Integer [^ImageInputStream this b ^Integer off ^Integer len]
    (-> this (.read b off len)))
  (^Integer [^ImageInputStream this b]
    (-> this (.read b)))
  (^Integer [^ImageInputStream this]
    (-> this (.read))))
...
(defn get-byte-order
  ...
  (^java.nio.ByteOrder [^ImageInputStream this]
    (-> this (.getByteOrder))))
...
(defn skip-bytes
  ...
  throws: java.io.IOException - if an I/O error occurs."
  (^Integer [^ImageInputStream this ^Integer n]
    (-> this (.skipBytes n))))
...
(defn read-utf
  ...
  (^java.lang.String [^ImageInputStream this]
    (-> this (.readUTF))))
...
(defn read-bits
  ...
  (^Long [^ImageInputStream this ^Integer num-bits]
