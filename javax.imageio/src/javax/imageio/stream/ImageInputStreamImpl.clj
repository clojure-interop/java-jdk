...
(defn read-unsigned-byte
  ...
  (^Integer [^ImageInputStreamImpl this]
...
(defn read-bytes
  ...
  ([^ImageInputStreamImpl this ^javax.imageio.stream.IIOByteBuffer buf ^Integer len]
...
(defn set-byte-order
  ...
  ([^ImageInputStreamImpl this ^java.nio.ByteOrder byte-order]
...
(defn read-byte
  ...
  throws: java.io.EOFException - if the end of the stream is reached."
  (^Byte [^ImageInputStreamImpl this]
    (-> this (.readByte))))
...
(defn read-fully
  ...
  ([^ImageInputStreamImpl this b ^Integer off ^Integer len]
    (-> this (.readFully b off len)))
  ([^ImageInputStreamImpl this b]
    (-> this (.readFully b))))
...
(defn read-char
  ...
  throws: java.io.EOFException - if the stream reaches the end before reading all the bytes."
  (^Character [^ImageInputStreamImpl this]
    (-> this (.readChar))))
...
(defn set-bit-offset
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^ImageInputStreamImpl this ^Integer bit-offset]
...
(defn get-stream-position
  ...
  throws: java.io.IOException - if an I/O error occurs."
  (^Long [^ImageInputStreamImpl this]
...
(defn read-float
  ...
  throws: java.io.EOFException - if the stream reaches the end before reading all the bytes."
  (^Float [^ImageInputStreamImpl this]
    (-> this (.readFloat))))
...
(defn flush-before
  ...
  throws: java.io.IOException - if an I/O error occurs."
  ([^ImageInputStreamImpl this ^Long pos]
...
(defn read
  ...
  (^Integer [^ImageInputStreamImpl this b ^Integer off ^Integer len]
    (-> this (.read b off len)))
  (^Integer [^ImageInputStreamImpl this b]
    (-> this (.read b)))
  (^Integer [^ImageInputStreamImpl this]
    (-> this (.read))))
...
(defn read-boolean
  ...
  throws: java.io.EOFException - if the end of the stream is reached."
  (^Boolean [^ImageInputStreamImpl this]
    (-> this (.readBoolean))))
...
(defn get-byte-order
  ...
  (^java.nio.ByteOrder [^ImageInputStreamImpl this]
    (-> this (.getByteOrder))))
...
(defn read-short
  ...
  throws: java.io.EOFException - if the stream reaches the end before reading all the bytes."
  (^Short [^ImageInputStreamImpl this]
    (-> this (.readShort))))
...
(defn skip-bytes
  ...
  (^Integer [^ImageInputStreamImpl this ^Integer n]
    (-> this (.skipBytes n))))
...
(defn read-utf
  ...
  (^java.lang.String [^ImageInputStreamImpl this]
    (-> this (.readUTF))))
...
(defn read-bits
  ...
  throws: java.io.EOFException - if the stream reaches the end before reading all the bits."
  (^Long [^ImageInputStreamImpl this ^Integer num-bits]
...
(defn read-double
  ...
  throws: java.io.EOFException - if the stream reaches the end before reading all the bytes."
  (^Double [^ImageInputStreamImpl this]
    (-> this (.readDouble))))
