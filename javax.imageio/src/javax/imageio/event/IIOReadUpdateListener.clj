...
(defn pass-started
  ...
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-image ^Integer pass ^Integer min-pass ^Integer max-pass ^Integer min-x ^Integer min-y ^Integer period-x ^Integer period-y bands]
...
(defn image-update
  ...
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-image ^Integer min-x ^Integer min-y ^Integer width ^Integer height ^Integer period-x ^Integer period-y bands]
...
(defn pass-complete
  ...
  source - the ImageReader object calling this method. - `javax.imageio.ImageReader`
  the-image - the BufferedImage being updated. - `java.awt.image.BufferedImage`"
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-image]
...
(defn thumbnail-pass-started
  ...
  period-y - the vertical spacing between updated pixels; a value of 1 means no gaps. - `int`
  bands - an array of ints indicating the the set bands that may be updated. - `int[]`"
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-thumbnail ^Integer pass ^Integer min-pass ^Integer max-pass ^Integer min-x ^Integer min-y ^Integer period-x ^Integer period-y bands]
...
(defn thumbnail-update
  ...
  period-y - the vertical spacing between updated pixels; a value of 1 means no gaps. - `int`
  bands - an array of ints indicating which bands are being updated. - `int[]`"
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-thumbnail ^Integer min-x ^Integer min-y ^Integer width ^Integer height ^Integer period-x ^Integer period-y bands]
...
(defn thumbnail-pass-complete
  ...
  source - the ImageReader object calling this method. - `javax.imageio.ImageReader`
  the-thumbnail - the BufferedImage thumbnail being updated. - `java.awt.image.BufferedImage`"
  ([^javax.imageio.event.IIOReadUpdateListener this ^javax.imageio.ImageReader source ^java.awt.image.BufferedImage the-thumbnail]
