...
(defn image-started
  ...
  ([^. this ^javax.imageio.ImageWriter source ^Integer image-index]
...
(defn image-progress
  ...
  ([^. this ^javax.imageio.ImageWriter source ^Float percentage-done]
...
(defn image-complete
  ...
  source - the ImageWriter object calling this method. - `javax.imageio.ImageWriter`"
  ([^. this ^javax.imageio.ImageWriter source]
...
(defn thumbnail-started
  ...
  ([^. this ^javax.imageio.ImageWriter source ^Integer image-index ^Integer thumbnail-index]
