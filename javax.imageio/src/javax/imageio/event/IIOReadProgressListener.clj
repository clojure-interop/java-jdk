...
(defn thumbnail-started
  ...
  ([^javax.imageio.event.IIOReadProgressListener this ^javax.imageio.ImageReader source ^Integer image-index ^Integer thumbnail-index]
...
(defn thumbnail-complete
  ...
  source - the ImageReader object calling this method. - `javax.imageio.ImageReader`"
  ([^javax.imageio.event.IIOReadProgressListener this ^javax.imageio.ImageReader source]
...
(defn sequence-started
  ...
  ([^javax.imageio.event.IIOReadProgressListener this ^javax.imageio.ImageReader source ^Integer min-index]
...
(defn image-progress
  ...
  ([^javax.imageio.event.IIOReadProgressListener this ^javax.imageio.ImageReader source ^Float percentage-done]
...
(defn image-started
  ...
  source - the ImageReader object calling this method. - `javax.imageio.ImageReader`
  image-index - the index of the image being read within its containing input file or stream. - `int`"
  ([^javax.imageio.event.IIOReadProgressListener this ^javax.imageio.ImageReader source ^Integer image-index]
