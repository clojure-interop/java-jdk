...
(defn convert-stream-metadata
  ...
  ([^javax.imageio.ImageTranscoder this ^javax.imageio.metadata.IIOMetadata in-data ^javax.imageio.ImageWriteParam param]
...
(defn convert-image-metadata
  ...
  ([^javax.imageio.ImageTranscoder this ^javax.imageio.metadata.IIOMetadata in-data ^javax.imageio.ImageTypeSpecifier image-type ^javax.imageio.ImageWriteParam param]
