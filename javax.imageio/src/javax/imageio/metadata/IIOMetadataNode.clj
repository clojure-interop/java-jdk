...
(defn ->iio-metadata-node
  ...
  (^IIOMetadataNode [^java.lang.String node-name]
...
(defn get-attribute-node-ns
  ...
  (^org.w3c.dom.Attr [^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name]
...
(defn get-node-value
  ...
  (^java.lang.String [^IIOMetadataNode this]
    (-> this (.getNodeValue))))
...
(defn set-prefix
  ...
  ([^IIOMetadataNode this ^java.lang.String prefix]
...
(defn get-owner-document
  ...
  (^org.w3c.dom.Document [^IIOMetadataNode this]
...
(defn set-user-object
  ...
  ([^IIOMetadataNode this ^java.lang.Object user-object]
...
(defn get-schema-type-info
  ...
  (^org.w3c.dom.TypeInfo [^IIOMetadataNode this]
...
(defn get-attribute-ns
  ...
  (^java.lang.String [^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name]
...
(defn get-feature
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^java.lang.Object [^IIOMetadataNode this ^java.lang.String feature ^java.lang.String version]
...
(defn set-text-content
  ...
  throws: org.w3c.dom.DOMException - - always."
  ([^IIOMetadataNode this ^java.lang.String text-content]
...
(defn set-id-attribute-ns
  ...
  throws: org.w3c.dom.DOMException - - always."
  ([^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name ^Boolean is-id]
...
(defn get-parent-node
  ...
  (^org.w3c.dom.Node [^IIOMetadataNode this]
    (-> this (.getParentNode))))
...
(defn get-attribute-node
  ...
  returns: The Attr node with the specified name (
     ...
     attribute. - `org.w3c.dom.Attr`"
  (^org.w3c.dom.Attr [^IIOMetadataNode this ^java.lang.String name]
...
(defn set-attribute-ns
  ...
  ([^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String qualified-name ^java.lang.String value]
...
(defn set-id-attribute
  ...
  throws: org.w3c.dom.DOMException - - always."
  ([^IIOMetadataNode this ^java.lang.String name ^Boolean is-id]
...
(defn append-child
  ...
  (^org.w3c.dom.Node [^IIOMetadataNode this ^org.w3c.dom.Node new-child]
...
(defn remove-attribute-ns
  ...
  ([^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name]
...
(defn get-user-data
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^java.lang.Object [^IIOMetadataNode this ^java.lang.String key]
...
(defn replace-child
  ...
  throws: java.lang.IllegalArgumentException - if newChild is null."
  (^org.w3c.dom.Node [^IIOMetadataNode this ^org.w3c.dom.Node new-child ^org.w3c.dom.Node old-child]
...
(defn get-attribute
  ...
  returns: The Attr value as a string, or the empty string
   if that attribute does not have a specified or default value. - `java.lang.String`"
  (^java.lang.String [^IIOMetadataNode this ^java.lang.String name]
...
(defn insert-before
  ...
  throws: java.lang.IllegalArgumentException - if newChild is null."
  (^org.w3c.dom.Node [^IIOMetadataNode this ^org.w3c.dom.Node new-child ^org.w3c.dom.Node ref-child]
...
(defn set-id-attribute-node
  ...
  throws: org.w3c.dom.DOMException - - always."
  ([^IIOMetadataNode this ^org.w3c.dom.Attr id-attr ^Boolean is-id]
...
(defn get-elements-by-tag-name-ns
  ...
  (^org.w3c.dom.NodeList [^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name]
...
(defn has-attribute-ns?
  ...
  (^Boolean [^IIOMetadataNode this ^java.lang.String namespace-uri ^java.lang.String local-name]
...
(defn remove-attribute
  ...
  ([^IIOMetadataNode this ^java.lang.String name]
...
(defn lookup-namespace-uri
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^java.lang.String [^IIOMetadataNode this ^java.lang.String prefix]
...
(defn item
  ...
  (^org.w3c.dom.Node [^IIOMetadataNode this ^Integer index]
    (-> this (.item index))))
...
(defn set-attribute
  ...
  ([^IIOMetadataNode this ^java.lang.String name ^java.lang.String value]
...
(defn compare-document-position
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^Short [^IIOMetadataNode this ^org.w3c.dom.Node other]
...
(defn default-namespace?
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^Boolean [^IIOMetadataNode this ^java.lang.String namespace-uri]
...
(defn get-child-nodes
  ...
  (^org.w3c.dom.NodeList [^IIOMetadataNode this]
    (-> this (.getChildNodes))))
...
(defn lookup-prefix
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^java.lang.String [^IIOMetadataNode this ^java.lang.String namespace-uri]
...
(defn supported?
  ...
  (^Boolean [^IIOMetadataNode this ^java.lang.String feature ^java.lang.String version]
...
(defn remove-attribute-node
  ...
  (^org.w3c.dom.Attr [^IIOMetadataNode this ^org.w3c.dom.Attr old-attr]
...
(defn set-attribute-node-ns
  ...
  (^org.w3c.dom.Attr [^IIOMetadataNode this ^org.w3c.dom.Attr new-attr]
...
(defn has-attribute?
  ...
  returns: true if an attribute with the given name is
     specified on this element or has a default value, false
      otherwise. - `boolean`"
  (^Boolean [^IIOMetadataNode this ^java.lang.String name]
...
(defn clone-node
  ...
  (^org.w3c.dom.Node [^IIOMetadataNode this ^Boolean deep]
    (-> this (.cloneNode deep))))
...
(defn remove-child
  ...
  (^org.w3c.dom.Node [^IIOMetadataNode this ^org.w3c.dom.Node old-child]
...
(defn equal-node?
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^Boolean [^IIOMetadataNode this ^org.w3c.dom.Node node]
...
(defn get-attributes
  ...
  (^org.w3c.dom.NamedNodeMap [^IIOMetadataNode this]
    (-> this (.getAttributes))))
...
(defn set-user-data
  ...
  throws: org.w3c.dom.DOMException - - always."
  (^java.lang.Object [^IIOMetadataNode this ^java.lang.String key ^java.lang.Object data ^org.w3c.dom.UserDataHandler handler]
...
(defn get-user-object
  ...
  (^java.lang.Object [^IIOMetadataNode this]
    (-> this (.getUserObject))))
...
(defn set-node-value
  ...
  ([^IIOMetadataNode this ^java.lang.String node-value]
