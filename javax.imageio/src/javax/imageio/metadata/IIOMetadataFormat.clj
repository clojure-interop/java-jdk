...
(defn get-child-names
  ...
  ([^IIOMetadataFormat this ^java.lang.String element-name]
...
(defn get-object-max-value
  ...
  (^java.lang.Comparable [^IIOMetadataFormat this ^java.lang.String element-name]
...
(defn can-node-appear?
  ...
  (^Boolean [^IIOMetadataFormat this ^java.lang.String element-name ^javax.imageio.ImageTypeSpecifier image-type]
...
(defn get-object-default-value
  ...
  (^java.lang.Object [^IIOMetadataFormat this ^java.lang.String element-name]
...
(defn get-object-class
  ...
  throws: java.lang.IllegalArgumentException - if the named element cannot contain an object value (i.e., if getObjectValueType(elementName) == VALUE_NONE)."
  (^java.lang.Class [^IIOMetadataFormat this ^java.lang.String element-name]
...
(defn get-attribute-min-value
  ...
  (^java.lang.String [^IIOMetadataFormat this ^java.lang.String element-name ^java.lang.String attr-name]
...
(defn get-child-policy
  ...
  throws: java.lang.IllegalArgumentException - if elementName is null or is not a legal element name for this format."
  (^Integer [^IIOMetadataFormat this ^java.lang.String element-name]
...
(defn get-attribute-description
  ...
  (^java.lang.String [^IIOMetadataFormat this ^java.lang.String element-name ^java.lang.String attr-name ^java.util.Locale locale]
...
(defn get-root-name
  ...
  (^java.lang.String [^IIOMetadataFormat this]
    (-> this (.getRootName))))
...
(defn attribute-required?
  ...
  throws: java.lang.IllegalArgumentException - if attrName is null or is not a legal attribute name for this element."
  (^Boolean [^IIOMetadataFormat this ^java.lang.String element-name ^java.lang.String attr-name]
...
(defn get-attribute-list-min-length
  ...
  (^Integer [^IIOMetadataFormat this ^java.lang.String element-name ^java.lang.String attr-name]
...
(defn get-attribute-enumerations
  ...
  ([^IIOMetadataFormat this ^java.lang.String element-name ^java.lang.String attr-name]
...
(defn get-element-description
  ...
  throws: java.lang.IllegalArgumentException - if elementName is null, or is not a legal element name for this format."
  (^java.lang.String [^IIOMetadataFormat this ^java.lang.String element-name ^java.util.Locale locale]
