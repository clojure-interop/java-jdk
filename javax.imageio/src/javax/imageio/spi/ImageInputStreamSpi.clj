...
(defn ->image-input-stream-spi
  ...
  (^ImageInputStreamSpi [^java.lang.String vendor-name ^java.lang.String version ^java.lang.Class input-class]
...
(defn get-input-class
  ...
  (^java.lang.Class [^ImageInputStreamSpi this]
    (-> this (.getInputClass))))
...
(defn can-use-cache-file?
  ...
  (^Boolean [^ImageInputStreamSpi this]
...
(defn create-input-stream-instance
  ...
  (^javax.imageio.stream.ImageInputStream [^ImageInputStreamSpi this ^java.lang.Object input ^Boolean use-cache ^java.io.File cache-dir]
    (-> this (.createInputStreamInstance input use-cache cache-dir)))
  (^javax.imageio.stream.ImageInputStream [^ImageInputStreamSpi this ^java.lang.Object input]
