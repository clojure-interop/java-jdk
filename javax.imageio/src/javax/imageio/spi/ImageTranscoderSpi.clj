...
(defn ->image-transcoder-spi
  ...
  (^ImageTranscoderSpi [^java.lang.String vendor-name ^java.lang.String version]
...
(defn get-reader-service-provider-name
  ...
  (^java.lang.String [^ImageTranscoderSpi this]
...
(defn create-transcoder-instance
  ...
  (^javax.imageio.ImageTranscoder [^ImageTranscoderSpi this]
