...
(defn ->image-writer-spi
  ...
  ([^java.lang.String vendor-name ^java.lang.String version ^java.lang.String[] names ^java.lang.String[] suffixes ^java.lang.String[] mime-types ^java.lang.String writer-class-name ^java.lang.Class[] output-types ^java.lang.String[] reader-spi-names ^Boolean supports-standard-stream-metadata-format ^java.lang.String native-stream-metadata-format-name ^java.lang.String native-stream-metadata-format-class-name ^java.lang.String[] extra-stream-metadata-format-names ^java.lang.String[] extra-stream-metadata-format-class-names ^Boolean supports-standard-image-metadata-format ^java.lang.String native-image-metadata-format-name ^java.lang.String native-image-metadata-format-class-name ^java.lang.String[] extra-image-metadata-format-names ^java.lang.String[] extra-image-metadata-format-class-names]
...
(defn can-encode-image?
  ...
  ([^javax.imageio.spi.ImageWriterSpi this ^javax.imageio.ImageTypeSpecifier type]
...
(defn create-writer-instance
  ...
  ([^javax.imageio.spi.ImageWriterSpi this ^java.lang.Object extension]
...
(defn own-writer?
  ...
  ([^javax.imageio.spi.ImageWriterSpi this ^javax.imageio.ImageWriter writer]
