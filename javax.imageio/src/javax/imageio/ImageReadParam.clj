...
(defn set-destination
  ...
  ([^ImageReadParam this ^java.awt.image.BufferedImage destination]
...
(defn set-destination-type
  ...
  ([^ImageReadParam this ^javax.imageio.ImageTypeSpecifier destination-type]
...
(defn get-destination
  ...
  (^java.awt.image.BufferedImage [^ImageReadParam this]
    (-> this (.getDestination))))
...
(defn get-source-render-size
  ...
  (^java.awt.Dimension [^ImageReadParam this]
...
(defn set-source-render-size
  ...
  ([^ImageReadParam this ^java.awt.Dimension size]
...
(defn set-destination-bands
  ...
  ([^ImageReadParam this destination-bands]
...
(defn set-source-progressive-passes
  ...
  ([^ImageReadParam this ^Integer min-pass ^Integer num-passes]
