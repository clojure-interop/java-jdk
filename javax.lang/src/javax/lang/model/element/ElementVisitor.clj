...
(defn visit
  ...
  ([^. this ^javax.lang.model.element.Element e ^ElementVisitor.P p]
    (-> this (.visit e p)))
...
(defn visit-package
  ...
  returns: a visitor-specified result - `ElementVisitor.R`"
  ([^. this ^javax.lang.model.element.PackageElement e ^ElementVisitor.P p]
...
(defn visit-type
  ...
  returns: a visitor-specified result - `ElementVisitor.R`"
  ([^. this ^javax.lang.model.element.TypeElement e ^ElementVisitor.P p]
    (-> this (.visitType e p))))
...
(defn visit-variable
  ...
  returns: a visitor-specified result - `ElementVisitor.R`"
  ([^. this ^javax.lang.model.element.VariableElement e ^ElementVisitor.P p]
...
(defn visit-executable
  ...
  returns: a visitor-specified result - `ElementVisitor.R`"
  ([^. this ^javax.lang.model.element.ExecutableElement e ^ElementVisitor.P p]
...
(defn visit-type-parameter
  ...
  returns: a visitor-specified result - `ElementVisitor.R`"
  ([^. this ^javax.lang.model.element.TypeParameterElement e ^ElementVisitor.P p]
