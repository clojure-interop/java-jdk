...
(defn get-nesting-kind
  ...
  (^javax.lang.model.element.NestingKind [^TypeElement this]
    (-> this (.getNestingKind))))
...
(defn get-qualified-name
  ...
  (^javax.lang.model.element.Name [^TypeElement this]
...
(defn get-superclass
  ...
  (^javax.lang.model.type.TypeMirror [^TypeElement this]
    (-> this (.getSuperclass))))
...
(defn get-enclosing-element
  ...
  (^javax.lang.model.element.Element [^TypeElement this]
