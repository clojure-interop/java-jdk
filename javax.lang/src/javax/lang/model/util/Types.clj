...
(defn assignable?
  ...
  (^Boolean [^Types this ^javax.lang.model.type.TypeMirror t-1 ^javax.lang.model.type.TypeMirror t-2]
...
(defn erasure
  ...
  (^javax.lang.model.type.TypeMirror [^Types this ^javax.lang.model.type.TypeMirror t]
    (-> this (.erasure t))))
...
(defn get-declared-type
  ...
  (^javax.lang.model.type.DeclaredType [^Types this ^javax.lang.model.type.DeclaredType containing ^javax.lang.model.element.TypeElement type-elem ^javax.lang.model.type.TypeMirror type-args]
    (-> this (.getDeclaredType containing type-elem type-args)))
  (^javax.lang.model.type.DeclaredType [^Types this ^javax.lang.model.element.TypeElement type-elem ^javax.lang.model.type.TypeMirror type-args]
...
(defn get-array-type
  ...
  (^javax.lang.model.type.ArrayType [^Types this ^javax.lang.model.type.TypeMirror component-type]
...
(defn get-wildcard-type
  ...
  (^javax.lang.model.type.WildcardType [^Types this ^javax.lang.model.type.TypeMirror extends-bound ^javax.lang.model.type.TypeMirror super-bound]
...
(defn boxed-class
  ...
  (^javax.lang.model.element.TypeElement [^Types this ^javax.lang.model.type.PrimitiveType p]
    (-> this (.boxedClass p))))
...
(defn unboxed-type
  ...
  (^javax.lang.model.type.PrimitiveType [^Types this ^javax.lang.model.type.TypeMirror t]
    (-> this (.unboxedType t))))
...
(defn as-member-of
  ...
  (^javax.lang.model.type.TypeMirror [^Types this ^javax.lang.model.type.DeclaredType containing ^javax.lang.model.element.Element element]
...
(defn get-null-type
  ...
  (^javax.lang.model.type.NullType [^Types this]
    (-> this (.getNullType))))
...
(defn get-primitive-type
  ...
  (^javax.lang.model.type.PrimitiveType [^Types this ^javax.lang.model.type.TypeKind kind]
...
(defn subsignature?
  ...
  (^Boolean [^Types this ^javax.lang.model.type.ExecutableType m-1 ^javax.lang.model.type.ExecutableType m-2]
...
(defn as-element
  ...
  (^javax.lang.model.element.Element [^Types this ^javax.lang.model.type.TypeMirror t]
    (-> this (.asElement t))))
...
(defn direct-supertypes
  ...
  throws: java.lang.IllegalArgumentException - if given an executable or package type"
  ([^Types this ^javax.lang.model.type.TypeMirror t]
...
(defn get-no-type
  ...
  (^javax.lang.model.type.NoType [^Types this ^javax.lang.model.type.TypeKind kind]
    (-> this (.getNoType kind))))
