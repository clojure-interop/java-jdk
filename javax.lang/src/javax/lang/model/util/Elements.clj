...
(defn get-package-of
  ...
  ([^. this ^javax.lang.model.element.Element type]
...
(defn overrides
  ...
  returns: true if and only if the first method overrides
            the second - `boolean`"
  ([^. this ^javax.lang.model.element.ExecutableElement overrider ^javax.lang.model.element.ExecutableElement overridden ^javax.lang.model.element.TypeElement type]
...
(defn get-all-annotation-mirrors
  ...
  ([^. this ^javax.lang.model.element.Element e]
...
(defn functional-interface?
  ...
  ([^. this ^javax.lang.model.element.TypeElement type]
...
(defn get-element-values-with-defaults
  ...
  ([^. this ^javax.lang.model.element.AnnotationMirror a]
...
(defn get-type-element
  ...
  ([^. this ^java.lang.CharSequence name]
...
(defn hides
  ...
  returns: true if and only if the first element hides
            the second - `boolean`"
  ([^. this ^javax.lang.model.element.Element hider ^javax.lang.model.element.Element hidden]
...
(defn print-elements
  ...
  ([^. this ^java.io.Writer w ^javax.lang.model.element.Element elements]
