...
(defn write-lock
  ...
  (^java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock [^ReentrantReadWriteLock this]
    (-> this (.writeLock))))
...
(defn fair?
  ...
  (^Boolean [^ReentrantReadWriteLock this]
    (-> this (.isFair))))
...
(defn get-queue-length
  ...
  (^Integer [^ReentrantReadWriteLock this]
    (-> this (.getQueueLength))))
...
(defn has-waiters?
  ...
  (^Boolean [^ReentrantReadWriteLock this ^java.util.concurrent.locks.Condition condition]
...
(defn to-string
  ...
  (^java.lang.String [^ReentrantReadWriteLock this]
    (-> this (.toString))))
...
(defn has-queued-thread?
  ...
  (^Boolean [^ReentrantReadWriteLock this ^java.lang.Thread thread]
...
(defn get-wait-queue-length
  ...
  throws: java.lang.IllegalMonitorStateException - if this lock is not held"
  (^Integer [^ReentrantReadWriteLock this ^java.util.concurrent.locks.Condition condition]
...
(defn read-lock
  ...
  (^java.util.concurrent.locks.ReentrantReadWriteLock$ReadLock [^ReentrantReadWriteLock this]
    (-> this (.readLock))))
