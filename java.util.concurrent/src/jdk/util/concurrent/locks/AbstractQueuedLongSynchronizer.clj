...
(defn queued?
  ...
  ([^java.util.concurrent.locks.AbstractQueuedLongSynchronizer this ^java.lang.Thread thread]
...
(defn get-queue-length
  ...
  ([^java.util.concurrent.locks.AbstractQueuedLongSynchronizer this]
    (-> this (.getQueueLength))))
...
(defn has-waiters?
  ...
  ([^java.util.concurrent.locks.AbstractQueuedLongSynchronizer this ^java.util.concurrent.locks.AbstractQueuedLongSynchronizer.ConditionObject condition]
...
(defn try-acquire-nanos
  ...
  throws: java.lang.InterruptedException - if the current thread is interrupted"
  ([^java.util.concurrent.locks.AbstractQueuedLongSynchronizer this ^Long arg ^Long nanos-timeout]
