...
(defn add-all
  ...
  throws: java.lang.NullPointerException - if the specified collection is null"
  (^Boolean [^CopyOnWriteArraySet this ^java.util.Collection c]
    (-> this (.addAll c))))
...
(defn spliterator
  ...
  (^java.util.Spliterator [^CopyOnWriteArraySet this]
    (-> this (.spliterator))))
...
(defn for-each
  ...
  ([^CopyOnWriteArraySet this ^java.util.function.Consumer action]
    (-> this (.forEach action))))
...
(defn remove-if
  ...
  (^Boolean [^CopyOnWriteArraySet this ^java.util.function.Predicate filter]
...
(defn contains
  ...
  (^Boolean [^CopyOnWriteArraySet this ^java.lang.Object o]
    (-> this (.contains o))))
...
(defn iterator
  ...
  (^java.util.Iterator [^CopyOnWriteArraySet this]
    (-> this (.iterator))))
...
(defn add
  ...
  returns: true if this set did not already contain the specified
           element - `boolean`"
  (^Boolean [^CopyOnWriteArraySet this e]
    (-> this (.add e))))
...
(defn empty?
  ...
  (^Boolean [^CopyOnWriteArraySet this]
    (-> this (.isEmpty))))
...
(defn size
  ...
  (^Integer [^CopyOnWriteArraySet this]
    (-> this (.size))))
