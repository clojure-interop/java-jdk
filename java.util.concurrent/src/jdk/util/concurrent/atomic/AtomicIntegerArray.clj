...
(defn ->atomic-integer-array
  ...
  (^AtomicIntegerArray [^Integer length]
...
(defn get-and-add
  ...
  (^Integer [^AtomicIntegerArray this ^Integer i ^Integer delta]
...
(defn get-and-set
  ...
  returns: the previous value - `int`"
  (^Integer [^AtomicIntegerArray this ^Integer i ^Integer new-value]
...
(defn update-and-get
  ...
  (^Integer [^AtomicIntegerArray this ^Integer i ^java.util.function.IntUnaryOperator update-function]
...
(defn to-string
  ...
  (^java.lang.String [^AtomicIntegerArray this]
    (-> this (.toString))))
...
(defn accumulate-and-get
  ...
  returns: the updated value - `int`"
  (^Integer [^AtomicIntegerArray this ^Integer i ^Integer x ^java.util.function.IntBinaryOperator accumulator-function]
...
(defn get-and-decrement
  ...
  returns: the previous value - `int`"
  (^Integer [^AtomicIntegerArray this ^Integer i]
...
(defn length
  ...
  (^Integer [^AtomicIntegerArray this]
    (-> this (.length))))
...
(defn weak-compare-and-set
  ...
  (^Boolean [^AtomicIntegerArray this ^Integer i ^Integer expect ^Integer update]
...
(defn lazy-set
  ...
  i - the index - `int`
  new-value - the new value - `int`"
  ([^AtomicIntegerArray this ^Integer i ^Integer new-value]
