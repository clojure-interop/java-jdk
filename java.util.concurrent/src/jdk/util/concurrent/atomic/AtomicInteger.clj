...
(defn get-and-add
  ...
  (^Integer [^java.util.concurrent.atomic.AtomicInteger this ^Integer delta]
...
(defn get-and-set
  ...
  returns: the previous value - `int`"
  (^Integer [^java.util.concurrent.atomic.AtomicInteger this ^Integer new-value]
...
(defn update-and-get
  ...
  (^Integer [^java.util.concurrent.atomic.AtomicInteger this ^java.util.function.IntUnaryOperator update-function]
...
(defn double-value
  ...
  (^Double [^java.util.concurrent.atomic.AtomicInteger this]
    (-> this (.doubleValue))))
...
(defn long-value
  ...
  returns: the numeric value represented by this object after conversion
            to type long. - `long`"
  (^Long [^java.util.concurrent.atomic.AtomicInteger this]
    (-> this (.longValue))))
...
(defn to-string
  ...
  (^java.lang.String [^java.util.concurrent.atomic.AtomicInteger this]
    (-> this (.toString))))
...
(defn float-value
  ...
  returns: the numeric value represented by this object after conversion
            to type float. - `float`"
  (^Float [^java.util.concurrent.atomic.AtomicInteger this]
    (-> this (.floatValue))))
...
(defn accumulate-and-get
  ...
  returns: the updated value - `int`"
  (^Integer [^java.util.concurrent.atomic.AtomicInteger this ^Integer x ^java.util.function.IntBinaryOperator accumulator-function]
...
(defn get-and-decrement
  ...
  returns: the previous value - `int`"
  (^Integer [^java.util.concurrent.atomic.AtomicInteger this]
...
(defn weak-compare-and-set
  ...
  (^Boolean [^java.util.concurrent.atomic.AtomicInteger this ^Integer expect ^Integer update]
