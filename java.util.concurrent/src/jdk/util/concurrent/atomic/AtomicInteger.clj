...
(defn ->atomic-integer
  ...
  (^AtomicInteger [^Integer initial-value]
...
(defn get-and-add
  ...
  (^Integer [^AtomicInteger this ^Integer delta]
...
(defn get-and-set
  ...
  returns: the previous value - `int`"
  (^Integer [^AtomicInteger this ^Integer new-value]
...
(defn update-and-get
  ...
  (^Integer [^AtomicInteger this ^java.util.function.IntUnaryOperator update-function]
...
(defn to-string
  ...
  (^java.lang.String [^AtomicInteger this]
    (-> this (.toString))))
...
(defn accumulate-and-get
  ...
  returns: the updated value - `int`"
  (^Integer [^AtomicInteger this ^Integer x ^java.util.function.IntBinaryOperator accumulator-function]
...
(defn weak-compare-and-set
  ...
  (^Boolean [^AtomicInteger this ^Integer expect ^Integer update]
...
(defn lazy-set
  ...
  new-value - the new value - `int`"
  ([^AtomicInteger this ^Integer new-value]
