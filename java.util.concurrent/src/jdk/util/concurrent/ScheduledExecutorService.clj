...
(defn schedule
  ...
  (^java.util.concurrent.ScheduledFuture [^ScheduledExecutorService this ^java.lang.Runnable command ^Long delay ^java.util.concurrent.TimeUnit unit]
...
(defn schedule-at-fixed-rate
  ...
  throws: java.util.concurrent.RejectedExecutionException - if the task cannot be scheduled for execution"
  (^java.util.concurrent.ScheduledFuture [^ScheduledExecutorService this ^java.lang.Runnable command ^Long initial-delay ^Long period ^java.util.concurrent.TimeUnit unit]
...
(defn schedule-with-fixed-delay
  ...
  throws: java.util.concurrent.RejectedExecutionException - if the task cannot be scheduled for execution"
  (^java.util.concurrent.ScheduledFuture [^ScheduledExecutorService this ^java.lang.Runnable command ^Long initial-delay ^Long delay ^java.util.concurrent.TimeUnit unit]
