...
(defn provider
  ...
  ([^java.nio.channels.SelectableChannel this]
    (-> this (.provider))))
...
(defn key-for
  ...
  ([^java.nio.channels.SelectableChannel this ^java.nio.channels.Selector sel]
    (-> this (.keyFor sel))))
...
(defn register
  ...
  ([^java.nio.channels.SelectableChannel this ^java.nio.channels.Selector sel ^Integer ops ^java.lang.Object att]
    (-> this (.register sel ops att)))
  ([^java.nio.channels.SelectableChannel this ^java.nio.channels.Selector sel ^Integer ops]
...
(defn configure-blocking
  ...
  throws: java.nio.channels.ClosedChannelException - If this channel is closed"
  ([^java.nio.channels.SelectableChannel this ^Boolean block]
