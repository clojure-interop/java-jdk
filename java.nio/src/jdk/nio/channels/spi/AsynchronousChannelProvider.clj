...
(defn open-asynchronous-channel-group
  ...
  (^java.nio.channels.AsynchronousChannelGroup [^AsynchronousChannelProvider this ^Integer n-threads ^java.util.concurrent.ThreadFactory thread-factory]
...
(defn open-asynchronous-server-socket-channel
  ...
  (^java.nio.channels.AsynchronousServerSocketChannel [^AsynchronousChannelProvider this ^java.nio.channels.AsynchronousChannelGroup group]
...
(defn open-asynchronous-socket-channel
  ...
  throws: java.nio.channels.IllegalChannelGroupException - If the provider that created the group differs from this provider"
  (^java.nio.channels.AsynchronousSocketChannel [^AsynchronousChannelProvider this ^java.nio.channels.AsynchronousChannelGroup group]
