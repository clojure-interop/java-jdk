...
(defn provider
  ...
  (^java.nio.channels.spi.SelectorProvider [^AbstractSelectableChannel this]
    (-> this (.provider))))
...
(defn registered?
  ...
  (^Boolean [^AbstractSelectableChannel this]
    (-> this (.isRegistered))))
...
(defn key-for
  ...
  (^java.nio.channels.SelectionKey [^AbstractSelectableChannel this ^java.nio.channels.Selector sel]
    (-> this (.keyFor sel))))
...
(defn register
  ...
  (^java.nio.channels.SelectionKey [^AbstractSelectableChannel this ^java.nio.channels.Selector sel ^Integer ops ^java.lang.Object att]
...
(defn blocking-lock
  ...
  (^java.lang.Object [^AbstractSelectableChannel this]
    (-> this (.blockingLock))))
...
(defn configure-blocking
  ...
  (^java.nio.channels.SelectableChannel [^AbstractSelectableChannel this ^Boolean block]
