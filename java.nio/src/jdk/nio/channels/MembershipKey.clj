...
(defn valid?
  ...
  returns: true if this membership key is valid, false
            otherwise - `boolean`"
  (^Boolean [^java.nio.channels.MembershipKey this]
    (-> this (.isValid))))
...
(defn block
  ...
  (^java.nio.channels.MembershipKey [^java.nio.channels.MembershipKey this ^java.net.InetAddress source]
    (-> this (.block source))))
...
(defn channel
  ...
  (^java.nio.s.MulticastChannel [^java.nio.channels.MembershipKey this]
    (-> this (.channel))))
...
(defn group
  ...
  (^java.net.InetAddress [^java.nio.channels.MembershipKey this]
    (-> this (.group))))
...
(defn network-interface
  ...
  (^java.net.NetworkInterface [^java.nio.channels.MembershipKey this]
