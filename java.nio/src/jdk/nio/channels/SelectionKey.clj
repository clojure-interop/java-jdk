...
(defn interest-ops
  ...
  (^java.nio.channels.SelectionKey [^SelectionKey this ^Integer ops]
...
(defn attachment
  ...
  (^java.lang.Object [^SelectionKey this]
    (-> this (.attachment))))
...
(defn attach
  ...
  (^java.lang.Object [^SelectionKey this ^java.lang.Object ob]
    (-> this (.attach ob))))
...
(defn selector
  ...
  (^java.nio.channels.Selector [^SelectionKey this]
    (-> this (.selector))))
