...
(defn join
  ...
  (^java.nio.channels.MembershipKey [^java.nio.channels.MulticastChannel this ^java.net.InetAddress group ^java.net.NetworkInterface interf ^java.net.InetAddress source]
    (-> this (.join group interf source)))
  (^java.nio.channels.MembershipKey [^java.nio.channels.MulticastChannel this ^java.net.InetAddress group ^java.net.NetworkInterface interf]
