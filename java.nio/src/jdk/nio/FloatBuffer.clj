...
(defn *wrap
  ...
  (^java.nio.FloatBuffer [array ^Integer offset ^Integer length]
...
(defn compact
  ...
  (^java.nio.FloatBuffer [^FloatBuffer this]
    (-> this (.compact))))
...
(defn put
  ...
  (^java.nio.FloatBuffer [^FloatBuffer this src ^Integer offset ^Integer length]
    (-> this (.put src offset length)))
  (^java.nio.FloatBuffer [^FloatBuffer this ^Integer index ^Float f]
    (-> this (.put index f)))
  (^java.nio.FloatBuffer [^FloatBuffer this ^Float f]
    (-> this (.put f))))
...
(defn to-string
  ...
  (^java.lang.String [^FloatBuffer this]
    (-> this (.toString))))
...
(defn order
  ...
  (^java.nio.ByteOrder [^FloatBuffer this]
    (-> this (.order))))
...
(defn compare-to
  ...
  (^Integer [^FloatBuffer this ^java.nio.FloatBuffer that]
    (-> this (.compareTo that))))
...
(defn get
  ...
  (^java.nio.FloatBuffer [^FloatBuffer this dst ^Integer offset ^Integer length]
    (-> this (.get dst offset length)))
  (^Float [^FloatBuffer this ^Integer index]
    (-> this (.get index)))
...
(defn equals
  ...
  (^Boolean [^FloatBuffer this ^java.lang.Object ob]
    (-> this (.equals ob))))
