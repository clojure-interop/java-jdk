...
(defn owner
  ...
  (^java.nio.file.attribute.UserPrincipal [^PosixFileAttributes this]
    (-> this (.owner))))
...
(defn group
  ...
  (^java.nio.file.attribute.GroupPrincipal [^PosixFileAttributes this]
    (-> this (.group))))
...
(defn permissions
  ...
  (^java.util.Set [^PosixFileAttributes this]
    (-> this (.permissions))))
