...
(defn owner
  ...
  (^java.nio.file.attribute.UserPrincipal [^java.nio.file.attribute.PosixFileAttributes this]
    (-> this (.owner))))
...
(defn group
  ...
  (^java.nio.file.attribute.GroupPrincipal [^java.nio.file.attribute.PosixFileAttributes this]
    (-> this (.group))))
...
(defn permissions
  ...
  (^java.util.Set [^java.nio.file.attribute.PosixFileAttributes this]
    (-> this (.permissions))))
