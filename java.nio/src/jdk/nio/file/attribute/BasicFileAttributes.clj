...
(defn file-key
  ...
  (^java.lang.Object [^java.nio.file.attribute.BasicFileAttributes this]
    (-> this (.fileKey))))
...
(defn last-modified-time
  ...
  (^java.nio.file.attribute.FileTime [^java.nio.file.attribute.BasicFileAttributes this]
...
(defn symbolic-link?
  ...
  (^Boolean [^java.nio.file.attribute.BasicFileAttributes this]
    (-> this (.isSymbolicLink))))
...
(defn size
  ...
  (^Long [^java.nio.file.attribute.BasicFileAttributes this]
    (-> this (.size))))
