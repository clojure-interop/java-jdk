...
(defn file-key
  ...
  (^java.lang.Object [^BasicFileAttributes this]
    (-> this (.fileKey))))
...
(defn last-modified-time
  ...
  (^java.nio.file.attribute.FileTime [^BasicFileAttributes this]
...
(defn symbolic-link?
  ...
  (^Boolean [^BasicFileAttributes this]
    (-> this (.isSymbolicLink))))
