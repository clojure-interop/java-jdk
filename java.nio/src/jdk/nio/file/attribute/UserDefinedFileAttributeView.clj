...
(defn name
  ...
  (^java.lang.String [^java.nio.file.attribute.UserDefinedFileAttributeView this]
    (-> this (.name))))
...
(defn list
  ...
  (^java.util.List [^java.nio.file.attribute.UserDefinedFileAttributeView this]
    (-> this (.list))))
...
(defn size
  ...
  (^Integer [^java.nio.file.attribute.UserDefinedFileAttributeView this ^java.lang.String name]
    (-> this (.size name))))
...
(defn read
  ...
  (^Integer [^java.nio.file.attribute.UserDefinedFileAttributeView this ^java.lang.String name ^java.nio.ByteBuffer dst]
    (-> this (.read name dst))))
...
(defn write
  ...
  throws: java.io.IOException - If an I/O error occurs"
  (^Integer [^java.nio.file.attribute.UserDefinedFileAttributeView this ^java.lang.String name ^java.nio.ByteBuffer src]
    (-> this (.write name src))))
