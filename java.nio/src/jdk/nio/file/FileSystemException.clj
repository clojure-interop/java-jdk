...
(defn ->file-system-exception
  ...
  (^FileSystemException [^java.lang.String file ^java.lang.String other ^java.lang.String reason]
    (new FileSystemException file other reason))
  (^FileSystemException [^java.lang.String file]
...
(defn get-file
  ...
  (^java.lang.String [^FileSystemException this]
    (-> this (.getFile))))
