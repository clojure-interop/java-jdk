...
(defn resolve-sibling
  ...
  ([^java.nio.file.Path this ^java.nio.file.Path other]
...
(defn to-real-path
  ...
  ([^java.nio.file.Path this ^java.nio.file.LinkOption options]
...
(defn get-name
  ...
  ([^java.nio.file.Path this ^Integer index]
    (-> this (.getName index))))
...
(defn subpath
  ...
  ([^java.nio.file.Path this ^Integer begin-index ^Integer end-index]
...
(defn register
  ...
  ([^java.nio.file.Path this ^java.nio.file.WatchService watcher ^java.nio.file.WatchEvent.Kind[] events ^java.nio.file.WatchEvent.Modifier modifiers]
    (-> this (.register watcher events modifiers)))
  ([^java.nio.file.Path this ^java.nio.file.WatchService watcher ^java.nio.file.WatchEvent.Kind events]
...
(defn equals
  ...
  ([^java.nio.file.Path this ^java.lang.Object other]
    (-> this (.equals other))))
