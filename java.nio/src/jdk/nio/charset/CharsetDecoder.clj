...
(defn on-unmappable-character
  ...
  (^java.nio.charset.CharsetDecoder [^CharsetDecoder this ^java.nio.charset.CodingErrorAction new-action]
...
(defn unmappable-character-action
  ...
  (^java.nio.charset.CodingErrorAction [^CharsetDecoder this]
...
(defn replacement
  ...
  (^java.lang.String [^CharsetDecoder this]
    (-> this (.replacement))))
...
(defn decode
  ...
  (^java.nio.charset.CoderResult [^CharsetDecoder this ^java.nio.ByteBuffer in ^java.nio.CharBuffer out ^Boolean end-of-input]
    (-> this (.decode in out end-of-input)))
  (^java.nio.CharBuffer [^CharsetDecoder this ^java.nio.ByteBuffer in]
    (-> this (.decode in))))
...
(defn replace-with
  ...
  (^java.nio.charset.CharsetDecoder [^CharsetDecoder this ^java.lang.String new-replacement]
...
(defn flush
  ...
  (^java.nio.charset.CoderResult [^CharsetDecoder this ^java.nio.CharBuffer out]
    (-> this (.flush out))))
...
(defn reset
  ...
  returns: This decoder - `java.nio.charset.CharsetDecoder`"
  (^java.nio.charset.CharsetDecoder [^CharsetDecoder this]
    (-> this (.reset))))
