...
(defn on-unmappable-character
  ...
  (^java.nio.charset.CharsetEncoder [^java.nio.charset.CharsetEncoder this ^java.nio.charset.CodingErrorAction new-action]
...
(defn legal-replacement?
  ...
  (^Boolean [^java.nio.charset.CharsetEncoder this repl]
...
(defn unmappable-character-action
  ...
  (^java.nio.charset.CodingErrorAction [^java.nio.charset.CharsetEncoder this]
...
(defn can-encode?
  ...
  (^Boolean [^java.nio.charset.CharsetEncoder this ^Character c]
    (-> this (.canEncode c))))
...
(defn average-bytes-per-char
  ...
  (^Float [^java.nio.charset.CharsetEncoder this]
...
(defn replace-with
  ...
  (^java.nio.charset.CharsetEncoder [^java.nio.charset.CharsetEncoder this new-replacement]
...
(defn flush
  ...
  (^java.nio.charset.CoderResult [^java.nio.charset.CharsetEncoder this ^java.nio.ByteBuffer out]
    (-> this (.flush out))))
...
(defn reset
  ...
  returns: This encoder - `java.nio.charset.CharsetEncoder`"
  (^java.nio.charset.CharsetEncoder [^java.nio.charset.CharsetEncoder this]
    (-> this (.reset))))
...
(defn encode
  ...
  (^java.nio.charset.CoderResult [^java.nio.charset.CharsetEncoder this ^java.nio.CharBuffer in ^java.nio.ByteBuffer out ^Boolean end-of-input]
    (-> this (.encode in out end-of-input)))
  (^java.nio.ByteBuffer [^java.nio.charset.CharsetEncoder this ^java.nio.CharBuffer in]
    (-> this (.encode in))))
...
(defn charset
  ...
  (^java.nio..Charset [^java.nio.charset.CharsetEncoder this]
    (-> this (.charset))))
