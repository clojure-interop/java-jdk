...
(defn on-unmappable-character
  ...
  (^java.nio.charset.CharsetEncoder [^CharsetEncoder this ^java.nio.charset.CodingErrorAction new-action]
...
(defn legal-replacement?
  ...
  (^Boolean [^CharsetEncoder this repl]
...
(defn unmappable-character-action
  ...
  (^java.nio.charset.CodingErrorAction [^CharsetEncoder this]
...
(defn can-encode?
  ...
  (^Boolean [^CharsetEncoder this ^Character c]
    (-> this (.canEncode c))))
...
(defn replace-with
  ...
  (^java.nio.charset.CharsetEncoder [^CharsetEncoder this new-replacement]
...
(defn flush
  ...
  (^java.nio.charset.CoderResult [^CharsetEncoder this ^java.nio.ByteBuffer out]
    (-> this (.flush out))))
...
(defn reset
  ...
  returns: This encoder - `java.nio.charset.CharsetEncoder`"
  (^java.nio.charset.CharsetEncoder [^CharsetEncoder this]
    (-> this (.reset))))
...
(defn encode
  ...
  (^java.nio.charset.CoderResult [^CharsetEncoder this ^java.nio.CharBuffer in ^java.nio.ByteBuffer out ^Boolean end-of-input]
    (-> this (.encode in out end-of-input)))
  (^java.nio.ByteBuffer [^CharsetEncoder this ^java.nio.CharBuffer in]
    (-> this (.encode in))))
