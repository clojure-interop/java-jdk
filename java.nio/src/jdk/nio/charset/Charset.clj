...
(defn display-name
  ...
  (^java.lang.String [^Charset this ^java.util.Locale locale]
...
(defn decode
  ...
  (^java.nio.CharBuffer [^Charset this ^java.nio.ByteBuffer bb]
    (-> this (.decode bb))))
...
(defn contains
  ...
  (^Boolean [^Charset this ^java.nio.charset.Charset cs]
    (-> this (.contains cs))))
...
(defn new-decoder
  ...
  (^java.nio.charset.CharsetDecoder [^Charset this]
    (-> this (.newDecoder))))
...
(defn compare-to
  ...
  (^Integer [^Charset this ^java.nio.charset.Charset that]
    (-> this (.compareTo that))))
...
(defn new-encoder
  ...
  (^java.nio.charset.CharsetEncoder [^Charset this]
    (-> this (.newEncoder))))
...
(defn encode
  ...
  (^java.nio.ByteBuffer [^Charset this ^java.nio.CharBuffer cb]
    (-> this (.encode cb))))
...
(defn equals
  ...
  (^Boolean [^Charset this ^java.lang.Object ob]
    (-> this (.equals ob))))
