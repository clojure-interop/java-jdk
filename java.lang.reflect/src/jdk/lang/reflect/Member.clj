...
(defn get-declaring-class
  ...
  (^java.lang.Class [^java.lang.reflect.Member this]
...
(defn get-name
  ...
  (^java.lang.String [^java.lang.reflect.Member this]
    (-> this (.getName))))
...
(defn get-modifiers
  ...
  (^Integer [^java.lang.reflect.Member this]
    (-> this (.getModifiers))))
...
(defn synthetic?
  ...
  (^Boolean [^java.lang.reflect.Member this]
    (-> this (.isSynthetic))))
