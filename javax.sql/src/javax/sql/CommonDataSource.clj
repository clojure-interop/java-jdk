...
(defn get-log-writer
  ...
  (^java.io.PrintWriter [^CommonDataSource this]
    (-> this (.getLogWriter))))
...
(defn set-log-writer
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^CommonDataSource this ^java.io.PrintWriter out]
...
(defn set-login-timeout
  ...
  throws: java.sql.SQLException - if a database access error occurs."
  ([^CommonDataSource this ^Integer seconds]
...
(defn get-parent-logger
  ...
  (^java.util.logging.Logger [^CommonDataSource this]
