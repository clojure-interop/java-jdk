...
(defn set-precision
  ...
  ([^RowSetMetaData this ^Integer column-index ^Integer precision]
...
(defn set-column-type-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String type-name]
...
(defn set-case-sensitive
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^Boolean property]
...
(defn set-column-label
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String label]
...
(defn set-schema-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String schema-name]
...
(defn set-nullable
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^Integer property]
...
(defn set-catalog-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String catalog-name]
...
(defn set-table-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String table-name]
...
(defn set-column-display-size
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^Integer size]
...
(defn set-column-count
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-count]
...
(defn set-column-type
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^Integer sql-type]
...
(defn set-scale
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^Integer scale]
...
(defn set-column-name
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^RowSetMetaData this ^Integer column-index ^java.lang.String column-name]
