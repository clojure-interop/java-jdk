...
(defn set-bytes
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index x]
...
(defn set-string
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.lang.String x]
...
(defn remove-row-set-listener
  ...
  ([^javax.sql.RowSet this ^javax.sql.RowSetListener listener]
...
(defn set-array
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer i ^java.sql.Array x]
    (-> this (.setArray i x))))
...
(defn set-type-map
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^java.util.Map> map]
    (-> this (.setTypeMap map))))
...
(defn set-read-only
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Boolean value]
...
(defn set-time
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Time x ^java.util.Calendar cal]
    (-> this (.setTime parameter-index x cal)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Time x]
...
(defn set-timestamp
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Timestamp x ^java.util.Calendar cal]
    (-> this (.setTimestamp parameter-index x cal)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Timestamp x]
...
(defn set-date
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Date x ^java.util.Calendar cal]
    (-> this (.setDate parameter-index x cal)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.Date x]
...
(defn set-boolean
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Boolean x]
...
(defn set-command
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^java.lang.String cmd]
    (-> this (.setCommand cmd))))
...
(defn set-n-character-stream
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.Reader value ^Long length]
    (-> this (.setNCharacterStream parameter-index value length)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.Reader value]
...
(defn set-null
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer param-index ^Integer sql-type ^java.lang.String type-name]
    (-> this (.setNull param-index sql-type type-name)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^Integer sql-type]
...
(defn set-query-timeout
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer seconds]
...
(defn set-password
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^java.lang.String password]
...
(defn set-binary-stream
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.InputStream x ^Integer length]
    (-> this (.setBinaryStream parameter-index x length)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.InputStream x]
...
(defn set-type
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer type]
    (-> this (.setType type))))
...
(defn set-blob
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.InputStream input-stream ^Long length]
    (-> this (.setBlob parameter-index input-stream length)))
  ([^javax.sql.RowSet this ^Integer i ^java.sql.Blob x]
    (-> this (.setBlob i x))))
...
(defn set-url
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^java.lang.String url]
    (-> this (.setUrl url))))
...
(defn set-object
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.lang.Object x ^Integer target-sql-type ^Integer scale-or-length]
    (-> this (.setObject parameter-index x target-sql-type scale-or-length)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.lang.Object x ^Integer target-sql-type]
    (-> this (.setObject parameter-index x target-sql-type)))
  ([^javax.sql.RowSet this ^java.lang.String parameter-name ^java.lang.Object x]
...
(defn set-escape-processing
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Boolean enable]
...
(defn set-max-rows
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer max]
    (-> this (.setMaxRows max))))
...
(defn set-n-clob
  ...
  ([^javax.sql.RowSet this ^java.lang.String parameter-name ^java.io.Reader reader ^Long length]
    (-> this (.setNClob parameter-name reader length)))
  ([^javax.sql.RowSet this ^java.lang.String parameter-name ^java.sql.NClob value]
...
(defn set-clob
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.Reader reader ^Long length]
    (-> this (.setClob parameter-index reader length)))
  ([^javax.sql.RowSet this ^Integer i ^java.sql.Clob x]
    (-> this (.setClob i x))))
...
(defn set-transaction-isolation
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer level]
...
(defn set-double
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Double x]
...
(defn set-ref
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer i ^java.sql.Ref x]
    (-> this (.setRef i x))))
...
(defn set-long
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Long x]
...
(defn set-username
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^java.lang.String name]
...
(defn set-byte
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Byte x]
...
(defn set-n-string
  ...
  throws: java.sql.SQLException - if the driver does not support national character sets; if the driver can detect that a data conversion error could occur ; or if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.lang.String value]
...
(defn set-short
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Short x]
...
(defn set-concurrency
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer concurrency]
...
(defn set-big-decimal
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.math.BigDecimal x]
...
(defn set-int
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Integer x]
...
(defn set-character-stream
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.Reader reader ^Integer length]
    (-> this (.setCharacterStream parameter-index reader length)))
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.io.Reader reader]
...
(defn set-url
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.net.URL x]
...
(defn set-sqlxml
  ...
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.SQLXML xml-object]
...
(defn set-float
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^Float x]
...
(defn set-row-id
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^javax.sql.RowSet this ^Integer parameter-index ^java.sql.RowId x]
