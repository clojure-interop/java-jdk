...
(defn ->statement-event
  ...
  (^StatementEvent [^javax.sql.PooledConnection con ^java.sql.PreparedStatement statement ^java.sql.SQLException exception]
    (new StatementEvent con statement exception))
  (^StatementEvent [^javax.sql.PooledConnection con ^java.sql.PreparedStatement statement]
...
(defn get-statement
  ...
  (^java.sql.PreparedStatement [^StatementEvent this]
    (-> this (.getStatement))))
...
(defn get-sql-exception
  ...
  (^java.sql.SQLException [^StatementEvent this]
