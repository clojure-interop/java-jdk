...
(defn get-connection
  ...
  (^java.sql.Connection [^PooledConnection this]
    (-> this (.getConnection))))
...
(defn add-connection-event-listener
  ...
  ([^PooledConnection this ^javax.sql.ConnectionEventListener listener]
...
(defn add-statement-event-listener
  ...
  ([^PooledConnection this ^javax.sql.StatementEventListener listener]
