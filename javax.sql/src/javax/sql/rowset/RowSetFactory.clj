...
(defn create-cached-row-set
  ...
  (^javax.sql.rowset.CachedRowSet [^javax.sql.rowset.RowSetFactory this]
...
(defn create-filtered-row-set
  ...
  (^javax.sql.rowset.FilteredRowSet [^javax.sql.rowset.RowSetFactory this]
...
(defn create-jdbc-row-set
  ...
  (^javax.sql.rowset.JdbcRowSet [^javax.sql.rowset.RowSetFactory this]
...
(defn create-join-row-set
  ...
  (^javax.sql.rowset.JoinRowSet [^javax.sql.rowset.RowSetFactory this]
...
(defn create-web-row-set
  ...
  (^javax.sql.rowset.WebRowSet [^javax.sql.rowset.RowSetFactory this]
