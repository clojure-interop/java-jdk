...
(defn ->serial-java-object
  ...
  (^SerialJavaObject [^java.lang.Object obj]
...
(defn get-object
  ...
  (^java.lang.Object [^SerialJavaObject this]
    (-> this (.getObject))))
...
(defn equals
  ...
  (^Boolean [^SerialJavaObject this ^java.lang.Object o]
    (-> this (.equals o))))
