...
(defn get-ascii-stream
  ...
  (^java.io.InputStream [^SerialClob this]
    (-> this (.getAsciiStream))))
...
(defn set-string
  ...
  (^Integer [^SerialClob this ^Long pos ^java.lang.String str ^Integer offset ^Integer length]
    (-> this (.setString pos str offset length)))
  (^Integer [^SerialClob this ^Long pos ^java.lang.String str]
...
(defn position
  ...
  (^Long [^SerialClob this ^java.lang.String search-str ^Long start]
...
(defn get-character-stream
  ...
  (^java.io.Reader [^SerialClob this ^Long pos ^Long length]
    (-> this (.getCharacterStream pos length)))
  (^java.io.Reader [^SerialClob this]
...
(defn get-sub-string
  ...
  (^java.lang.String [^SerialClob this ^Long pos ^Integer length]
...
(defn set-ascii-stream
  ...
  (^java.io.OutputStream [^SerialClob this ^Long pos]
...
(defn clone
  ...
  (^java.lang.Object [^SerialClob this]
    (-> this (.clone))))
...
(defn set-character-stream
  ...
  (^java.io.Writer [^SerialClob this ^Long pos]
...
(defn equals
  ...
  (^Boolean [^SerialClob this ^java.lang.Object obj]
    (-> this (.equals obj))))
