...
(defn ->sql-output-impl
  ...
  (^SQLOutputImpl [^java.util.Vector attributes ^java.util.Map map]
...
(defn write-date
  ...
  ([^SQLOutputImpl this ^java.sql.Date x]
    (-> this (.writeDate x))))
...
(defn write-time
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Time x]
    (-> this (.writeTime x))))
...
(defn write-url
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.net.URL url]
    (-> this (.writeURL url))))
...
(defn write-clob
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Clob x]
    (-> this (.writeClob x))))
...
(defn write-object
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.SQLData x]
    (-> this (.writeObject x))))
...
(defn write-binary-stream
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.io.InputStream x]
...
(defn write-blob
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Blob x]
    (-> this (.writeBlob x))))
...
(defn write-array
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Array x]
    (-> this (.writeArray x))))
...
(defn write-string
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.lang.String x]
    (-> this (.writeString x))))
...
(defn write-character-stream
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.io.Reader x]
...
(defn write-struct
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Struct x]
    (-> this (.writeStruct x))))
...
(defn write-n-clob
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^SQLOutputImpl this ^java.sql.NClob x]
    (-> this (.writeNClob x))))
...
(defn write-timestamp
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Timestamp x]
...
(defn write-sqlxml
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^SQLOutputImpl this ^java.sql.SQLXML x]
    (-> this (.writeSQLXML x))))
...
(defn write-big-decimal
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.math.BigDecimal x]
...
(defn write-ref
  ...
  throws: java.sql.SQLException - if the SQLOutputImpl object is in use by a SQLData object attempting to write the attribute values of a UDT to the database."
  ([^SQLOutputImpl this ^java.sql.Ref x]
    (-> this (.writeRef x))))
...
(defn write-row-id
  ...
  throws: java.sql.SQLException - if a database access error occurs"
  ([^SQLOutputImpl this ^java.sql.RowId x]
    (-> this (.writeRowId x))))
