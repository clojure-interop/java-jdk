...
(defn invoke
  ...
  (^java.lang.Object [^MBeanServerConnection this ^javax.management.ObjectName name ^java.lang.String operation-name params signature]
...
(defn query-m-beans
  ...
  (^java.util.Set [^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.QueryExp query]
...
(defn remove-notification-listener
  ...
  ([^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.ObjectName listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
    (-> this (.removeNotificationListener name listener filter handback)))
  ([^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.ObjectName listener]
...
(defn get-attribute
  ...
  (^java.lang.Object [^MBeanServerConnection this ^javax.management.ObjectName name ^java.lang.String attribute]
...
(defn get-m-bean-info
  ...
  (^javax.management.MBeanInfo [^MBeanServerConnection this ^javax.management.ObjectName name]
...
(defn create-m-bean
  ...
  (^javax.management.ObjectInstance [^MBeanServerConnection this ^java.lang.String class-name ^javax.management.ObjectName name ^javax.management.ObjectName loader-name params signature]
    (-> this (.createMBean class-name name loader-name params signature)))
  (^javax.management.ObjectInstance [^MBeanServerConnection this ^java.lang.String class-name ^javax.management.ObjectName name params signature]
    (-> this (.createMBean class-name name params signature)))
  (^javax.management.ObjectInstance [^MBeanServerConnection this ^java.lang.String class-name ^javax.management.ObjectName name ^javax.management.ObjectName loader-name]
    (-> this (.createMBean class-name name loader-name)))
  (^javax.management.ObjectInstance [^MBeanServerConnection this ^java.lang.String class-name ^javax.management.ObjectName name]
...
(defn get-m-bean-count
  ...
  throws: java.io.IOException - A communication problem occurred when talking to the MBean server."
  (^java.lang.Integer [^MBeanServerConnection this]
    (-> this (.getMBeanCount))))
...
(defn registered?
  ...
  (^Boolean [^MBeanServerConnection this ^javax.management.ObjectName name]
...
(defn unregister-m-bean
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  ([^MBeanServerConnection this ^javax.management.ObjectName name]
...
(defn get-default-domain
  ...
  throws: java.io.IOException - A communication problem occurred when talking to the MBean server."
  (^java.lang.String [^MBeanServerConnection this]
...
(defn set-attribute
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  ([^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.Attribute attribute]
...
(defn get-object-instance
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  (^javax.management.ObjectInstance [^MBeanServerConnection this ^javax.management.ObjectName name]
...
(defn set-attributes
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  (^javax.management.AttributeList [^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.AttributeList attributes]
...
(defn add-notification-listener
  ...
  throws: javax.management.InstanceNotFoundException - The MBean name provided does not match any of the registered MBeans."
  ([^MBeanServerConnection this ^javax.management.ObjectName name ^javax.management.NotificationListener listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
...
(defn get-attributes
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  (^javax.management.AttributeList [^MBeanServerConnection this ^javax.management.ObjectName name attributes]
...
(defn instance-of?
  ...
  throws: javax.management.InstanceNotFoundException - The MBean specified is not registered in the MBean server."
  (^Boolean [^MBeanServerConnection this ^javax.management.ObjectName name ^java.lang.String class-name]
