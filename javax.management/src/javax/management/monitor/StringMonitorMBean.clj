...
(defn get-derived-gauge-time-stamp
  ...
  (^Long [^StringMonitorMBean this ^javax.management.ObjectName object]
    (-> this (.getDerivedGaugeTimeStamp object)))
  (^Long [^StringMonitorMBean this]
...
(defn set-string-to-compare
  ...
  ([^StringMonitorMBean this ^java.lang.String value]
...
(defn get-notify-match?
  ...
  (^Boolean [^StringMonitorMBean this]
    (-> this (.getNotifyMatch))))
...
(defn set-notify-match
  ...
  ([^StringMonitorMBean this ^Boolean value]
