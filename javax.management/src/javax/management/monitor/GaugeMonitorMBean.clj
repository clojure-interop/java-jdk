...
(defn set-notify-high
  ...
  ([^GaugeMonitorMBean this ^Boolean value]
...
(defn get-derived-gauge-time-stamp
  ...
  (^Long [^GaugeMonitorMBean this ^javax.management.ObjectName object]
    (-> this (.getDerivedGaugeTimeStamp object)))
  (^Long [^GaugeMonitorMBean this]
...
(defn get-notify-low?
  ...
  (^Boolean [^GaugeMonitorMBean this]
    (-> this (.getNotifyLow))))
...
(defn set-thresholds
  ...
  ([^GaugeMonitorMBean this ^java.lang.Number high-value ^java.lang.Number low-value]
