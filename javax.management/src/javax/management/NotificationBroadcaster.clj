...
(defn add-notification-listener
  ...
  ([^NotificationBroadcaster this ^javax.management.NotificationListener listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
...
(defn remove-notification-listener
  ...
  ([^NotificationBroadcaster this ^javax.management.NotificationListener listener]
