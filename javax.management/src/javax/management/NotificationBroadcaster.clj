...
(defn add-notification-listener
  ...
  ([^javax.management.NotificationBroadcaster this ^javax.management.NotificationListener listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
...
(defn remove-notification-listener
  ...
  ([^javax.management.NotificationBroadcaster this ^javax.management.NotificationListener listener]
...
(defn get-notification-info
  ...
  ([^javax.management.NotificationBroadcaster this]
