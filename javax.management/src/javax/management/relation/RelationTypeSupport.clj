...
(defn ->relation-type-support
  ...
  (^RelationTypeSupport [^java.lang.String relation-type-name role-info-array]
...
(defn get-relation-type-name
  ...
  (^java.lang.String [^RelationTypeSupport this]
...
(defn get-role-infos
  ...
  (^java.util.List [^RelationTypeSupport this]
    (-> this (.getRoleInfos))))
...
(defn get-role-info
  ...
  throws: java.lang.IllegalArgumentException - if null parameter"
  (^javax.management.relation.RoleInfo [^RelationTypeSupport this ^java.lang.String role-info-name]
