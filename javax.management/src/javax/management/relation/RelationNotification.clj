...
(defn ->relation-notification
  ...
  new-value - new role value (List of ObjectName objects) - `java.util.List`
  ...
  (^RelationNotification [^java.lang.String notif-type ^java.lang.Object source-obj ^Long sequence ^Long time-stamp ^java.lang.String message ^java.lang.String id ^java.lang.String type-name ^javax.management.ObjectName object-name ^java.lang.String name ^java.util.List new-value ^java.util.List old-value]
  ...
  (^RelationNotification [^java.lang.String notif-type ^java.lang.Object source-obj ^Long sequence ^Long time-stamp ^java.lang.String message ^java.lang.String id ^java.lang.String type-name ^javax.management.ObjectName object-name ^java.util.List unreg-m-bean-list]
...
(defn get-relation-id
  ...
  (^java.lang.String [^RelationNotification this]
    (-> this (.getRelationId))))
...
(defn get-object-name
  ...
  (^javax.management.ObjectName [^RelationNotification this]
    (-> this (.getObjectName))))
...
(defn get-m-beans-to-unregister
  ...
  (^java.util.List [^RelationNotification this]
