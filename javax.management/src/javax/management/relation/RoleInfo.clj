...
(defn ->role-info
  ...
  (^RoleInfo [^java.lang.String role-name ^java.lang.String mbean-class-name ^Boolean read ^Boolean write ^Integer min ^Integer max ^java.lang.String descr]
    (new RoleInfo role-name mbean-class-name read write min max descr))
  (^RoleInfo [^java.lang.String role-name ^java.lang.String mbean-class-name ^Boolean read ^Boolean write]
    (new RoleInfo role-name mbean-class-name read write))
  (^RoleInfo [^java.lang.String role-name ^java.lang.String mbean-class-name]
    (new RoleInfo role-name mbean-class-name))
  (^RoleInfo [^javax.management.relation.RoleInfo role-info]
...
(defn get-ref-m-bean-class-name
  ...
  (^java.lang.String [^RoleInfo this]
...
(defn check-max-degree
  ...
  (^Boolean [^RoleInfo this ^Integer value]
