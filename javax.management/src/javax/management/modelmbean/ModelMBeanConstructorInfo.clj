...
(defn ->model-m-bean-constructor-info
  ...
  (^ModelMBeanConstructorInfo [^java.lang.String description ^java.lang.reflect.Constructor constructor-method]
...
(defn clone
  ...
  (^java.lang.Object [^ModelMBeanConstructorInfo this]
    (-> this (.clone))))
...
(defn get-descriptor
  ...
  (^javax.management.Descriptor [^ModelMBeanConstructorInfo this]
    (-> this (.getDescriptor))))
...
(defn to-string
  ...
  (^java.lang.String [^ModelMBeanConstructorInfo this]
    (-> this (.toString))))
