...
(defn ->required-model-m-bean
  ...
  (^RequiredModelMBean [^javax.management.modelmbean.ModelMBeanInfo mbi]
...
(defn invoke
  ...
  (^java.lang.Object [^RequiredModelMBean this ^java.lang.String op-name op-args sig]
...
(defn remove-notification-listener
  ...
  ([^RequiredModelMBean this ^javax.management.NotificationListener listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
    (-> this (.removeNotificationListener listener filter handback)))
  ([^RequiredModelMBean this ^javax.management.NotificationListener listener]
...
(defn get-attribute
  ...
  (^java.lang.Object [^RequiredModelMBean this ^java.lang.String attr-name]
...
(defn get-m-bean-info
  ...
  (^javax.management.MBeanInfo [^RequiredModelMBean this]
    (-> this (.getMBeanInfo))))
...
(defn add-attribute-change-notification-listener
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^RequiredModelMBean this ^javax.management.NotificationListener inlistener ^java.lang.String in-attribute-name ^java.lang.Object inhandback]
...
(defn remove-attribute-change-notification-listener
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^RequiredModelMBean this ^javax.management.NotificationListener inlistener ^java.lang.String in-attribute-name]
...
(defn post-register
  ...
  ([^RequiredModelMBean this ^java.lang.Boolean registration-done]
...
(defn set-attribute
  ...
  ([^RequiredModelMBean this ^javax.management.Attribute attribute]
...
(defn set-attributes
  ...
  (^javax.management.AttributeList [^RequiredModelMBean this ^javax.management.AttributeList attributes]
...
(defn set-model-m-bean-info
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^RequiredModelMBean this ^javax.management.modelmbean.ModelMBeanInfo mbi]
...
(defn send-notification
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^RequiredModelMBean this ^javax.management.Notification ntfy-obj]
...
(defn pre-register
  ...
  throws: java.lang.Exception - This exception will be caught by the MBean server and re-thrown as an MBeanRegistrationException."
  (^javax.management.ObjectName [^RequiredModelMBean this ^javax.management.MBeanServer server ^javax.management.ObjectName name]
...
(defn send-attribute-change-notification
  ...
  ([^RequiredModelMBean this ^javax.management.AttributeChangeNotification ntfy-obj]
...
(defn get-attributes
  ...
  throws: javax.management.RuntimeOperationsException - Wraps an IllegalArgumentException: The object name in parameter is null or attributes in parameter is null."
  (^javax.management.AttributeList [^RequiredModelMBean this attr-names]
