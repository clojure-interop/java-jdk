...
(defn send-notification
  ...
  ([^javax.management.modelmbean.ModelMBeanNotificationBroadcaster this ^javax.management.Notification ntfy-obj]
...
(defn send-attribute-change-notification
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^javax.management.modelmbean.ModelMBeanNotificationBroadcaster this ^javax.management.Attribute old-value ^javax.management.Attribute new-value]
    (-> this (.sendAttributeChangeNotification old-value new-value)))
  ([^javax.management.modelmbean.ModelMBeanNotificationBroadcaster this ^javax.management.AttributeChangeNotification notification]
...
(defn add-attribute-change-notification-listener
  ...
  ([^javax.management.modelmbean.ModelMBeanNotificationBroadcaster this ^javax.management.NotificationListener listener ^java.lang.String attribute-name ^java.lang.Object handback]
...
(defn remove-attribute-change-notification-listener
  ...
  ([^javax.management.modelmbean.ModelMBeanNotificationBroadcaster this ^javax.management.NotificationListener listener ^java.lang.String attribute-name]
