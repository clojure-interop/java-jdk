...
(defn ->model-m-bean-info-support
  ...
  (^ModelMBeanInfoSupport [^java.lang.String class-name ^java.lang.String description attributes constructors operations notifications]
    (new ModelMBeanInfoSupport class-name description attributes constructors operations notifications))
  (^ModelMBeanInfoSupport [^javax.management.modelmbean.ModelMBeanInfo mbi]
...
(defn get-m-bean-descriptor
  ...
  (^javax.management.Descriptor [^ModelMBeanInfoSupport this]
...
(defn set-m-bean-descriptor
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^ModelMBeanInfoSupport this ^javax.management.Descriptor in-m-bean-descriptor]
...
(defn get-descriptor
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  (^javax.management.Descriptor [^ModelMBeanInfoSupport this ^java.lang.String in-descriptor-name ^java.lang.String in-descriptor-type]
    (-> this (.getDescriptor in-descriptor-name in-descriptor-type)))
  (^javax.management.Descriptor [^ModelMBeanInfoSupport this ^java.lang.String in-descriptor-name]
...
(defn set-descriptors
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^ModelMBeanInfoSupport this in-descriptors]
...
(defn get-descriptors
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  ([^ModelMBeanInfoSupport this ^java.lang.String in-descriptor-type]
...
(defn get-attribute
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  (^javax.management.modelmbean.ModelMBeanAttributeInfo [^ModelMBeanInfoSupport this ^java.lang.String in-name]
...
(defn get-constructor
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  (^javax.management.modelmbean.ModelMBeanConstructorInfo [^ModelMBeanInfoSupport this ^java.lang.String in-name]
...
(defn clone
  ...
  (^java.lang.Object [^ModelMBeanInfoSupport this]
    (-> this (.clone))))
...
(defn get-notification
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  (^javax.management.modelmbean.ModelMBeanNotificationInfo [^ModelMBeanInfoSupport this ^java.lang.String in-name]
...
(defn get-operation
  ...
  throws: javax.management.MBeanException - Wraps a distributed communication Exception."
  (^javax.management.modelmbean.ModelMBeanOperationInfo [^ModelMBeanInfoSupport this ^java.lang.String in-name]
