...
(defn ->model-m-bean-notification-info
  ...
  (^ModelMBeanNotificationInfo [^javax.management.modelmbean.ModelMBeanNotificationInfo in-info]
...
(defn clone
  ...
  (^java.lang.Object [^ModelMBeanNotificationInfo this]
    (-> this (.clone))))
...
(defn get-descriptor
  ...
  (^javax.management.Descriptor [^ModelMBeanNotificationInfo this]
    (-> this (.getDescriptor))))
...
(defn set-descriptor
  ...
  ([^ModelMBeanNotificationInfo this ^javax.management.Descriptor in-descriptor]
...
(defn to-string
  ...
  (^java.lang.String [^ModelMBeanNotificationInfo this]
    (-> this (.toString))))
