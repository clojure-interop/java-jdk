...
(defn ->jmx-connection-notification
  ...
  (^JMXConnectionNotification [^java.lang.String type ^java.lang.Object source ^java.lang.String connection-id ^Long sequence-number ^java.lang.String message ^java.lang.Object user-data]
...
(defn get-connection-id
  ...
  (^java.lang.String [^JMXConnectionNotification this]
