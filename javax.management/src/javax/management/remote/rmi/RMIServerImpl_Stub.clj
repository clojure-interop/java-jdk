...
(defn ->rmi-server-impl-stub
  ...
  (^RMIServerImpl_Stub [^java.rmi.server.RemoteRef ref]
...
(defn get-version
  ...
  (^java.lang.String [^RMIServerImpl_Stub this]
    (-> this (.getVersion))))
...
(defn new-client
  ...
  (^javax.management.remote.rmi.RMIConnection [^RMIServerImpl_Stub this ^java.lang.Object $param-object-1]
