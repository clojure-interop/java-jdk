...
(defn get-version
  ...
  (^java.lang.String [^javax.management.remote.rmi.RMIServerImpl_Stub this]
    (-> this (.getVersion))))
...
(defn new-client
  ...
  (^javax.management.remote.rmi.RMIConnection [^javax.management.remote.rmi.RMIServerImpl_Stub this ^java.lang.Object $param-object-1]
