...
(defn ->rmi-connection-impl-stub
  ...
  (^RMIConnectionImpl_Stub [^java.rmi.server.RemoteRef ref]
...
(defn invoke
  ...
  (^java.lang.Object [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.lang.String $param-string-2 ^java.rmi.MarshalledObject $param-marshalled-object-3 $param-array-of-string-4 ^javax.security.auth.Subject $param-subject-5]
...
(defn query-m-beans
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^java.util.Set [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.rmi.MarshalledObject $param-marshalled-object-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn remove-notification-listeners
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 $param-array-of-integer-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn remove-notification-listener
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.management.ObjectName $param-object-name-2 ^java.rmi.MarshalledObject $param-marshalled-object-3 ^java.rmi.MarshalledObject $param-marshalled-object-4 ^javax.security.auth.Subject $param-subject-5]
  ...
  ([^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.management.ObjectName $param-object-name-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn get-attribute
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^java.lang.Object [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.lang.String $param-string-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn get-m-bean-info
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.MBeanInfo [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.security.auth.Subject $param-subject-2]
...
(defn create-m-bean
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.ObjectInstance [^RMIConnectionImpl_Stub this ^java.lang.String $param-string-1 ^javax.management.ObjectName $param-object-name-2 ^javax.management.ObjectName $param-object-name-3 ^java.rmi.MarshalledObject $param-marshalled-object-4 $param-array-of-string-5 ^javax.security.auth.Subject $param-subject-6]
  ...
  (^javax.management.ObjectInstance [^RMIConnectionImpl_Stub this ^java.lang.String $param-string-1 ^javax.management.ObjectName $param-object-name-2 ^java.rmi.MarshalledObject $param-marshalled-object-3 $param-array-of-string-4 ^javax.security.auth.Subject $param-subject-5]
    (-> this (.createMBean $param-string-1 $param-object-name-2 $param-marshalled-object-3 $param-array-of-string-4 $param-subject-5)))
  (^javax.management.ObjectInstance [^RMIConnectionImpl_Stub this ^java.lang.String $param-string-1 ^javax.management.ObjectName $param-object-name-2 ^javax.management.ObjectName $param-object-name-3 ^javax.security.auth.Subject $param-subject-4]
    (-> this (.createMBean $param-string-1 $param-object-name-2 $param-object-name-3 $param-subject-4)))
  (^javax.management.ObjectInstance [^RMIConnectionImpl_Stub this ^java.lang.String $param-string-1 ^javax.management.ObjectName $param-object-name-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn get-m-bean-count
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^java.lang.Integer [^RMIConnectionImpl_Stub this ^javax.security.auth.Subject $param-subject-1]
...
(defn registered?
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^Boolean [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.security.auth.Subject $param-subject-2]
...
(defn add-notification-listeners
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this $param-array-of-object-name-1 $param-array-of-marshalled-object-2 $param-array-of-subject-3]
...
(defn unregister-m-bean
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.security.auth.Subject $param-subject-2]
...
(defn get-default-domain
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^java.lang.String [^RMIConnectionImpl_Stub this ^javax.security.auth.Subject $param-subject-1]
...
(defn set-attribute
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.rmi.MarshalledObject $param-marshalled-object-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn get-object-instance
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.ObjectInstance [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^javax.security.auth.Subject $param-subject-2]
...
(defn get-domains
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  ([^RMIConnectionImpl_Stub this ^javax.security.auth.Subject $param-subject-1]
...
(defn get-connection-id
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^java.lang.String [^RMIConnectionImpl_Stub this]
...
(defn set-attributes
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.AttributeList [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.rmi.MarshalledObject $param-marshalled-object-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn fetch-notifications
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.remote.NotificationResult [^RMIConnectionImpl_Stub this ^Long $param-long-1 ^Integer $param-int-2 ^Long $param-long-3]
...
(defn get-attributes
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^javax.management.AttributeList [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 $param-array-of-string-2 ^javax.security.auth.Subject $param-subject-3]
...
(defn instance-of?
  ...
  throws: java.io.IOException - if a general communication exception occurred."
  (^Boolean [^RMIConnectionImpl_Stub this ^javax.management.ObjectName $param-object-name-1 ^java.lang.String $param-string-2 ^javax.security.auth.Subject $param-subject-3]
