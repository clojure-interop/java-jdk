...
(defn ->jmx-service-url
  ...
  (^JMXServiceURL [^java.lang.String protocol ^java.lang.String host ^Integer port ^java.lang.String url-path]
    (new JMXServiceURL protocol host port url-path))
  (^JMXServiceURL [^java.lang.String protocol ^java.lang.String host ^Integer port]
    (new JMXServiceURL protocol host port))
  (^JMXServiceURL [^java.lang.String service-url]
...
(defn get-protocol
  ...
  (^java.lang.String [^JMXServiceURL this]
    (-> this (.getProtocol))))
...
(defn equals
  ...
  (^Boolean [^JMXServiceURL this ^java.lang.Object obj]
    (-> this (.equals obj))))
