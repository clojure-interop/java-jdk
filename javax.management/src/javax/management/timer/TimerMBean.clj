...
(defn get-notification-type
  ...
  (^java.lang.String [^TimerMBean this ^java.lang.Integer id]
...
(defn get-notification-i-ds
  ...
  (^java.util.Vector [^TimerMBean this ^java.lang.String type]
...
(defn get-period
  ...
  (^java.lang.Long [^TimerMBean this ^java.lang.Integer id]
    (-> this (.getPeriod id))))
...
(defn get-fixed-rate?
  ...
  (^java.lang.Boolean [^TimerMBean this ^java.lang.Integer id]
...
(defn get-all-notification-i-ds
  ...
  (^java.util.Vector [^TimerMBean this]
...
(defn get-notification-user-data
  ...
  (^java.lang.Object [^TimerMBean this ^java.lang.Integer id]
...
(defn get-date
  ...
  (^java.util.Date [^TimerMBean this ^java.lang.Integer id]
    (-> this (.getDate id))))
...
(defn add-notification
  ...
  (^java.lang.Integer [^TimerMBean this ^java.lang.String type ^java.lang.String message ^java.lang.Object user-data ^java.util.Date date ^Long period ^Long nb-occurences ^Boolean fixed-rate]
    (-> this (.addNotification type message user-data date period nb-occurences fixed-rate)))
  (^java.lang.Integer [^TimerMBean this ^java.lang.String type ^java.lang.String message ^java.lang.Object user-data ^java.util.Date date ^Long period ^Long nb-occurences]
    (-> this (.addNotification type message user-data date period nb-occurences)))
  (^java.lang.Integer [^TimerMBean this ^java.lang.String type ^java.lang.String message ^java.lang.Object user-data ^java.util.Date date ^Long period]
    (-> this (.addNotification type message user-data date period)))
  (^java.lang.Integer [^TimerMBean this ^java.lang.String type ^java.lang.String message ^java.lang.Object user-data ^java.util.Date date]
...
(defn remove-notification
  ...
  ([^TimerMBean this ^java.lang.Integer id]
...
(defn remove-notifications
  ...
  ([^TimerMBean this ^java.lang.String type]
