...
(defn get-actions
  ...
  (^java.lang.String [^MBeanPermission this]
    (-> this (.getActions))))
...
(defn implies
  ...
  (^Boolean [^MBeanPermission this ^java.security.Permission p]
    (-> this (.implies p))))
...
(defn equals
  ...
  (^Boolean [^MBeanPermission this ^java.lang.Object obj]
    (-> this (.equals obj))))
