...
(defn get-description
  ...
  (^java.lang.String [^OpenMBeanConstructorInfo this]
    (-> this (.getDescription))))
...
(defn equals
  ...
  (^Boolean [^OpenMBeanConstructorInfo this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn hash-code
  ...
  (^Integer [^OpenMBeanConstructorInfo this]
    (-> this (.hashCode))))
