...
(defn get-impact
  ...
  (^Integer [^OpenMBeanOperationInfo this]
    (-> this (.getImpact))))
...
(defn to-string
  ...
  (^java.lang.String [^OpenMBeanOperationInfo this]
    (-> this (.toString))))
...
(defn get-return-open-type
  ...
  (^javax.management.openmbean.OpenType [^OpenMBeanOperationInfo this]
...
(defn equals
  ...
  (^Boolean [^OpenMBeanOperationInfo this ^java.lang.Object obj]
    (-> this (.equals obj))))
