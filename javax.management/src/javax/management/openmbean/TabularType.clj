...
(defn ->tabular-type
  ...
  ([^java.lang.String type-name ^java.lang.String description ^javax.management.openmbean.CompositeType row-type index-names]
...
(defn get-row-type
  ...
  (^javax.management.openmbean.CompositeType [^javax.management.openmbean.TabularType this]
    (-> this (.getRowType))))
...
(defn get-index-names
  ...
  (^java.util.List [^javax.management.openmbean.TabularType this]
    (-> this (.getIndexNames))))
...
(defn value?
  ...
  (^Boolean [^javax.management.openmbean.TabularType this ^java.lang.Object obj]
    (-> this (.isValue obj))))
...
(defn hash-code
  ...
  (^Integer [^javax.management.openmbean.TabularType this]
    (-> this (.hashCode))))
...
(defn to-string
  ...
  (^java.lang.String [^javax.management.openmbean.TabularType this]
    (-> this (.toString))))
