...
(defn ->tabular-type
  ...
  (^TabularType [^java.lang.String type-name ^java.lang.String description ^javax.management.openmbean.CompositeType row-type index-names]
...
(defn get-row-type
  ...
  (^javax.management.openmbean.CompositeType [^TabularType this]
    (-> this (.getRowType))))
...
(defn get-index-names
  ...
  (^java.util.List [^TabularType this]
    (-> this (.getIndexNames))))
...
(defn value?
  ...
  (^Boolean [^TabularType this ^java.lang.Object obj]
    (-> this (.isValue obj))))
...
(defn to-string
  ...
  (^java.lang.String [^TabularType this]
    (-> this (.toString))))
