...
(defn get-all
  ...
  ([^javax.management.openmbean.CompositeData this ^java.lang.String[] keys]
    (-> this (.getAll keys))))
...
(defn contains-value
  ...
  ([^javax.management.openmbean.CompositeData this ^java.lang.Object value]
...
(defn contains-key
  ...
  ([^javax.management.openmbean.CompositeData this ^java.lang.String key]
...
(defn equals
  ...
  ([^javax.management.openmbean.CompositeData this ^java.lang.Object obj]
    (-> this (.equals obj))))
