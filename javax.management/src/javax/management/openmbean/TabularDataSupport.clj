...
(defn ->tabular-data-support
  ...
  (^TabularDataSupport [^javax.management.openmbean.TabularType tabular-type ^Integer initial-capacity ^Float load-factor]
    (new TabularDataSupport tabular-type initial-capacity load-factor))
  (^TabularDataSupport [^javax.management.openmbean.TabularType tabular-type]
...
(defn values
  ...
  (^java.util.Collection [^TabularDataSupport this]
    (-> this (.values))))
...
(defn put-all
  ...
  ([^TabularDataSupport this ^java.util.Map t]
    (-> this (.putAll t))))
...
(defn get-tabular-type
  ...
  (^javax.management.openmbean.TabularType [^TabularDataSupport this]
    (-> this (.getTabularType))))
...
(defn put
  ...
  (^java.lang.Object [^TabularDataSupport this ^java.lang.Object key ^java.lang.Object value]
    (-> this (.put key value)))
  ([^TabularDataSupport this ^javax.management.openmbean.CompositeData value]
    (-> this (.put value))))
...
(defn entry-set
  ...
  (^java.util.Set [^TabularDataSupport this]
    (-> this (.entrySet))))
...
(defn to-string
  ...
  (^java.lang.String [^TabularDataSupport this]
    (-> this (.toString))))
...
(defn contains-value
  ...
  (^Boolean [^TabularDataSupport this ^javax.management.openmbean.CompositeData value]
...
(defn remove
  ...
  (^java.lang.Object [^TabularDataSupport this ^java.lang.Object key]
    (-> this (.remove key))))
...
(defn clone
  ...
  (^java.lang.Object [^TabularDataSupport this]
    (-> this (.clone))))
...
(defn hash-code
  ...
  (^Integer [^TabularDataSupport this]
    (-> this (.hashCode))))
...
(defn empty?
  ...
  (^Boolean [^TabularDataSupport this]
    (-> this (.isEmpty))))
...
(defn contains-key
  ...
  (^Boolean [^TabularDataSupport this ^java.lang.Object key]
...
(defn equals
  ...
  (^Boolean [^TabularDataSupport this ^java.lang.Object obj]
    (-> this (.equals obj))))
