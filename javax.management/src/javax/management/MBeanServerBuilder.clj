...
(defn new-m-bean-server-delegate
  ...
  (^javax.management.MBeanServerDelegate [^MBeanServerBuilder this]
...
(defn new-m-bean-server
  ...
  (^javax.management.MBeanServer [^MBeanServerBuilder this ^java.lang.String default-domain ^javax.management.MBeanServer outer ^javax.management.MBeanServerDelegate delegate]
