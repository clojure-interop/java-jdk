...
(defn ->notification-broadcaster-support
  ...
  (^NotificationBroadcasterSupport [^java.util.concurrent.Executor executor ^javax.management.MBeanNotificationInfo info]
...
(defn add-notification-listener
  ...
  ([^NotificationBroadcasterSupport this ^javax.management.NotificationListener listener ^javax.management.NotificationFilter filter ^java.lang.Object handback]
...
(defn remove-notification-listener
  ...
  ([^NotificationBroadcasterSupport this ^javax.management.NotificationListener listener]
...
(defn get-notification-info
  ...
  ([^NotificationBroadcasterSupport this]
...
(defn send-notification
  ...
  ([^NotificationBroadcasterSupport this ^javax.management.Notification notification]
