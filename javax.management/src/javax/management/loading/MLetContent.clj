...
(defn ->m-let-content
  ...
  attributes - A map of the attributes of the MLET tag. The keys in this map are the attribute names in lowercase, for example codebase. The values are the associated attribute values. - `java.util.Map`
  types - A list of the TYPE attributes that appeared in nested <PARAM> tags. - `java.util.List`
  values - A list of the VALUE attributes that appeared in nested <PARAM> tags. - `java.util.List`"
  (^MLetContent [^java.net.URL url ^java.util.Map attributes ^java.util.List types ^java.util.List values]
...
(defn get-jar-files
  ...
  (^java.lang.String [^MLetContent this]
    (-> this (.getJarFiles))))
...
(defn get-parameter-types
  ...
  (^java.util.List [^MLetContent this]
...
(defn get-attributes
  ...
  (^java.util.Map [^MLetContent this]
    (-> this (.getAttributes))))
