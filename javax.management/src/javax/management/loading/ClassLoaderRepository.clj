...
(defn load-class
  ...
  ([^javax.management.loading.ClassLoaderRepository this ^java.lang.String class-name]
...
(defn load-class-without
  ...
  throws: java.lang.ClassNotFoundException - The specified class could not be found."
  ([^javax.management.loading.ClassLoaderRepository this ^java.lang.ClassLoader exclude ^java.lang.String class-name]
...
(defn load-class-before
  ...
  throws: java.lang.ClassNotFoundException - The specified class could not be found."
  ([^javax.management.loading.ClassLoaderRepository this ^java.lang.ClassLoader stop ^java.lang.String class-name]
