...
(defn set-fields
  ...
  ([^Descriptor this field-names field-values]
...
(defn remove-field
  ...
  ([^Descriptor this ^java.lang.String field-name]
...
(defn get-field-value
  ...
  (^java.lang.Object [^Descriptor this ^java.lang.String field-name]
...
(defn get-field-values
  ...
  ([^Descriptor this ^java.lang.String field-names]
...
(defn set-field
  ...
  ([^Descriptor this ^java.lang.String field-name ^java.lang.Object field-value]
...
(defn clone
  ...
  (^java.lang.Object [^Descriptor this]
    (-> this (.clone))))
...
(defn equals
  ...
  returns: true if the objects are the same; false
   otherwise. - `boolean`"
  (^Boolean [^Descriptor this ^java.lang.Object obj]
    (-> this (.equals obj))))
