...
(defn ->standard-m-bean
  ...
  mbean-interface - The Management Interface exported by this MBean's implementation. If null, then this object will use standard JMX design pattern to determine the management interface associated with the given implementation. - `java.lang.Class`
  ...
  (^StandardMBean [implementation ^java.lang.Class mbean-interface ^Boolean is-mx-bean]
    (new StandardMBean implementation mbean-interface is-mx-bean))
  (^StandardMBean [implementation ^java.lang.Class mbean-interface]
...
(defn invoke
  ...
  (^java.lang.Object [^StandardMBean this ^java.lang.String action-name params signature]
...
(defn set-implementation
  ...
  ([^StandardMBean this ^java.lang.Object implementation]
...
(defn get-attribute
  ...
  (^java.lang.Object [^StandardMBean this ^java.lang.String attribute]
...
(defn get-implementation
  ...
  (^java.lang.Object [^StandardMBean this]
...
(defn get-m-bean-info
  ...
  (^javax.management.MBeanInfo [^StandardMBean this]
    (-> this (.getMBeanInfo))))
...
(defn post-register
  ...
  ([^StandardMBean this ^java.lang.Boolean registration-done]
...
(defn set-attribute
  ...
  throws: javax.management.AttributeNotFoundException"
  ([^StandardMBean this ^javax.management.Attribute attribute]
...
(defn get-implementation-class
  ...
  (^java.lang.Class [^StandardMBean this]
...
(defn set-attributes
  ...
  (^javax.management.AttributeList [^StandardMBean this ^javax.management.AttributeList attributes]
...
(defn pre-register
  ...
  (^javax.management.ObjectName [^StandardMBean this ^javax.management.MBeanServer server ^javax.management.ObjectName name]
...
(defn get-attributes
  ...
  (^javax.management.AttributeList [^StandardMBean this attributes]
