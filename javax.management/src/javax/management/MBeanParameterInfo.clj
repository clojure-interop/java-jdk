...
(defn ->m-bean-parameter-info
  ...
  (^MBeanParameterInfo [^java.lang.String name ^java.lang.String type ^java.lang.String description ^javax.management.Descriptor descriptor]
...
(defn clone
  ...
  (^java.lang.Object [^MBeanParameterInfo this]
    (-> this (.clone))))
...
(defn get-type
  ...
  (^java.lang.String [^MBeanParameterInfo this]
    (-> this (.getType))))
...
(defn equals
  ...
  (^Boolean [^MBeanParameterInfo this ^java.lang.Object o]
    (-> this (.equals o))))
...
(defn hash-code
  ...
  (^Integer [^MBeanParameterInfo this]
    (-> this (.hashCode))))
