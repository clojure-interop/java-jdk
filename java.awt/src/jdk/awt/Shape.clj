...
(defn intersects
  ...
  ([^. this ^java.awt.geom.Rectangle2D r]
    (-> this (.intersects r))))
...
(defn get-path-iterator
  ...
  ([^. this ^java.awt.geom.AffineTransform at ^Double flatness]
    (-> this (.getPathIterator at flatness)))
  ([^. this ^java.awt.geom.AffineTransform at]
