...
(defn get-image-capabilities
  ...
  (^java.awt.ImageCapabilities [^GraphicsConfiguration this]
...
(defn get-default-transform
  ...
  (^java.awt.geom.AffineTransform [^GraphicsConfiguration this]
...
(defn create-compatible-volatile-image
  ...
  (^java.awt.image.VolatileImage [^GraphicsConfiguration this ^Integer width ^Integer height ^java.awt.ImageCapabilities caps ^Integer transparency]
    (-> this (.createCompatibleVolatileImage width height caps transparency)))
  (^java.awt.image.VolatileImage [^GraphicsConfiguration this ^Integer width ^Integer height ^Integer transparency]
    (-> this (.createCompatibleVolatileImage width height transparency)))
  (^java.awt.image.VolatileImage [^GraphicsConfiguration this ^Integer width ^Integer height]
...
(defn create-compatible-image
  ...
  throws: java.lang.IllegalArgumentException - if the transparency is not a valid value"
  (^java.awt.image.BufferedImage [^GraphicsConfiguration this ^Integer width ^Integer height ^Integer transparency]
    (-> this (.createCompatibleImage width height transparency)))
  (^java.awt.image.BufferedImage [^GraphicsConfiguration this ^Integer width ^Integer height]
...
(defn get-device
  ...
  (^java.awt.GraphicsDevice [^GraphicsConfiguration this]
    (-> this (.getDevice))))
...
(defn translucency-capable?
  ...
  (^Boolean [^GraphicsConfiguration this]
...
(defn get-bounds
  ...
  (^java.awt.Rectangle [^GraphicsConfiguration this]
    (-> this (.getBounds))))
...
(defn get-buffer-capabilities
  ...
  (^java.awt.BufferCapabilities [^GraphicsConfiguration this]
...
(defn get-color-model
  ...
  (^java.awt.image.ColorModel [^GraphicsConfiguration this ^Integer transparency]
    (-> this (.getColorModel transparency)))
  (^java.awt.image.ColorModel [^GraphicsConfiguration this]
    (-> this (.getColorModel))))
