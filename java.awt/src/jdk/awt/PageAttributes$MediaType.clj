(ns jdk.awt.PageAttributes$MediaType
...
(def *-iso-designated-long-envelope
  "Static Constant.
...
(defn hash-code
  ...
  (^Integer [^PageAttributes$MediaType this]
    (-> this (.hashCode))))
...
(defn to-string
  ...
  (^java.lang.String [^PageAttributes$MediaType this]
    (-> this (.toString))))
