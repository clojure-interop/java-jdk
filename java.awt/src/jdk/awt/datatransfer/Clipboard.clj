...
(defn data-flavor-available?
  ...
  (^Boolean [^Clipboard this ^java.awt.datatransfer.DataFlavor flavor]
...
(defn get-data
  ...
  throws: java.lang.NullPointerException - if flavor is null"
  (^java.lang.Object [^Clipboard this ^java.awt.datatransfer.DataFlavor flavor]
    (-> this (.getData flavor))))
...
(defn set-contents
  ...
  ([^Clipboard this ^java.awt.datatransfer.Transferable contents ^java.awt.datatransfer.ClipboardOwner owner]
...
(defn add-flavor-listener
  ...
  ([^Clipboard this ^java.awt.datatransfer.FlavorListener listener]
...
(defn get-name
  ...
  (^java.lang.String [^Clipboard this]
    (-> this (.getName))))
...
(defn get-contents
  ...
  throws: java.lang.IllegalStateException - if the clipboard is currently unavailable"
  (^java.awt.datatransfer.Transferable [^Clipboard this ^java.lang.Object requestor]
