...
(defn ->data-flavor
  ...
  (^DataFlavor [^java.lang.String mime-type ^java.lang.String human-presentable-name ^java.lang.ClassLoader class-loader]
    (new DataFlavor mime-type human-presentable-name class-loader))
  (^DataFlavor [^java.lang.Class representation-class ^java.lang.String human-presentable-name]
    (new DataFlavor representation-class human-presentable-name))
  (^DataFlavor [^java.lang.String mime-type]
...
(defn get-reader-for-text
  ...
  (^java.io.Reader [^DataFlavor this ^java.awt.datatransfer.Transferable transferable]
...
(defn get-representation-class
  ...
  (^java.lang.Class [^DataFlavor this]
...
(defn set-human-presentable-name
  ...
  ([^DataFlavor this ^java.lang.String human-presentable-name]
...
(defn get-mime-type
  ...
  (^java.lang.String [^DataFlavor this]
    (-> this (.getMimeType))))
...
(defn write-external
  ...
  ([^DataFlavor this ^java.io.ObjectOutput os]
...
(defn get-parameter
  ...
  (^java.lang.String [^DataFlavor this ^java.lang.String param-name]
...
(defn match
  ...
  (^Boolean [^DataFlavor this ^java.awt.datatransfer.DataFlavor that]
    (-> this (.match that))))
...
(defn clone
  ...
  (^java.lang.Object [^DataFlavor this]
    (-> this (.clone))))
...
(defn read-external
  ...
  ([^DataFlavor this ^java.io.ObjectInput is]
...
(defn mime-type-equal?
  ...
  (^Boolean [^DataFlavor this ^java.lang.String mime-type]
...
(defn equals
  ...
  returns: true if that is equivalent to this
           DataFlavor; false otherwise - `boolean`"
  (^Boolean [^DataFlavor this ^java.lang.Object o]
    (-> this (.equals o))))
