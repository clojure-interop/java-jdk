...
(defn add-action-listener
  ...
  ([^Button this ^java.awt.event.ActionListener l]
...
(defn get-accessible-context
  ...
  (^javax.accessibility.AccessibleContext [^Button this]
...
(defn get-listeners
  ...
  ([^Button this ^java.lang.Class listener-type]
...
(defn set-action-command
  ...
  ([^Button this ^java.lang.String command]
...
(defn set-label
  ...
  ([^Button this ^java.lang.String label]
    (-> this (.setLabel label))))
