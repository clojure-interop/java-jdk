...
(defn ->shape-graphic-attribute
  ...
  (^ShapeGraphicAttribute [^java.awt.Shape shape ^Integer alignment ^Boolean stroke]
...
(defn get-ascent
  ...
  (^Float [^ShapeGraphicAttribute this]
    (-> this (.getAscent))))
...
(defn draw
  ...
  ([^ShapeGraphicAttribute this ^java.awt.Graphics2D graphics ^Float x ^Float y]
...
(defn get-bounds
  ...
  (^java.awt.geom.Rectangle2D [^ShapeGraphicAttribute this]
    (-> this (.getBounds))))
...
(defn get-outline
  ...
  (^java.awt.Shape [^ShapeGraphicAttribute this ^java.awt.geom.AffineTransform tx]
    (-> this (.getOutline tx))))
...
(defn hash-code
  ...
  (^Integer [^ShapeGraphicAttribute this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  (^Boolean [^ShapeGraphicAttribute this ^java.lang.Object rhs]
    (-> this (.equals rhs))))
