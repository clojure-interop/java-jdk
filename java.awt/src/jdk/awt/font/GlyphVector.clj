...
(defn get-glyph-outline
  ...
  (^java.awt.Shape [^GlyphVector this ^Integer glyph-index ^Float x ^Float y]
    (-> this (.getGlyphOutline glyph-index x y)))
  (^java.awt.Shape [^GlyphVector this ^Integer glyph-index]
...
(defn get-glyph-char-indices
  ...
  ([^GlyphVector this ^Integer begin-glyph-index ^Integer num-entries code-return]
...
(defn get-glyph-positions
  ...
  ([^GlyphVector this ^Integer begin-glyph-index ^Integer num-entries position-return]
...
(defn get-glyph-justification-info
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than or equal to the number of glyphs in this GlyphVector"
  (^java.awt.font.GlyphJustificationInfo [^GlyphVector this ^Integer glyph-index]
...
(defn get-visual-bounds
  ...
  (^java.awt.geom.Rectangle2D [^GlyphVector this]
...
(defn get-glyph-position
  ...
  (^java.awt.geom.Point2D [^GlyphVector this ^Integer glyph-index]
...
(defn get-glyph-pixel-bounds
  ...
  (^java.awt.Rectangle [^GlyphVector this ^Integer index ^java.awt.font.FontRenderContext render-frc ^Float x ^Float y]
...
(defn set-glyph-position
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than the number of glyphs in this GlyphVector"
  ([^GlyphVector this ^Integer glyph-index ^java.awt.geom.Point2D new-pos]
...
(defn set-glyph-transform
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than or equal to the number of glyphs in this GlyphVector"
  ([^GlyphVector this ^Integer glyph-index ^java.awt.geom.AffineTransform new-tx]
...
(defn get-outline
  ...
  returns: a Shape that is the outline of this
     GlyphVector when rendered at the specified
     coordinates. - `java.awt.Shape`"
  (^java.awt.Shape [^GlyphVector this ^Float x ^Float y]
    (-> this (.getOutline x y)))
  (^java.awt.Shape [^GlyphVector this]
    (-> this (.getOutline))))
...
(defn get-font-render-context
  ...
  (^java.awt.font.FontRenderContext [^GlyphVector this]
...
(defn get-pixel-bounds
  ...
  returns: a Rectangle bounding the pixels that would be affected. - `java.awt.Rectangle`"
  (^java.awt.Rectangle [^GlyphVector this ^java.awt.font.FontRenderContext render-frc ^Float x ^Float y]
...
(defn get-glyph-metrics
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than or equal to the number of glyphs in this GlyphVector"
  (^java.awt.font.GlyphMetrics [^GlyphVector this ^Integer glyph-index]
...
(defn get-glyph-code
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than or equal to the number of glyphs in this GlyphVector"
  (^Integer [^GlyphVector this ^Integer glyph-index]
...
(defn equals
  ...
  (^Boolean [^GlyphVector this ^java.awt.font.GlyphVector set]
    (-> this (.equals set))))
...
(defn get-glyph-transform
  ...
  throws: java.lang.IndexOutOfBoundsException - if glyphIndex is less than 0 or greater than or equal to the number of glyphs in this GlyphVector"
  (^java.awt.geom.AffineTransform [^GlyphVector this ^Integer glyph-index]
