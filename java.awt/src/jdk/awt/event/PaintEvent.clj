...
(defn ->paint-event
  ...
  (^PaintEvent [^java.awt.Component source ^Integer id ^java.awt.Rectangle update-rect]
...
(defn get-update-rect
  ...
  (^java.awt.Rectangle [^PaintEvent this]
    (-> this (.getUpdateRect))))
...
(defn set-update-rect
  ...
  update-rect - the rectangle area which needs to be repainted - `java.awt.Rectangle`"
  ([^PaintEvent this ^java.awt.Rectangle update-rect]
...
(defn param-string
  ...
  (^java.lang.String [^PaintEvent this]
    (-> this (.paramString))))
