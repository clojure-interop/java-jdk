...
(defn ->input-method-event
  ...
  (^InputMethodEvent [^java.awt.Component source ^Integer id ^Long when ^java.text.AttributedCharacterIterator text ^Integer committed-character-count ^java.awt.font.TextHitInfo caret ^java.awt.font.TextHitInfo visible-position]
    (new InputMethodEvent source id when text committed-character-count caret visible-position))
  (^InputMethodEvent [^java.awt.Component source ^Integer id ^java.text.AttributedCharacterIterator text ^Integer committed-character-count ^java.awt.font.TextHitInfo caret ^java.awt.font.TextHitInfo visible-position]
    (new InputMethodEvent source id text committed-character-count caret visible-position))
  (^InputMethodEvent [^java.awt.Component source ^Integer id ^java.awt.font.TextHitInfo caret ^java.awt.font.TextHitInfo visible-position]
...
(defn get-text
  ...
  (^java.text.AttributedCharacterIterator [^InputMethodEvent this]
    (-> this (.getText))))
...
(defn get-caret
  ...
  (^java.awt.font.TextHitInfo [^InputMethodEvent this]
    (-> this (.getCaret))))
...
(defn param-string
  ...
  (^java.lang.String [^InputMethodEvent this]
    (-> this (.paramString))))
