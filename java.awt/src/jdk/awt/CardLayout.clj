...
(defn ->card-layout
  ...
  (^CardLayout [^Integer hgap ^Integer vgap]
...
(defn invalidate-layout
  ...
  ([^CardLayout this ^java.awt.Container target]
...
(defn next
  ...
  ([^CardLayout this ^java.awt.Container parent]
    (-> this (.next parent))))
...
(defn get-layout-alignment-y
  ...
  returns: `float`"
  (^Float [^CardLayout this ^java.awt.Container parent]
...
(defn preferred-layout-size
  ...
  (^java.awt.Dimension [^CardLayout this ^java.awt.Container parent]
...
(defn to-string
  ...
  (^java.lang.String [^CardLayout this]
    (-> this (.toString))))
...
(defn show
  ...
  ([^CardLayout this ^java.awt.Container parent ^java.lang.String name]
...
(defn maximum-layout-size
  ...
  (^java.awt.Dimension [^CardLayout this ^java.awt.Container target]
...
(defn add-layout-component
  ...
  ([^CardLayout this ^java.awt.Component comp ^java.lang.Object constraints]
...
(defn remove-layout-component
  ...
  ([^CardLayout this ^java.awt.Component comp]
