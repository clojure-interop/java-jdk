...
(defn dispatch-input-method-event
  ...
  ([^. this ^Integer id ^java.text.AttributedCharacterIterator text ^Integer committed-character-count ^java.awt.font.TextHitInfo caret ^java.awt.font.TextHitInfo visible-position]
...
(defn create-input-method-window
  ...
  ([^. this ^java.lang.String title ^Boolean attach-to-input-context]
...
(defn enable-client-window-notification
  ...
  ([^. this ^java.awt.im.spi.InputMethod input-method ^Boolean enable]
