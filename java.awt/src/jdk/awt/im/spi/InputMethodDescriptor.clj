...
(defn has-dynamic-locale-list?
  ...
  returns: `boolean`"
  (^Boolean [^InputMethodDescriptor this]
...
(defn get-input-method-display-name
  ...
  (^java.lang.String [^InputMethodDescriptor this ^java.util.Locale input-locale ^java.util.Locale display-language]
...
(defn get-input-method-icon
  ...
  (^java.awt.Image [^InputMethodDescriptor this ^java.util.Locale input-locale]
...
(defn create-input-method
  ...
  (^java.awt.im.spi.InputMethod [^InputMethodDescriptor this]
