...
(defn drag-enter
  ...
  ([^DragSourceListener this ^java.awt.dnd.DragSourceDragEvent dsde]
    (-> this (.dragEnter dsde))))
...
(defn drag-exit
  ...
  ([^DragSourceListener this ^java.awt.dnd.DragSourceEvent dse]
    (-> this (.dragExit dse))))
...
(defn drag-drop-end
  ...
  ([^DragSourceListener this ^java.awt.dnd.DragSourceDropEvent dsde]
