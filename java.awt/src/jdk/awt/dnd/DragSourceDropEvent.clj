...
(defn ->drag-source-drop-event
  ...
  (^DragSourceDropEvent [^java.awt.dnd.DragSourceContext dsc ^Integer action ^Boolean success ^Integer x ^Integer y]
    (new DragSourceDropEvent dsc action success x y))
  (^DragSourceDropEvent [^java.awt.dnd.DragSourceContext dsc ^Integer action ^Boolean success]
    (new DragSourceDropEvent dsc action success))
  (^DragSourceDropEvent [^java.awt.dnd.DragSourceContext dsc]
...
(defn get-drop-success?
  ...
  (^Boolean [^DragSourceDropEvent this]
    (-> this (.getDropSuccess))))
...
(defn get-drop-action
  ...
  (^Integer [^DragSourceDropEvent this]
    (-> this (.getDropAction))))
