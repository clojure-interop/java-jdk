...
(defn get-drop-target
  ...
  (^java.awt.dnd.DropTarget [^DropTargetContext this]
    (-> this (.getDropTarget))))
...
(defn get-component
  ...
  (^java.awt.Component [^DropTargetContext this]
    (-> this (.getComponent))))
...
(defn add-notify
  ...
  ([^DropTargetContext this ^java.awt.dnd.peer.DropTargetContextPeer dtcp]
    (-> this (.addNotify dtcp))))
...
(defn drop-complete
  ...
  ([^DropTargetContext this ^Boolean success]
