...
(defn ->drag-source-event
  ...
  (^DragSourceEvent [^java.awt.dnd.DragSourceContext dsc ^Integer x ^Integer y]
    (new DragSourceEvent dsc x y))
  (^DragSourceEvent [^java.awt.dnd.DragSourceContext dsc]
...
(defn get-drag-source-context
  ...
  (^java.awt.dnd.DragSourceContext [^DragSourceEvent this]
...
(defn get-location
  ...
  (^java.awt.Point [^DragSourceEvent this]
    (-> this (.getLocation))))
