...
(defn get-display-mode
  ...
  (^java.awt.DisplayMode [^GraphicsDevice this]
    (-> this (.getDisplayMode))))
...
(defn get-full-screen-window
  ...
  (^java.awt.Window [^GraphicsDevice this]
...
(defn get-i-dstring
  ...
  (^java.lang.String [^GraphicsDevice this]
    (-> this (.getIDstring))))
...
(defn window-translucency-supported?
  ...
  (^Boolean [^GraphicsDevice this ^java.awt.GraphicsDevice$WindowTranslucency translucency-kind]
...
(defn set-display-mode
  ...
  ([^GraphicsDevice this ^java.awt.DisplayMode dm]
...
(defn set-full-screen-window
  ...
  ([^GraphicsDevice this ^java.awt.Window w]
...
(defn get-default-configuration
  ...
  (^java.awt.GraphicsConfiguration [^GraphicsDevice this]
...
(defn get-best-configuration
  ...
  (^java.awt.GraphicsConfiguration [^GraphicsDevice this ^java.awt.GraphicsConfigTemplate gct]
