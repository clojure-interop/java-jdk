...
(defn ->lookup-op
  ...
  (^LookupOp [^java.awt.image.LookupTable lookup ^java.awt.RenderingHints hints]
...
(defn get-table
  ...
  (^java.awt.image.LookupTable [^LookupOp this]
    (-> this (.getTable))))
...
(defn filter
  ...
  (^java.awt.image.BufferedImage [^LookupOp this ^java.awt.image.BufferedImage src ^java.awt.image.BufferedImage dst]
    (-> this (.filter src dst))))
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^LookupOp this ^java.awt.image.BufferedImage src]
...
(defn create-compatible-dest-image
  ...
  (^java.awt.image.BufferedImage [^LookupOp this ^java.awt.image.BufferedImage src ^java.awt.image.ColorModel dest-cm]
...
(defn create-compatible-dest-raster
  ...
  (^java.awt.image.WritableRaster [^LookupOp this ^java.awt.image.Raster src]
...
(defn get-point-2-d
  ...
  (^java.awt.geom.Point2D [^LookupOp this ^java.awt.geom.Point2D src-pt ^java.awt.geom.Point2D dst-pt]
...
(defn get-rendering-hints
  ...
  (^java.awt.RenderingHints [^LookupOp this]
