...
(defn ->memory-image-source
  ...
  (^MemoryImageSource [^Integer w ^Integer h ^java.awt.image.ColorModel cm pix ^Integer off ^Integer scan ^java.util.Hashtable props]
    (new MemoryImageSource w h cm pix off scan props))
  (^MemoryImageSource [^Integer w ^Integer h ^java.awt.image.ColorModel cm pix ^Integer off ^Integer scan]
    (new MemoryImageSource w h cm pix off scan))
  (^MemoryImageSource [^Integer w ^Integer h pix ^Integer off ^Integer scan]
...
(defn add-consumer
  ...
  ([^MemoryImageSource this ^java.awt.image.ImageConsumer ic]
    (-> this (.addConsumer ic))))
...
(defn consumer?
  ...
  (^Boolean [^MemoryImageSource this ^java.awt.image.ImageConsumer ic]
    (-> this (.isConsumer ic))))
...
(defn set-animated
  ...
  ([^MemoryImageSource this ^Boolean animated]
...
(defn set-full-buffer-updates
  ...
  ([^MemoryImageSource this ^Boolean fullbuffers]
...
(defn new-pixels
  ...
  ([^MemoryImageSource this ^Integer x ^Integer y ^Integer w ^Integer h ^Boolean framenotify]
    (-> this (.newPixels x y w h framenotify)))
  ([^MemoryImageSource this ^Integer x ^Integer y ^Integer w ^Integer h]
    (-> this (.newPixels x y w h)))
  ([^MemoryImageSource this]
    (-> this (.newPixels))))
