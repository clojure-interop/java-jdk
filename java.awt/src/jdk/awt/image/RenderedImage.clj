...
(defn get-min-tile-y
  ...
  ([^java.awt.image.RenderedImage this]
    (-> this (.getMinTileY))))
...
(defn get-data
  ...
  ([^java.awt.image.RenderedImage this ^java.awt.Rectangle rect]
    (-> this (.getData rect)))
  ([^java.awt.image.RenderedImage this]
    (-> this (.getData))))
...
(defn get-tile
  ...
  ([^java.awt.image.RenderedImage this ^Integer tile-x ^Integer tile-y]
...
(defn copy-data
  ...
  ([^java.awt.image.RenderedImage this ^java.awt.image.WritableRaster raster]
...
(defn get-property
  ...
  ([^java.awt.image.RenderedImage this ^java.lang.String name]
