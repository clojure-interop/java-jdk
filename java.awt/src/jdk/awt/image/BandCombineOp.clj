...
(defn ->band-combine-op
  ...
  (^BandCombineOp [matrix ^java.awt.RenderingHints hints]
...
(defn filter
  ...
  (^java.awt.image.WritableRaster [^BandCombineOp this ^java.awt.image.Raster src ^java.awt.image.WritableRaster dst]
    (-> this (.filter src dst))))
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^BandCombineOp this ^java.awt.image.Raster src]
...
(defn create-compatible-dest-raster
  ...
  (^java.awt.image.WritableRaster [^BandCombineOp this ^java.awt.image.Raster src]
...
(defn get-point-2-d
  ...
  (^java.awt.geom.Point2D [^BandCombineOp this ^java.awt.geom.Point2D src-pt ^java.awt.geom.Point2D dst-pt]
...
(defn get-rendering-hints
  ...
  (^java.awt.RenderingHints [^BandCombineOp this]
