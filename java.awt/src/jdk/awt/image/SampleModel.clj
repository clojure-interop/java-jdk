...
(defn ->sample-model
  ...
  (^SampleModel [^Integer data-type ^Integer w ^Integer h ^Integer num-bands]
...
(defn get-sample-float
  ...
  (^Float [^SampleModel this ^Integer x ^Integer y ^Integer b ^java.awt.image.DataBuffer data]
...
(defn create-data-buffer
  ...
  (^java.awt.image.DataBuffer [^SampleModel this]
...
(defn get-data-elements
  ...
  throws: java.lang.NullPointerException - if data is null."
  (^java.lang.Object [^SampleModel this ^Integer x ^Integer y ^Integer w ^Integer h ^java.lang.Object obj ^java.awt.image.DataBuffer data]
    (-> this (.getDataElements x y w h obj data)))
  (^java.lang.Object [^SampleModel this ^Integer x ^Integer y ^java.lang.Object obj ^java.awt.image.DataBuffer data]
...
(defn create-subset-sample-model
  ...
  (^java.awt.image.SampleModel [^SampleModel this bands]
...
(defn get-pixels
  ...
  throws: java.lang.NullPointerException - if data is null."
  ([^SampleModel this ^Integer x ^Integer y ^Integer w ^Integer h i-array ^java.awt.image.DataBuffer data]
...
(defn get-sample-double
  ...
  throws: java.lang.NullPointerException - if data is null."
  (^Double [^SampleModel this ^Integer x ^Integer y ^Integer b ^java.awt.image.DataBuffer data]
...
(defn get-sample
  ...
  throws: java.lang.NullPointerException - if data is null."
  (^Integer [^SampleModel this ^Integer x ^Integer y ^Integer b ^java.awt.image.DataBuffer data]
...
(defn set-sample
  ...
  throws: java.lang.NullPointerException - if data is null."
  ([^SampleModel this ^Integer x ^Integer y ^Integer b ^Integer s ^java.awt.image.DataBuffer data]
...
(defn set-pixel
  ...
  throws: java.lang.NullPointerException - if iArray or data is null."
  ([^SampleModel this ^Integer x ^Integer y i-array ^java.awt.image.DataBuffer data]
...
(defn get-sample-size
  ...
  (^Integer [^SampleModel this ^Integer band]
...
(defn create-compatible-sample-model
  ...
  (^java.awt.image.SampleModel [^SampleModel this ^Integer w ^Integer h]
...
(defn set-data-elements
  ...
  throws: java.lang.NullPointerException - if data is null."
  ([^SampleModel this ^Integer x ^Integer y ^Integer w ^Integer h ^java.lang.Object obj ^java.awt.image.DataBuffer data]
    (-> this (.setDataElements x y w h obj data)))
  ([^SampleModel this ^Integer x ^Integer y ^java.lang.Object obj ^java.awt.image.DataBuffer data]
...
(defn set-samples
  ...
  throws: java.lang.NullPointerException - if iArray or data is null."
  ([^SampleModel this ^Integer x ^Integer y ^Integer w ^Integer h ^Integer b i-array ^java.awt.image.DataBuffer data]
