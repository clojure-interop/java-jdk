...
(defn get-interpolation-type
  ...
  (^Integer [^AffineTransformOp this]
...
(defn filter
  ...
  (^java.awt.image.BufferedImage [^AffineTransformOp this ^java.awt.image.BufferedImage src ^java.awt.image.BufferedImage dst]
    (-> this (.filter src dst))))
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^AffineTransformOp this ^java.awt.image.BufferedImage src]
...
(defn create-compatible-dest-image
  ...
  (^java.awt.image.BufferedImage [^AffineTransformOp this ^java.awt.image.BufferedImage src ^java.awt.image.ColorModel dest-cm]
...
(defn create-compatible-dest-raster
  ...
  (^java.awt.image.WritableRaster [^AffineTransformOp this ^java.awt.image.Raster src]
...
(defn get-point-2-d
  ...
  (^java.awt.geom.Point2D [^AffineTransformOp this ^java.awt.geom.Point2D src-pt ^java.awt.geom.Point2D dst-pt]
...
(defn get-transform
  ...
  (^java.awt.geom.AffineTransform [^AffineTransformOp this]
    (-> this (.getTransform))))
...
(defn get-rendering-hints
  ...
  (^java.awt.RenderingHints [^AffineTransformOp this]
