...
(defn filter
  ...
  (^java.awt.image.WritableRaster [^RasterOp this ^java.awt.image.Raster src ^java.awt.image.WritableRaster dest]
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^RasterOp this ^java.awt.image.Raster src]
...
(defn create-compatible-dest-raster
  ...
  (^java.awt.image.WritableRaster [^RasterOp this ^java.awt.image.Raster src]
...
(defn get-point-2-d
  ...
  (^java.awt.geom.Point2D [^RasterOp this ^java.awt.geom.Point2D src-pt ^java.awt.geom.Point2D dst-pt]
...
(defn get-rendering-hints
  ...
  (^java.awt.RenderingHints [^RasterOp this]
