...
(defn ->multi-pixel-packed-sample-model
  ...
  (^MultiPixelPackedSampleModel [^Integer data-type ^Integer w ^Integer h ^Integer number-of-bits ^Integer scanline-stride ^Integer data-bit-offset]
    (new MultiPixelPackedSampleModel data-type w h number-of-bits scanline-stride data-bit-offset))
  (^MultiPixelPackedSampleModel [^Integer data-type ^Integer w ^Integer h ^Integer number-of-bits]
...
(defn get-pixel-bit-stride
  ...
  (^Integer [^MultiPixelPackedSampleModel this]
...
(defn get-bit-offset
  ...
  (^Integer [^MultiPixelPackedSampleModel this ^Integer x]
    (-> this (.getBitOffset x))))
...
(defn create-data-buffer
  ...
  (^java.awt.image.DataBuffer [^MultiPixelPackedSampleModel this]
...
(defn get-data-elements
  ...
  (^java.lang.Object [^MultiPixelPackedSampleModel this ^Integer x ^Integer y ^java.lang.Object obj ^java.awt.image.DataBuffer data]
...
(defn create-subset-sample-model
  ...
  (^java.awt.image.SampleModel [^MultiPixelPackedSampleModel this bands]
...
(defn get-offset
  ...
  (^Integer [^MultiPixelPackedSampleModel this ^Integer x ^Integer y]
    (-> this (.getOffset x y))))
...
(defn get-sample
  ...
  (^Integer [^MultiPixelPackedSampleModel this ^Integer x ^Integer y ^Integer b ^java.awt.image.DataBuffer data]
...
(defn set-sample
  ...
  ([^MultiPixelPackedSampleModel this ^Integer x ^Integer y ^Integer b ^Integer s ^java.awt.image.DataBuffer data]
...
(defn set-pixel
  ...
  data - the DataBuffer containing the image data - `java.awt.image.DataBuffer`"
  ([^MultiPixelPackedSampleModel this ^Integer x ^Integer y i-array ^java.awt.image.DataBuffer data]
...
(defn get-sample-size
  ...
  (^Integer [^MultiPixelPackedSampleModel this ^Integer band]
    (-> this (.getSampleSize band)))
  ([^MultiPixelPackedSampleModel this]
    (-> this (.getSampleSize))))
...
(defn create-compatible-sample-model
  ...
  (^java.awt.image.SampleModel [^MultiPixelPackedSampleModel this ^Integer w ^Integer h]
...
(defn set-data-elements
  ...
  data - the DataBuffer containing the image data - `java.awt.image.DataBuffer`"
  ([^MultiPixelPackedSampleModel this ^Integer x ^Integer y ^java.lang.Object obj ^java.awt.image.DataBuffer data]
...
(defn equals
  ...
  (^Boolean [^MultiPixelPackedSampleModel this ^java.lang.Object o]
    (-> this (.equals o))))
