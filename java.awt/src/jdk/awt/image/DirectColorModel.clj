...
(defn ->direct-color-model
  ...
  (^DirectColorModel [^java.awt.color.ColorSpace space ^Integer bits ^Integer rmask ^Integer gmask ^Integer bmask ^Integer amask ^Boolean is-alpha-premultiplied ^Integer transfer-type]
    (new DirectColorModel space bits rmask gmask bmask amask is-alpha-premultiplied transfer-type))
  (^DirectColorModel [^Integer bits ^Integer rmask ^Integer gmask ^Integer bmask ^Integer amask]
    (new DirectColorModel bits rmask gmask bmask amask))
  (^DirectColorModel [^Integer bits ^Integer rmask ^Integer gmask ^Integer bmask]
...
(defn get-data-element
  ...
  (^Integer [^DirectColorModel this components ^Integer offset]
...
(defn get-rgb
  ...
  returns: the RGB value of the color/alpha components of the specified
           pixel. - `int`"
  (^Integer [^DirectColorModel this ^Integer pixel]
    (-> this (.getRGB pixel))))
...
(defn get-data-elements
  ...
  (^java.lang.Object [^DirectColorModel this components ^Integer offset ^java.lang.Object obj]
    (-> this (.getDataElements components offset obj)))
  (^java.lang.Object [^DirectColorModel this ^Integer rgb ^java.lang.Object pixel]
...
(defn to-string
  ...
  (^java.lang.String [^DirectColorModel this]
    (-> this (.toString))))
...
(defn get-components
  ...
  ([^DirectColorModel this ^Integer pixel components ^Integer offset]
...
(defn compatible-raster?
  ...
  (^Boolean [^DirectColorModel this ^java.awt.image.Raster raster]
...
(defn coerce-data
  ...
  (^java.awt.image.ColorModel [^DirectColorModel this ^java.awt.image.WritableRaster raster ^Boolean is-alpha-premultiplied]
...
(defn create-compatible-writable-raster
  ...
  (^java.awt.image.WritableRaster [^DirectColorModel this ^Integer w ^Integer h]
