...
(defn set-rect
  ...
  ([^WritableRaster this ^Integer dx ^Integer dy ^java.awt.image.Raster src-raster]
    (-> this (.setRect dx dy src-raster)))
  ([^WritableRaster this ^java.awt.image.Raster src-raster]
...
(defn get-writable-parent
  ...
  (^java.awt.image.WritableRaster [^WritableRaster this]
...
(defn set-pixels
  ...
  ([^WritableRaster this ^Integer x ^Integer y ^Integer w ^Integer h i-array]
...
(defn set-sample
  ...
  ([^WritableRaster this ^Integer x ^Integer y ^Integer b ^Integer s]
...
(defn set-pixel
  ...
  throws: java.lang.NullPointerException - if iArray is null."
  ([^WritableRaster this ^Integer x ^Integer y i-array]
...
(defn set-data-elements
  ...
  ([^WritableRaster this ^Integer x ^Integer y ^Integer w ^Integer h ^java.lang.Object in-data]
    (-> this (.setDataElements x y w h in-data)))
  ([^WritableRaster this ^Integer x ^Integer y ^java.lang.Object in-data]
...
(defn set-samples
  ...
  throws: java.lang.NullPointerException - if iArray is null."
  ([^WritableRaster this ^Integer x ^Integer y ^Integer w ^Integer h ^Integer b i-array]
...
(defn create-writable-translated-child
  ...
  (^java.awt.image.WritableRaster [^WritableRaster this ^Integer child-min-x ^Integer child-min-y]
...
(defn create-writable-child
  ...
  (^java.awt.image.WritableRaster [^WritableRaster this ^Integer parent-x ^Integer parent-y ^Integer w ^Integer h ^Integer child-min-x ^Integer child-min-y band-list]
