...
(defn ->renderable-image-producer
  ...
  (^RenderableImageProducer [^java.awt.image.renderable.RenderableImage rdbl-image ^java.awt.image.renderable.RenderContext rc]
...
(defn set-render-context
  ...
  ([^RenderableImageProducer this ^java.awt.image.renderable.RenderContext rc]
...
(defn add-consumer
  ...
  ([^RenderableImageProducer this ^java.awt.image.ImageConsumer ic]
    (-> this (.addConsumer ic))))
...
(defn consumer?
  ...
  (^Boolean [^RenderableImageProducer this ^java.awt.image.ImageConsumer ic]
    (-> this (.isConsumer ic))))
