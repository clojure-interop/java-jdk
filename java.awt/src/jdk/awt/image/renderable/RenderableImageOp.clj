...
(defn set-parameter-block
  ...
  ([^java.awt.image.renderable.RenderableImageOp this ^java.awt.image.renderable.ParameterBlock param-block]
...
(defn get-property
  ...
  ([^java.awt.image.renderable.RenderableImageOp this ^java.lang.String name]
...
(defn create-rendering
  ...
  ([^java.awt.image.renderable.RenderableImageOp this ^java.awt.image.renderable.RenderContext render-context]
...
(defn create-scaled-rendering
  ...
  returns: a RenderedImage containing the rendered data. - `java.awt.image.RenderedImage`"
  ([^java.awt.image.renderable.RenderableImageOp this ^Integer w ^Integer h ^java.awt.RenderingHints hints]
