...
(defn get-property
  ...
  ([^java.awt.image.renderable.RenderableImage this ^java.lang.String name]
...
(defn create-rendering
  ...
  returns: a RenderedImage containing the rendered data. - `java.awt.image.RenderedImage`"
  ([^java.awt.image.renderable.RenderableImage this ^java.awt.image.renderable.RenderContext render-context]
...
(defn create-scaled-rendering
  ...
  returns: a RenderedImage containing the rendered data. - `java.awt.image.RenderedImage`"
  ([^java.awt.image.renderable.RenderableImage this ^Integer w ^Integer h ^java.awt.RenderingHints hints]
