...
(defn filter
  ...
  (^java.awt.image.BufferedImage [^java.awt.image.BufferedImageOp this ^java.awt.image.BufferedImage src ^java.awt.image.BufferedImage dest]
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^java.awt.image.BufferedImageOp this ^java.awt.image.BufferedImage src]
...
(defn create-compatible-dest-image
  ...
  (^java.awt.image.BufferedImage [^java.awt.image.BufferedImageOp this ^java.awt.image.BufferedImage src ^java.awt.image.ColorModel dest-cm]
...
(defn get-point-2-d
  ...
  (^java.awt.geom.Point2D [^java.awt.image.BufferedImageOp this ^java.awt.geom.Point2D src-pt ^java.awt.geom.Point2D dst-pt]
...
(defn get-rendering-hints
  ...
  (^java.awt.RenderingHints [^java.awt.image.BufferedImageOp this]
