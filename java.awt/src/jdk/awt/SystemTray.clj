...
(defn add
  ...
  ([^SystemTray this ^java.awt.TrayIcon tray-icon]
    (-> this (.add tray-icon))))
...
(defn get-tray-icon-size
  ...
  (^java.awt.Dimension [^SystemTray this]
...
(defn add-property-change-listener
  ...
  ([^SystemTray this ^java.lang.String property-name ^java.beans.PropertyChangeListener listener]
...
(defn get-property-change-listeners
  ...
  ([^SystemTray this ^java.lang.String property-name]
