...
(defn ->float
  ...
  ([^Float x-1 ^Float y-1 ^Float ctrlx ^Float ctrly ^Float x-2 ^Float y-2]
...
(defn get-x-1
  ...
  ([^java.awt.geom.QuadCurve2D$Float this]
    (-> this (.getX1))))
...
(defn set-curve
  ...
  ([^java.awt.geom.QuadCurve2D$Float this ^Double x-1 ^Double y-1 ^Double ctrlx ^Double ctrly ^Double x-2 ^Double y-2]
