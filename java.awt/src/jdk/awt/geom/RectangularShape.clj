...
(defn set-frame-from-diagonal
  ...
  ([^RectangularShape this ^Double x-1 ^Double y-1 ^Double x-2 ^Double y-2]
    (-> this (.setFrameFromDiagonal x-1 y-1 x-2 y-2)))
  ([^RectangularShape this ^java.awt.geom.Point2D p-1 ^java.awt.geom.Point2D p-2]
...
(defn get-path-iterator
  ...
  (^java.awt.geom.PathIterator [^RectangularShape this ^java.awt.geom.AffineTransform at ^Double flatness]
...
(defn get-frame
  ...
  (^java.awt.geom.Rectangle2D [^RectangularShape this]
    (-> this (.getFrame))))
...
(defn contains
  ...
  (^Boolean [^RectangularShape this ^java.awt.geom.Point2D p]
    (-> this (.contains p))))
...
(defn set-frame-from-center
  ...
  ([^RectangularShape this ^Double center-x ^Double center-y ^Double corner-x ^Double corner-y]
    (-> this (.setFrameFromCenter center-x center-y corner-x corner-y)))
  ([^RectangularShape this ^java.awt.geom.Point2D center ^java.awt.geom.Point2D corner]
...
(defn clone
  ...
  (^java.lang.Object [^RectangularShape this]
    (-> this (.clone))))
...
(defn get-bounds
  ...
  (^java.awt.Rectangle [^RectangularShape this]
    (-> this (.getBounds))))
...
(defn set-frame
  ...
  ([^RectangularShape this ^Double x ^Double y ^Double w ^Double h]
    (-> this (.setFrame x y w h)))
  ([^RectangularShape this ^java.awt.geom.Point2D loc ^java.awt.geom.Dimension2D size]
    (-> this (.setFrame loc size)))
  ([^RectangularShape this ^java.awt.geom.Rectangle2D r]
    (-> this (.setFrame r))))
...
(defn intersects
  ...
  returns: true if the interior of the Shape and
            ...
            otherwise. - `boolean`"
  (^Boolean [^RectangularShape this ^java.awt.geom.Rectangle2D r]
    (-> this (.intersects r))))
