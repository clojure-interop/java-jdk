...
(defn contains
  ...
  returns: true if the interior of the Shape
            ...
            perform. - `boolean`"
  (^Boolean [^java.awt.geom.Ellipse2D this ^Double x ^Double y ^Double w ^Double h]
    (-> this (.contains x y w h)))
  (^Boolean [^java.awt.geom.Ellipse2D this ^Double x ^Double y]
    (-> this (.contains x y))))
...
(defn get-path-iterator
  ...
  (^java.awt.geom.PathIterator [^java.awt.geom.Ellipse2D this ^java.awt.geom.AffineTransform at]
...
(defn hash-code
  ...
  (^Integer [^java.awt.geom.Ellipse2D this]
    (-> this (.hashCode))))
...
(defn equals
  ...
  (^Boolean [^java.awt.geom.Ellipse2D this ^java.lang.Object obj]
    (-> this (.equals obj))))
