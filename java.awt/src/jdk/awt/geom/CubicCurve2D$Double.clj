...
(defn ->double
  ...
  (^CubicCurve2D$Double [^Double x-1 ^Double y-1 ^Double ctrlx-1 ^Double ctrly-1 ^Double ctrlx-2 ^Double ctrly-2 ^Double x-2 ^Double y-2]
...
(defn get-p-1
  ...
  (^java.awt.geom.Point2D [^CubicCurve2D$Double this]
    (-> this (.getP1))))
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^CubicCurve2D$Double this]
    (-> this (.getBounds2D))))
...
(defn set-curve
  ...
  ([^CubicCurve2D$Double this ^Double x-1 ^Double y-1 ^Double ctrlx-1 ^Double ctrly-1 ^Double ctrlx-2 ^Double ctrly-2 ^Double x-2 ^Double y-2]
