...
(defn ->affine-transform
  ...
  (^AffineTransform [^Float m-00 ^Float m-10 ^Float m-01 ^Float m-11 ^Float m-02 ^Float m-12]
...
(defn translate
  ...
  tx - the distance by which coordinates are translated in the X axis direction - `double`
  ty - the distance by which coordinates are translated in the Y axis direction - `double`"
  ([^AffineTransform this ^Double tx ^Double ty]
...
(defn scale
  ...
  sx - the factor by which coordinates are scaled along the X axis direction - `double`
  sy - the factor by which coordinates are scaled along the Y axis direction - `double`"
  ([^AffineTransform this ^Double sx ^Double sy]
    (-> this (.scale sx sy))))
...
(defn delta-transform
  ...
  ([^AffineTransform this src-pts ^Integer src-off dst-pts ^Integer dst-off ^Integer num-pts]
    (-> this (.deltaTransform src-pts src-off dst-pts dst-off num-pts)))
  (^java.awt.geom.Point2D [^AffineTransform this ^java.awt.geom.Point2D pt-src ^java.awt.geom.Point2D pt-dst]
...
(defn transform
  ...
  ([^AffineTransform this pt-src ^Integer src-off pt-dst ^Integer dst-off ^Integer num-pts]
...
(defn to-string
  ...
  (^java.lang.String [^AffineTransform this]
    (-> this (.toString))))
...
(defn set-to-shear
  ...
  shx - the multiplier by which coordinates are shifted in the direction of the positive X axis as a factor of their Y coordinate - `double`
  shy - the multiplier by which coordinates are shifted in the direction of the positive Y axis as a factor of their X coordinate - `double`"
  ([^AffineTransform this ^Double shx ^Double shy]
...
(defn create-inverse
  ...
  throws: java.awt.geom.NoninvertibleTransformException - if the matrix cannot be inverted."
  (^java.awt.geom.AffineTransform [^AffineTransform this]
    (-> this (.createInverse))))
...
(defn set-to-rotation
  ...
  anchorx - the X coordinate of the rotation anchor point - `double`
  anchory - the Y coordinate of the rotation anchor point - `double`"
  ([^AffineTransform this ^Double vecx ^Double vecy ^Double anchorx ^Double anchory]
    (-> this (.setToRotation vecx vecy anchorx anchory)))
  ([^AffineTransform this ^Double theta ^Double anchorx ^Double anchory]
    (-> this (.setToRotation theta anchorx anchory)))
  ([^AffineTransform this ^Double vecx ^Double vecy]
    (-> this (.setToRotation vecx vecy)))
  ([^AffineTransform this ^Double theta]
...
(defn quadrant-rotate
  ...
  anchorx - the X coordinate of the rotation anchor point - `double`
  anchory - the Y coordinate of the rotation anchor point - `double`"
  ([^AffineTransform this ^Integer numquadrants ^Double anchorx ^Double anchory]
    (-> this (.quadrantRotate numquadrants anchorx anchory)))
  ([^AffineTransform this ^Integer numquadrants]
...
(defn pre-concatenate
  ...
  ([^AffineTransform this ^java.awt.geom.AffineTransform tx]
...
(defn create-transformed-shape
  ...
  (^java.awt.Shape [^AffineTransform this ^java.awt.Shape p-src]
...
(defn clone
  ...
  (^java.lang.Object [^AffineTransform this]
    (-> this (.clone))))
...
(defn set-transform
  ...
  ([^AffineTransform this ^Double m-00 ^Double m-10 ^Double m-01 ^Double m-11 ^Double m-02 ^Double m-12]
...
(defn get-matrix
  ...
  ([^AffineTransform this flatmatrix]
...
(defn equals
  ...
  (^Boolean [^AffineTransform this ^java.lang.Object obj]
    (-> this (.equals obj))))
