...
(defn ->double
  ...
  (^Path2D$Double [^Integer rule ^Integer initial-capacity]
    (new Path2D$Double rule initial-capacity))
  (^Path2D$Double [^Integer rule]
    (new Path2D$Double rule))
  (^Path2D$Double []
    (new Path2D$Double )))
...
(defn get-path-iterator
  ...
  at - an AffineTransform - `java.awt.geom.AffineTransform`
  ...
  (^java.awt.geom.PathIterator [^Path2D$Double this ^java.awt.geom.AffineTransform at]
...
(defn line-to
  ...
  ([^Path2D$Double this ^Double x ^Double y]
    (-> this (.lineTo x y))))
...
(defn transform
  ...
  ([^Path2D$Double this ^java.awt.geom.AffineTransform at]
    (-> this (.transform at))))
...
(defn curve-to
  ...
  ([^Path2D$Double this ^Double x-1 ^Double y-1 ^Double x-2 ^Double y-2 ^Double x-3 ^Double y-3]
...
(defn get-bounds-2-d
  ...
  (^java.awt.geom.Rectangle2D [^Path2D$Double this]
    (-> this (.getBounds2D))))
...
(defn append
  ...
  ([^Path2D$Double this ^java.awt.geom.PathIterator pi ^Boolean connect]
...
(defn clone
  ...
  (^java.lang.Object [^Path2D$Double this]
    (-> this (.clone))))
...
(defn quad-to
  ...
  ([^Path2D$Double this ^Double x-1 ^Double y-1 ^Double x-2 ^Double y-2]
