...
(defn to-instant
  ...
  ([^ChronoLocalDateTime this ^java.time.ZoneOffset offset]
...
(defn is-equal
  ...
  ([^ChronoLocalDateTime this ^java.time.chrono.ChronoLocalDateTime other]
    (-> this (.isEqual other))))
...
(defn plus
  ...
  (^java.time.chrono.ChronoLocalDateTime [^ChronoLocalDateTime this ^Long amount-to-add ^java.time.temporal.TemporalUnit unit]
    (-> this (.plus amount-to-add unit)))
  ([^ChronoLocalDateTime this ^java.time.temporal.TemporalAmount amount]
    (-> this (.plus amount))))
...
(defn query
  ...
  ([^ChronoLocalDateTime this ^java.time.temporal.TemporalQuery query]
    (-> this (.query query))))
...
(defn to-string
  ...
  (^java.lang.String [^ChronoLocalDateTime this]
    (-> this (.toString))))
...
(defn minus
  ...
  ([^ChronoLocalDateTime this ^Long amount-to-subtract ^java.time.temporal.TemporalUnit unit]
...
(defn at-zone
  ...
  (^java.time.chrono.ChronoZonedDateTime [^ChronoLocalDateTime this ^java.time.ZoneId zone]
    (-> this (.atZone zone))))
...
(defn to-local-time
  ...
  (^java.time.LocalTime [^ChronoLocalDateTime this]
    (-> this (.toLocalTime))))
...
(defn supported?
  ...
  (^Boolean [^ChronoLocalDateTime this ^java.time.temporal.TemporalField field]
...
(defn hash-code
  ...
  (^Integer [^ChronoLocalDateTime this]
    (-> this (.hashCode))))
...
(defn adjust-into
  ...
  ([^ChronoLocalDateTime this ^java.time.temporal.Temporal temporal]
...
(defn with
  ...
  (^java.time.chrono.ChronoLocalDateTime [^ChronoLocalDateTime this ^java.time.temporal.TemporalField field ^Long new-value]
    (-> this (.with field new-value)))
  ([^ChronoLocalDateTime this ^java.time.temporal.TemporalAdjuster adjuster]
    (-> this (.with adjuster))))
...
(defn equals
  ...
  (^Boolean [^ChronoLocalDateTime this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn format
  ...
  ([^ChronoLocalDateTime this ^java.time.format.DateTimeFormatter formatter]
