...
(defn *now
  ...
  (^java.time.chrono.ThaiBuddhistDate [^java.time.ZoneId zone]
...
(defn *of
  ...
  (^java.time.chrono.ThaiBuddhistDate [^Integer proleptic-year ^Integer month ^Integer day-of-month]
...
(defn *from
  ...
  (^java.time.chrono.ThaiBuddhistDate [^java.time.temporal.TemporalAccessor temporal]
