...
(defn multiplied-by
  ...
  (^java.time.Period [^java.time.Period this ^Integer scalar]
...
(defn with-days
  ...
  (^java.time.Period [^java.time.Period this ^Integer days]
    (-> this (.withDays days))))
...
(defn with-years
  ...
  (^java.time.Period [^java.time.Period this ^Integer years]
...
(defn with-months
  ...
  (^java.time.Period [^java.time.Period this ^Integer months]
...
(defn get
  ...
  (^Long [^java.time.Period this ^java.time.temporal.TemporalUnit unit]
    (-> this (.get unit))))
...
(defn equals
  ...
  (^Boolean [^java.time.Period this ^java.lang.Object obj]
    (-> this (.equals obj))))
