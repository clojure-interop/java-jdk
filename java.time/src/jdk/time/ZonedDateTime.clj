...
(defn truncated-to
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^java.time.temporal.TemporalUnit unit]
...
(defn get-hour
  ...
  (^Integer [^java.time.ZonedDateTime this]
    (-> this (.getHour))))
...
(defn with-month
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer month]
...
(defn plus
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Long amount-to-add ^java.time.temporal.TemporalUnit unit]
...
(defn with-hour
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer hour]
    (-> this (.withHour hour))))
...
(defn with-minute
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer minute]
...
(defn minus
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Long amount-to-subtract ^java.time.temporal.TemporalUnit unit]
...
(defn with-year
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer year]
    (-> this (.withYear year))))
...
(defn with-nano
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer nano-of-second]
...
(defn until
  ...
  (^Long [^java.time.ZonedDateTime this ^java.time.temporal.Temporal end-exclusive ^java.time.temporal.TemporalUnit unit]
...
(defn with-day-of-month
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer day-of-month]
...
(defn supported?
  ...
  (^Boolean [^java.time.ZonedDateTime this ^java.time.temporal.TemporalField field]
...
(defn with-second
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer second]
...
(defn with-day-of-year
  ...
  (^java.time.ZonedDateTime [^java.time.ZonedDateTime this ^Integer day-of-year]
...
(defn get
  ...
  (^Integer [^java.time.ZonedDateTime this ^java.time.temporal.TemporalField field]
    (-> this (.get field))))
...
(defn equals
  ...
  (^Boolean [^java.time.ZonedDateTime this ^java.lang.Object obj]
    (-> this (.equals obj))))
