...
(defn get-range-unit
  ...
  (^java.time.temporal.TemporalUnit [^java.time.temporal.ChronoField this]
    (-> this (.getRangeUnit))))
...
(defn check-valid-int-value
  ...
  (^Integer [^java.time.temporal.ChronoField this ^Long value]
...
(defn date-based?
  ...
  (^Boolean [^java.time.temporal.ChronoField this]
    (-> this (.isDateBased))))
...
(defn supported-by?
  ...
  (^Boolean [^java.time.temporal.ChronoField this ^java.time.temporal.TemporalAccessor temporal]
