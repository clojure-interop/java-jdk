...
(defn supported?
  ...
  (^Boolean [^Temporal this ^java.time.temporal.TemporalUnit unit]
...
(defn with
  ...
  (^java.time.temporal.Temporal [^Temporal this ^java.time.temporal.TemporalField field ^Long new-value]
    (-> this (.with field new-value)))
  ([^Temporal this ^java.time.temporal.TemporalAdjuster adjuster]
    (-> this (.with adjuster))))
...
(defn plus
  ...
  (^java.time.temporal.Temporal [^Temporal this ^Long amount-to-add ^java.time.temporal.TemporalUnit unit]
    (-> this (.plus amount-to-add unit)))
  ([^Temporal this ^java.time.temporal.TemporalAmount amount]
    (-> this (.plus amount))))
...
(defn minus
  ...
  ([^Temporal this ^Long amount-to-subtract ^java.time.temporal.TemporalUnit unit]
...
(defn until
  ...
  (^Long [^Temporal this ^java.time.temporal.Temporal end-exclusive ^java.time.temporal.TemporalUnit unit]
