...
(defn get-duration
  ...
  (^java.time.Duration [^TemporalUnit this]
    (-> this (.getDuration))))
...
(defn is-supported-by
  ...
  ([^TemporalUnit this ^java.time.temporal.Temporal temporal]
...
(defn add-to
  ...
  ([^TemporalUnit this temporal ^Long amount]
...
(defn between
  ...
  (^Long [^TemporalUnit this ^java.time.temporal.Temporal temporal-1-inclusive ^java.time.temporal.Temporal temporal-2-exclusive]
...
(defn to-string
  ...
  (^java.lang.String [^TemporalUnit this]
    (-> this (.toString))))
