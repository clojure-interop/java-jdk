...
(defn get
  ...
  ([^java.time.temporal.TemporalAmount this ^java.time.temporal.TemporalUnit unit]
    (-> this (.get unit))))
...
(defn add-to
  ...
  ([^java.time.temporal.TemporalAmount this ^java.time.temporal.Temporal temporal]
    (-> this (.addTo temporal))))
