...
(defn *of
  ...
  standard-offset-transition-list - the list of changes to the standard offset, not null - `java.util.List`
  transition-list - the list of transitions, not null - `java.util.List`
  last-rules - the recurring last rules, size 16 or less, not null - `java.util.List`
...
(defn get-standard-offset
  ...
  (^java.time.ZoneOffset [^ZoneRules this ^java.time.Instant instant]
...
(defn get-daylight-savings
  ...
  (^java.time.Duration [^ZoneRules this ^java.time.Instant instant]
...
(defn next-transition
  ...
  (^java.time.zone.ZoneOffsetTransition [^ZoneRules this ^java.time.Instant instant]
...
(defn get-transition
  ...
  (^java.time.zone.ZoneOffsetTransition [^ZoneRules this ^java.time.LocalDateTime local-date-time]
...
(defn to-string
  ...
  (^java.lang.String [^ZoneRules this]
    (-> this (.toString))))
...
(defn get-valid-offsets
  ...
  (^java.util.List [^ZoneRules this ^java.time.LocalDateTime local-date-time]
...
(defn daylight-savings?
  ...
  (^Boolean [^ZoneRules this ^java.time.Instant instant]
...
(defn valid-offset?
  ...
  (^Boolean [^ZoneRules this ^java.time.LocalDateTime local-date-time ^java.time.ZoneOffset offset]
...
(defn equals
  ...
  (^Boolean [^ZoneRules this ^java.lang.Object other-rules]
