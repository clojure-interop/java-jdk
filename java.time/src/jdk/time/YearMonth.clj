...
(defn length-of-year
  ...
  (^Integer [^java.time.YearMonth this]
    (-> this (.lengthOfYear))))
...
(defn valid-day?
  ...
  (^Boolean [^java.time.YearMonth this ^Integer day-of-month]
...
(defn with-month
  ...
  (^java.time.YearMonth [^java.time.YearMonth this ^Integer month]
...
(defn at-day
  ...
  (^java.time.LocalDate [^java.time.YearMonth this ^Integer day-of-month]
...
(defn plus
  ...
  (^java.time.YearMonth [^java.time.YearMonth this ^Long amount-to-add ^java.time.temporal.TemporalUnit unit]
...
(defn leap-year?
  ...
  (^Boolean [^java.time.YearMonth this]
    (-> this (.isLeapYear))))
...
(defn before?
  ...
  (^Boolean [^java.time.YearMonth this ^java.time.YearMonth other]
    (-> this (.isBefore other))))
...
(defn minus
  ...
  (^java.time.YearMonth [^java.time.YearMonth this ^Long amount-to-subtract ^java.time.temporal.TemporalUnit unit]
...
(defn with-year
  ...
  throws: java.time.DateTimeException - if the year value is invalid"
  (^java.time.YearMonth [^java.time.YearMonth this ^Integer year]
    (-> this (.withYear year))))
...
(defn until
  ...
  (^Long [^java.time.YearMonth this ^java.time.temporal.Temporal end-exclusive ^java.time.temporal.TemporalUnit unit]
...
(defn supported?
  ...
  (^Boolean [^java.time.YearMonth this ^java.time.temporal.TemporalField field]
...
(defn compare-to
  ...
  (^Integer [^java.time.YearMonth this ^java.time.YearMonth other]
...
(defn get
  ...
  (^Integer [^java.time.YearMonth this ^java.time.temporal.TemporalField field]
    (-> this (.get field))))
...
(defn equals
  ...
  (^Boolean [^java.time.YearMonth this ^java.lang.Object obj]
    (-> this (.equals obj))))
