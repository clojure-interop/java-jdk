...
(defn *now
  ...
  (^java.time.YearMonth [^java.time.ZoneId zone]
    (YearMonth/now zone))
  (^java.time.YearMonth []
    (YearMonth/now )))
...
(defn *of
  ...
  (^java.time.YearMonth [^Integer year ^java.time.Month month]
...
(defn range
  ...
  (^java.time.temporal.ValueRange [^YearMonth this ^java.time.temporal.TemporalField field]
    (-> this (.range field))))
...
(defn valid-day?
  ...
  (^Boolean [^YearMonth this ^Integer day-of-month]
...
(defn with-month
  ...
  (^java.time.YearMonth [^YearMonth this ^Integer month]
...
(defn at-day
  ...
  (^java.time.LocalDate [^YearMonth this ^Integer day-of-month]
...
(defn plus
  ...
  (^java.time.YearMonth [^YearMonth this ^Long amount-to-add ^java.time.temporal.TemporalUnit unit]
    (-> this (.plus amount-to-add unit)))
  (^java.time.YearMonth [^YearMonth this ^java.time.temporal.TemporalAmount amount-to-add]
...
(defn query
  ...
  ([^YearMonth this ^java.time.temporal.TemporalQuery query]
    (-> this (.query query))))
...
(defn to-string
  ...
  (^java.lang.String [^YearMonth this]
    (-> this (.toString))))
...
(defn plus-months
  ...
  (^java.time.YearMonth [^YearMonth this ^Long months-to-add]
...
(defn before?
  ...
  (^Boolean [^YearMonth this ^java.time.YearMonth other]
    (-> this (.isBefore other))))
...
(defn minus-months
  ...
  throws: java.time.DateTimeException - if the result exceeds the supported range"
  (^java.time.YearMonth [^YearMonth this ^Long months-to-subtract]
...
(defn minus
  ...
  (^java.time.YearMonth [^YearMonth this ^Long amount-to-subtract ^java.time.temporal.TemporalUnit unit]
    (-> this (.minus amount-to-subtract unit)))
  (^java.time.YearMonth [^YearMonth this ^java.time.temporal.TemporalAmount amount-to-subtract]
...
(defn get-long
  ...
  (^Long [^YearMonth this ^java.time.temporal.TemporalField field]
    (-> this (.getLong field))))
...
(defn with-year
  ...
  throws: java.time.DateTimeException - if the year value is invalid"
  (^java.time.YearMonth [^YearMonth this ^Integer year]
    (-> this (.withYear year))))
...
(defn at-end-of-month
  ...
  (^java.time.LocalDate [^YearMonth this]
    (-> this (.atEndOfMonth))))
...
(defn until
  ...
  (^Long [^YearMonth this ^java.time.temporal.Temporal end-exclusive ^java.time.temporal.TemporalUnit unit]
...
(defn supported?
  ...
  (^Boolean [^YearMonth this ^java.time.temporal.TemporalField field]
...
(defn minus-years
  ...
  throws: java.time.DateTimeException - if the result exceeds the supported range"
  (^java.time.YearMonth [^YearMonth this ^Long years-to-subtract]
...
(defn adjust-into
  ...
  (^java.time.temporal.Temporal [^YearMonth this ^java.time.temporal.Temporal temporal]
...
(defn with
  ...
  (^java.time.YearMonth [^YearMonth this ^java.time.temporal.TemporalField field ^Long new-value]
    (-> this (.with field new-value)))
  (^java.time.YearMonth [^YearMonth this ^java.time.temporal.TemporalAdjuster adjuster]
    (-> this (.with adjuster))))
...
(defn compare-to
  ...
  (^Integer [^YearMonth this ^java.time.YearMonth other]
...
(defn get-month
  ...
  (^java.time.Month [^YearMonth this]
    (-> this (.getMonth))))
...
(defn get
  ...
  (^Integer [^YearMonth this ^java.time.temporal.TemporalField field]
    (-> this (.get field))))
...
(defn equals
  ...
  (^Boolean [^YearMonth this ^java.lang.Object obj]
    (-> this (.equals obj))))
...
(defn format
  ...
  (^java.lang.String [^YearMonth this ^java.time.format.DateTimeFormatter formatter]
...
(defn plus-years
  ...
  throws: java.time.DateTimeException - if the result exceeds the supported range"
  (^java.time.YearMonth [^YearMonth this ^Long years-to-add]
