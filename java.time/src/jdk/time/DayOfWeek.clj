...
(defn range
  ...
  (^java.time.temporal.ValueRange [^DayOfWeek this ^java.time.temporal.TemporalField field]
    (-> this (.range field))))
...
(defn plus
  ...
  (^java.time.DayOfWeek [^DayOfWeek this ^Long days]
    (-> this (.plus days))))
...
(defn query
  ...
  ([^DayOfWeek this ^java.time.temporal.TemporalQuery query]
    (-> this (.query query))))
...
(defn get-display-name
  ...
  (^java.lang.String [^DayOfWeek this ^java.time.format.TextStyle style ^java.util.Locale locale]
...
(defn get-long
  ...
  (^Long [^DayOfWeek this ^java.time.temporal.TemporalField field]
    (-> this (.getLong field))))
...
(defn supported?
  ...
  (^Boolean [^DayOfWeek this ^java.time.temporal.TemporalField field]
...
(defn adjust-into
  ...
  (^java.time.temporal.Temporal [^DayOfWeek this ^java.time.temporal.Temporal temporal]
...
(defn get
  ...
  (^Integer [^DayOfWeek this ^java.time.temporal.TemporalField field]
    (-> this (.get field))))
