...
(defn get-image
  ...
  (^java.awt.Image [^Applet this ^java.net.URL url ^java.lang.String name]
    (-> this (.getImage url name)))
  (^java.awt.Image [^Applet this ^java.net.URL url]
    (-> this (.getImage url))))
...
(defn play
  ...
  ([^Applet this ^java.net.URL url ^java.lang.String name]
    (-> this (.play url name)))
  ([^Applet this ^java.net.URL url]
    (-> this (.play url))))
...
(defn set-stub
  ...
  ([^Applet this ^java.applet.AppletStub stub]
    (-> this (.setStub stub))))
...
(defn get-parameter
  ...
  (^java.lang.String [^Applet this ^java.lang.String name]
...
(defn get-accessible-context
  ...
  (^javax.accessibility.AccessibleContext [^Applet this]
...
(defn show-status
  ...
  ([^Applet this ^java.lang.String msg]
    (-> this (.showStatus msg))))
...
(defn get-applet-context
  ...
  (^java.applet.AppletContext [^Applet this]
...
(defn resize
  ...
  ([^Applet this ^Integer width ^Integer height]
    (-> this (.resize width height)))
  ([^Applet this ^java.awt.Dimension d]
    (-> this (.resize d))))
...
(defn get-audio-clip
  ...
  returns: the audio clip at the specified URL. - `java.applet.AudioClip`"
  (^java.applet.AudioClip [^Applet this ^java.net.URL url ^java.lang.String name]
    (-> this (.getAudioClip url name)))
  (^java.applet.AudioClip [^Applet this ^java.net.URL url]
