...
(defn get-display-name
  ...
  (^java.lang.String [^CalendarNameProvider this ^java.lang.String calendar-type ^Integer field ^Integer value ^Integer style ^java.util.Locale locale]
...
(defn get-display-names
  ...
  (^java.util.Map [^CalendarNameProvider this ^java.lang.String calendar-type ^Integer field ^Integer style ^java.util.Locale locale]
