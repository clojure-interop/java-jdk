...
(defn skip
  ...
  (^java.util.stream.DoubleStream [^DoubleStream this ^Long n]
    (-> this (.skip n))))
...
(defn map
  ...
  returns: the new stream - `java.util.stream.DoubleStream`"
  (^java.util.stream.DoubleStream [^DoubleStream this ^java.util.function.DoubleUnaryOperator mapper]
    (-> this (.map mapper))))
...
(defn peek
  ...
  returns: the new stream - `java.util.stream.DoubleStream`"
  (^java.util.stream.DoubleStream [^DoubleStream this ^java.util.function.DoubleConsumer action]
    (-> this (.peek action))))
...
(defn min
  ...
  (^java.util.OptionalDouble [^DoubleStream this]
    (-> this (.min))))
...
(defn spliterator
  ...
  (^java.util.Spliterator$OfDouble [^DoubleStream this]
    (-> this (.spliterator))))
...
(defn for-each
  ...
  ([^DoubleStream this ^java.util.function.DoubleConsumer action]
    (-> this (.forEach action))))
...
(defn *of
  ...
  (^java.util.stream.DoubleStream [^Double t]
    (DoubleStream/of t)))
...
(defn sequential
  ...
  (^java.util.stream.DoubleStream [^DoubleStream this]
    (-> this (.sequential))))
...
(defn all-match
  ...
  (^Boolean [^DoubleStream this ^java.util.function.DoublePredicate predicate]
...
(defn map-to-long
  ...
  (^java.util.stream.LongStream [^DoubleStream this ^java.util.function.DoubleToLongFunction mapper]
...
(defn *iterate
  ...
  (^java.util.stream.DoubleStream [^Double seed ^java.util.function.DoubleUnaryOperator f]
    (DoubleStream/iterate seed f)))
...
(defn *generate
  ...
  (^java.util.stream.DoubleStream [^java.util.function.DoubleSupplier s]
...
(defn iterator
  ...
  (^java.util.PrimitiveIterator$OfDouble [^DoubleStream this]
    (-> this (.iterator))))
...
(defn map-to-int
  ...
  (^java.util.stream.IntStream [^DoubleStream this ^java.util.function.DoubleToIntFunction mapper]
...
(defn boxed
  ...
  (^java.util.stream.Stream [^DoubleStream this]
    (-> this (.boxed))))
...
(defn limit
  ...
  (^java.util.stream.DoubleStream [^DoubleStream this ^Long max-size]
    (-> this (.limit max-size))))
...
(defn flat-map
  ...
  returns: the new stream - `java.util.stream.DoubleStream`"
  (^java.util.stream.DoubleStream [^DoubleStream this ^java.util.function.DoubleFunction mapper]
    (-> this (.flatMap mapper))))
...
(defn *concat
  ...
  (^java.util.stream.DoubleStream [^java.util.stream.DoubleStream a ^java.util.stream.DoubleStream b]
    (DoubleStream/concat a b)))
...
(defn filter
  ...
  returns: the new stream - `java.util.stream.DoubleStream`"
  (^java.util.stream.DoubleStream [^DoubleStream this ^java.util.function.DoublePredicate predicate]
...
(defn map-to-obj
  ...
  ([^DoubleStream this ^java.util.function.DoubleFunction mapper]
...
(defn summary-statistics
  ...
  (^java.util.DoubleSummaryStatistics [^DoubleStream this]
...
(defn collect
  ...
  ([^DoubleStream this ^java.util.function.Supplier supplier ^java.util.function.ObjDoubleConsumer accumulator ^java.util.function.BiConsumer combiner]
...
(defn reduce
  ...
  (^Double [^DoubleStream this ^Double identity ^java.util.function.DoubleBinaryOperator op]
    (-> this (.reduce identity op)))
  (^java.util.OptionalDouble [^DoubleStream this ^java.util.function.DoubleBinaryOperator op]
    (-> this (.reduce op))))
