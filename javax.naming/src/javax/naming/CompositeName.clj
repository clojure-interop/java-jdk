...
(defn add-all
  ...
  (^javax.naming.Name [^CompositeName this ^Integer posn ^javax.naming.Name n]
    (-> this (.addAll posn n)))
  (^javax.naming.Name [^CompositeName this ^javax.naming.Name suffix]
    (-> this (.addAll suffix))))
...
(defn ends-with
  ...
  (^Boolean [^CompositeName this ^javax.naming.Name n]
    (-> this (.endsWith n))))
...
(defn get-suffix
  ...
  (^javax.naming.Name [^CompositeName this ^Integer posn]
    (-> this (.getSuffix posn))))
...
(defn get-all
  ...
  (^java.util.Enumeration [^CompositeName this]
    (-> this (.getAll))))
...
(defn to-string
  ...
  (^java.lang.String [^CompositeName this]
    (-> this (.toString))))
...
(defn remove
  ...
  (^java.lang.Object [^CompositeName this ^Integer posn]
    (-> this (.remove posn))))
...
(defn clone
  ...
  (^java.lang.Object [^CompositeName this]
    (-> this (.clone))))
...
(defn add
  ...
  throws: java.lang.ArrayIndexOutOfBoundsException - If posn is outside the specified range."
  (^javax.naming.Name [^CompositeName this ^Integer posn ^java.lang.String comp]
    (-> this (.add posn comp)))
  (^javax.naming.Name [^CompositeName this ^java.lang.String comp]
    (-> this (.add comp))))
...
(defn compare-to
  ...
  (^Integer [^CompositeName this ^java.lang.Object obj]
    (-> this (.compareTo obj))))
...
(defn get
  ...
  throws: java.lang.ArrayIndexOutOfBoundsException - if posn is outside the specified range."
  (^java.lang.String [^CompositeName this ^Integer posn]
    (-> this (.get posn))))
...
(defn equals
  ...
  (^Boolean [^CompositeName this ^java.lang.Object obj]
    (-> this (.equals obj))))
