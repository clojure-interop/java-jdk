...
(defn add-all
  ...
  ([^. this ^Integer posn ^javax.naming.Name n]
    (-> this (.addAll posn n)))
  ([^. this ^javax.naming.Name suffix]
    (-> this (.addAll suffix))))
...
(defn add
  ...
  throws: java.lang.ArrayIndexOutOfBoundsException - if posn is outside the specified range"
  ([^. this ^Integer posn ^java.lang.String comp]
    (-> this (.add posn comp)))
  ([^. this ^java.lang.String comp]
    (-> this (.add comp))))
