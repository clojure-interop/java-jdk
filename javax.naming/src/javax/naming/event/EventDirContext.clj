...
(defn add-naming-listener
  ...
  ([^javax.naming.event.EventDirContext this ^javax.naming.Name target ^java.lang.String filter ^java.lang.Object[] filter-args ^javax.naming.directory.SearchControls ctls ^javax.naming.event.NamingListener l]
