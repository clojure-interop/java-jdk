...
(defn add-naming-listener
  ...
  ([^EventContext this ^javax.naming.Name target ^Integer scope ^javax.naming.event.NamingListener l]
...
(defn remove-naming-listener
  ...
  ([^EventContext this ^javax.naming.event.NamingListener l]
