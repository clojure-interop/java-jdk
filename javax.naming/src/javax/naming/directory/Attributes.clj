...
(defn case-ignored?
  ...
  (^Boolean [^javax.naming.directory.Attributes this]
    (-> this (.isCaseIgnored))))
...
(defn size
  ...
  (^Integer [^javax.naming.directory.Attributes this]
    (-> this (.size))))
...
(defn get
  ...
  (^javax.naming.directory.Attribute [^javax.naming.directory.Attributes this ^java.lang.String attr-id]
    (-> this (.get attr-id))))
...
(defn get-i-ds
  ...
  (^javax.naming.NamingEnumeration [^javax.naming.directory.Attributes this]
    (-> this (.getIDs))))
...
(defn put
  ...
  (^javax.naming.directory.Attribute [^javax.naming.directory.Attributes this ^java.lang.String attr-id ^java.lang.Object val]
    (-> this (.put attr-id val)))
  (^javax.naming.directory.Attribute [^javax.naming.directory.Attributes this ^javax.naming.directory.Attribute attr]
    (-> this (.put attr))))
...
(defn clone
  ...
  (^java.lang.Object [^javax.naming.directory.Attributes this]
    (-> this (.clone))))
