...
(defn get
  ...
  (^javax.naming.directory.Attribute [^Attributes this ^java.lang.String attr-id]
    (-> this (.get attr-id))))
...
(defn get-i-ds
  ...
  (^javax.naming.NamingEnumeration [^Attributes this]
    (-> this (.getIDs))))
...
(defn put
  ...
  (^javax.naming.directory.Attribute [^Attributes this ^java.lang.String attr-id ^java.lang.Object val]
    (-> this (.put attr-id val)))
  (^javax.naming.directory.Attribute [^Attributes this ^javax.naming.directory.Attribute attr]
    (-> this (.put attr))))
