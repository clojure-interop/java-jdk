...
(defn get-id
  ...
  (^java.lang.String [^ExtendedRequest this]
    (-> this (.getID))))
...
(defn create-extended-response
  ...
  (^javax.naming.ldap.ExtendedResponse [^ExtendedRequest this ^java.lang.String id ber-value ^Integer offset ^Integer length]
